...
<head>
  <title>pyxb.binding.xml_.STD_ANON_space</title>
  ...
  <tr valign="top">
    <td width="100%">
      <span class="breadcrumbs">
        ...
        <a href="pyxb.binding.xml_-module.html">Module&nbsp;xml_</a> ::
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="pyxb.binding.xml_.STD_ANON_space-class.html"
...
<!-- ==================== CLASS DESCRIPTION ==================== -->
<h1 class="epydoc">Class STD_ANON_space</h1><p class="nomargin-top"><span class="codelink"><a href="pyxb.binding.xml_-pysrc.html#STD_ANON_space">source&nbsp;code</a></span></p>
<pre class="base-tree">
                    object --+                                    
                             |                                    
            ...
            <a href="pyxb.binding.basis._DynamicCreate_mixin-class.html" onclick="show_private();">basis._DynamicCreate_mixin</a> --+                        
                ...
                <a href="pyxb.binding.basis.simpleTypeDefinition-class.html">basis.simpleTypeDefinition</a> --+                    
                            ...
                            basestring --+   |                    
                                   ...
                                   unicode --+                    
                                             |                    
                              <a href="pyxb.binding.datatypes.string-class.html">datatypes.string</a> --+                
                                                 |                
                        <a href="pyxb.binding.datatypes.normalizedString-class.html">datatypes.normalizedString</a> --+            
                                                     |            
                                       <a href="pyxb.binding.datatypes.token-class.html">datatypes.token</a> --+        
                                                         |        
                                            <a href="pyxb.binding.datatypes.Name-class.html">datatypes.Name</a> --+    
                                                             |    
                                              <a href="pyxb.binding.datatypes.NCName-class.html">datatypes.NCName</a> --+
                                                                 |
                                                object --+       |
                                                         |       |
                                                   <a href="pyxb.cscRoot-class.html">cscRoot</a> --+   |
                                                             |   |
                                       <a href="pyxb.binding.basis.enumeration_mixin-class.html">basis.enumeration_mixin</a> --+
                                                                 |
                                                                <strong class="uidshort">STD_ANON_space</strong>
</pre>
...
<tr bgcolor="#70b0f0" class="table-header">
  ...
  <tr>
    ...
    <div class="private">    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.datatypes.string-class.html">datatypes.string</a></code></b> (private):
...
<tr bgcolor="#70b0f0" class="table-header">
  ...
  <tr>
    <td colspan="2" class="summary">
    <div class="private">    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.datatypes.token-class.html">datatypes.token</a></code></b> (private):
      <code><a href="pyxb.binding.datatypes.token-class.html#_ValidateString_va" onclick="show_private();">_ValidateString_va</a></code>
      </p></div>
    <div class="private">    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.datatypes.normalizedString-class.html">datatypes.normalizedString</a></code></b> (private):
      <code><a href="pyxb.binding.datatypes.normalizedString-class.html#_XsdConstraintsPreCheck_vb" onclick="show_private();">_XsdConstraintsPreCheck_vb</a></code>
      </p></div>
    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.datatypes.string-class.html">datatypes.string</a></code></b>:
      <code><a href="pyxb.binding.datatypes.string-class.html#XsdLiteral">XsdLiteral</a></code>,
      <code><a href="pyxb.binding.datatypes.string-class.html#XsdValueLength">XsdValueLength</a></code>
      </p>
    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.basis.simpleTypeDefinition-class.html">basis.simpleTypeDefinition</a></code></b>:
      <code><a href="pyxb.binding.basis.simpleTypeDefinition-class.html#PythonLiteral">PythonLiteral</a></code>,
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.xml_.STD_ANON_space-class.html#_CF_enumeration" class="summary-name" onclick="show_private();">_CF_enumeration</a> = <code title="pyxb.binding.facets.CF_enumeration(value_datatype= STD_ANON_space, enu\
m_prefix= None)">pyxb.binding.facets.CF_enumeration(value_dat<code class="variable-ellipsis">...</code></code>
    </td>
  </tr>
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="default"></a><span class="summary-name">default</span> = <code title="u'default'">u'default'</code>
    </td>
  </tr>
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="preserve"></a><span class="summary-name">preserve</span> = <code title="u'preserve'">u'preserve'</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.xml_.STD_ANON_space-class.html#_STD_ANON_space_FacetMap" class="summary-name" onclick="show_private();">_STD_ANON_space_FacetMap</a> = <code title="{&lt;class 'pyxb.binding.facets.CF_whiteSpace'&gt;: &lt;pyxb.binding.facets.CF_\
whiteSpace object at 0x9e047ac&gt;,
 &lt;class 'pyxb.binding.facets.CF_pattern'&gt;: &lt;pyxb.binding.facets.CF_pat\
tern object at 0x9e04aac&gt;,
 &lt;class 'pyxb.binding.facets.CF_enumeration'&gt;: &lt;pyxb.binding.facets.CF\
_enumeration object at 0x9d4962c&gt;,
 &lt;class 'pyxb.binding.facets.CF_length'&gt;: &lt;pyxb.binding.facets.CF_leng\
th object at 0x9e043ec&gt;,
..."><code class="variable-group">{</code>&lt;class 'pyxb.binding.facets.CF_whi<code class="variable-ellipsis">...</code></code>
    </td>
  </tr>
  <tr>
    <td colspan="2" class="summary">
    <div class="private">    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.datatypes.NCName-class.html">datatypes.NCName</a></code></b> (private):
      <code><a href="pyxb.binding.datatypes.NCName-class.html#_CF_pattern" onclick="show_private();">_CF_pattern</a></code>,
      <code><a href="pyxb.binding.datatypes.NCName-class.html#_ValidRE" onclick="show_private();">_ValidRE</a></code>,
      <code><a href="pyxb.binding.datatypes.NCName-class.html#_httpwww_w3_org2001XMLSchema_NCName_FacetMap" onclick="show_private();">_httpwww_w3_org2001XMLSchema_NCName_FacetMap</a></code>
      </p></div>
    <div class="private">    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.datatypes.Name-class.html">datatypes.Name</a></code></b> (private):
      <code><a href="pyxb.binding.datatypes.Name-class.html#_httpwww_w3_org2001XMLSchema_Name_FacetMap" onclick="show_private();">_httpwww_w3_org2001XMLSchema_Name_FacetMap</a></code>
      </p></div>
    <div class="private">    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.datatypes.token-class.html">datatypes.token</a></code></b> (private):
      <code><a href="pyxb.binding.datatypes.token-class.html#_CF_whiteSpace" onclick="show_private();">_CF_whiteSpace</a></code>,
      <code><a href="pyxb.binding.datatypes.token-class.html#_httpwww_w3_org2001XMLSchema_token_FacetMap" onclick="show_private();">_httpwww_w3_org2001XMLSchema_token_FacetMap</a></code>
      </p></div>
    <div class="private">    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.datatypes.normalizedString-class.html">datatypes.normalizedString</a></code></b> (private):
      <code><a href="pyxb.binding.datatypes.normalizedString-class.html#_InvalidRE" onclick="show_private();">_InvalidRE</a></code>,
      <code><a href="pyxb.binding.datatypes.normalizedString-class.html#_httpwww_w3_org2001XMLSchema_normalizedString_FacetMap" onclick="show_private();">_httpwww_w3_org2001XMLSchema_normalizedString_FacetMap</a></code>
      </p></div>
    <div class="private">    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.datatypes.string-class.html">datatypes.string</a></code></b> (private):
      <code><a href="pyxb.binding.datatypes.string-class.html#_CF_length" onclick="show_private();">_CF_length</a></code>,
      <code><a href="pyxb.binding.datatypes.string-class.html#_CF_maxLength" onclick="show_private();">_CF_maxLength</a></code>,
      <code><a href="pyxb.binding.datatypes.string-class.html#_CF_minLength" onclick="show_private();">_CF_minLength</a></code>,
      <code><a href="pyxb.binding.datatypes.string-class.html#_httpwww_w3_org2001XMLSchema_string_FacetMap" onclick="show_private();">_httpwww_w3_org2001XMLSchema_string_FacetMap</a></code>
      </p></div>
    <div class="private">    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.basis.simpleTypeDefinition-class.html">basis.simpleTypeDefinition</a></code></b> (private):
...
pyxb.binding.facets.CF_enumeration(value_datatype= STD_ANON_space, enu<span class="variable-linewrap"><img src="crarr.png" alt="\" /></span>
m_prefix= None)
</pre></td></tr></table>
</dd>
  </dl>
...
<a name="_STD_ANON_space_FacetMap"></a>
<div class="private">
<table class="details" border="1" cellpadding="3"
       cellspacing="0" width="100%" bgcolor="white">
<tr><td>
  <h3 class="epydoc">_STD_ANON_space_FacetMap</h3>
...
whiteSpace object at 0x9e047ac&gt;<code class="variable-op">,</code>
...
tern object at 0x9e04aac&gt;<code class="variable-op">,</code>
...
_enumeration object at 0x9d4962c&gt;<code class="variable-op">,</code>
...
th object at 0x9e043ec&gt;<code class="variable-op">,</code>
