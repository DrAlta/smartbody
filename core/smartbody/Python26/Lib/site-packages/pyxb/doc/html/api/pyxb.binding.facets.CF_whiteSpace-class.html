...
<head>
  <title>pyxb.binding.facets.CF_whiteSpace</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="pyxb.binding.facets.CF_whiteSpace-class.html"
...
<!-- ==================== CLASS DESCRIPTION ==================== -->
<h1 class="epydoc">Class CF_whiteSpace</h1><p class="nomargin-top"><span class="codelink"><a href="pyxb.binding.facets-pysrc.html#CF_whiteSpace">source&nbsp;code</a></span></p>
<pre class="base-tree">
object --+            
         |            
 ...
 <a href="pyxb.binding.facets.ConstrainingFacet-class.html">ConstrainingFacet</a> --+
    ...
    object --+       |
       ...
       <a href="pyxb.cscRoot-class.html">cscRoot</a> --+   |
                 |   |
      <a href="pyxb.binding.facets._Fixed_mixin-class.html" onclick="show_private();">_Fixed_mixin</a> --+
                     |
                    <strong class="uidshort">CF_whiteSpace</strong>
</pre>

<hr />
<p>Specify the value-space interpretation of whitespace.</p>
  <p>See <a href="http://www.w3.org/TR/xmlschema-2/#rf-whiteSpace" 
  target="_top">http://www.w3.org/TR/xmlschema-2/#rf-whiteSpace</a></p>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.facets._WhiteSpace_enum-class.html" class="summary-name" onclick="show_private();">_ValueDatatype</a><br />
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="normalizeString"></a><span class="summary-sig-name">normalizeString</span>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">value</span>)</span><br />
      Normalize the given string in accordance with the configured 
      whitespace interpretation.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.facets-pysrc.html#CF_whiteSpace.normalizeString">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.binding.facets.CF_whiteSpace-class.html#_validateConstraint_vx" class="summary-sig-name" onclick="show_private();">_validateConstraint_vx</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">value</span>)</span><br />
      No validation rules for whitespace facet.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.facets-pysrc.html#CF_whiteSpace._validateConstraint_vx">source&nbsp;code</a></span>
  ...
  <tr>
    ...
    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.facets.ConstrainingFacet-class.html">ConstrainingFacet</a></code></b>:
      <code><a href="pyxb.binding.facets.ConstrainingFacet-class.html#__init__">__init__</a></code>,
    ...
    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.facets._Fixed_mixin-class.html" onclick="show_private();">_Fixed_mixin</a></code></b>:
      <code><a href="pyxb.binding.facets._Fixed_mixin-class.html#fixed">fixed</a></code>
      </p>
    <div class="private">    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.facets._Fixed_mixin-class.html" onclick="show_private();">_Fixed_mixin</a></code></b> (private):
      <code><a href="pyxb.binding.facets._Fixed_mixin-class.html#_Fixed_mixin__setFromKeywords" onclick="show_private();">_Fixed_mixin__setFromKeywords</a></code>
      </p></div>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="_Name"></a><span class="summary-name">_Name</span> = <code title="'whiteSpace'"><code class="variable-quote">'</code><code class="variable-string">whiteSpace</code><code class="variable-quote">'</code></code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
...
<tr class="private">
  ...
  <tr>
    ...
    <div class="private">    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.facets._Fixed_mixin-class.html" onclick="show_private();">_Fixed_mixin</a></code></b> (private):
      <code><a href="pyxb.binding.facets._Fixed_mixin-class.html#_Fixed_mixin__fixed" onclick="show_private();">_Fixed_mixin__fixed</a></code>
      </p></div>
    </td>
  </tr>
</table>
...
<tr><td>
  ...
  <p>No validation rules for whitespace facet.</p>
  <dl class="fields">
    <dt>Overrides:
