...
<head>
  <title>pyxb.binding.datatypes.token</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="pyxb.binding.datatypes.token-class.html"
...
<!-- ==================== CLASS DESCRIPTION ==================== -->
<h1 class="epydoc">Class token</h1><p class="nomargin-top"><span class="codelink"><a href="pyxb.binding.datatypes-pysrc.html#token">source&nbsp;code</a></span></p>
<pre class="base-tree">
                    object --+                        
                             |                        
...
<li><a href="pyxb.binding.datatypes.Name-class.html">Name</a></li><li>, <a href="pyxb.binding.datatypes.NMTOKEN-class.html">NMTOKEN</a></li><li>, <a href="pyxb.binding.datatypes.language-class.html">language</a></li>  </ul>
</dd></dl>

<hr />
<p>See http:///www.w3.org/TR/xmlschema-2/index.html#token</p>
  <p>Tokens cannot leading or trailing space characters; any carriage 
  return, line feed, or tab characters; nor any occurrence of two or more 
  consecutive space characters.</p>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.binding.datatypes.token-class.html#_ValidateString_va" class="summary-sig-name" onclick="show_private();">_ValidateString_va</a>(<span class="summary-sig-arg">cls</span>,
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.datatypes.token-class.html#_ExpandedName" class="summary-name" onclick="show_private();">_ExpandedName</a> = <code title="pyxb.namespace.XMLSchema.createExpandedName('token')">pyxb.namespace.XMLSchema.createExpandedName('t<code class="variable-ellipsis">...</code></code><br />
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.datatypes.token-class.html#_CF_whiteSpace" class="summary-name" onclick="show_private();">_CF_whiteSpace</a> = <code title="&lt;pyxb.binding.facets.CF_whiteSpace object at 0x9e047ac&gt;">&lt;pyxb.binding.facets.CF_whiteSpace object at <code class="variable-ellipsis">...</code></code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.datatypes.token-class.html#_httpwww_w3_org2001XMLSchema_token_FacetMap" class="summary-name" onclick="show_private();">_httpwww_w3_org2001XMLSchema_token_FacetMap</a> = <code title="{&lt;class 'pyxb.binding.facets.CF_whiteSpace'&gt;: &lt;pyxb.binding.facets.CF_\
whiteSpace object at 0x9e047ac&gt;,
 &lt;class 'pyxb.binding.facets.CF_pattern'&gt;: &lt;pyxb.binding.facets.CF_pat\
tern object at 0x9e0444c&gt;,
...
..."><code class="variable-group">{</code>&lt;class 'pyxb.bi<code class="variable-ellipsis">...</code></code>
  ...
  <tr>
    ...
    <div class="private">    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.datatypes.normalizedString-class.html">normalizedString</a></code></b> (private):
      ...
      <code><a href="pyxb.binding.datatypes.normalizedString-class.html#_ValidRE" onclick="show_private();">_ValidRE</a></code>,
    ...
    <div class="private">    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.datatypes.string-class.html">string</a></code></b> (private):
      ...
      <code><a href="pyxb.binding.datatypes.string-class.html#_CF_pattern" onclick="show_private();">_CF_pattern</a></code>,
...
<tr><td>
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr valign="top"><td>
  <h3 class="epydoc"><span class="sig"><span class="sig-name">_ValidateString_va</span>(<span class="sig-arg">cls</span>,
  ...
  <p>Post-extended method to validate that a string matches a given 
  pattern.</p>
  <p>If you can express the valid strings as a compiled regular expression 
  in the class variable _ValidRE, or the invalid strings as a compiled 
  regular expression in the class variable _InvalidRE, you can just use 
  those.  If the acceptable matches are any trickier, you should invoke the
  superclass implementation, and if it returns True then perform additional
  tests.</p>
  <dl class="fields">
    <dt>Overrides:
        <a href="pyxb.binding.datatypes.normalizedString-class.html#_ValidateString_va" onclick="show_private();">normalizedString._ValidateString_va</a>
...
pyxb.namespace.XMLSchema.createExpandedName('token')
</pre></td></tr></table>
</dd>
  </dl>
</td></tr></table>
...
<tr><td>
  ...
  <dl class="fields">
    <dt>Value:</dt>
      <dd><table><tr><td><pre class="variable">
&lt;pyxb.binding.facets.CF_whiteSpace object at 0x9e047ac&gt;
</pre></td></tr></table>
</dd>
  </dl>
</td></tr></table>
</div>
<a name="_httpwww_w3_org2001XMLSchema_token_FacetMap"></a>
<div class="private">
<table class="details" border="1" cellpadding="3"
       cellspacing="0" width="100%" bgcolor="white">
<tr><td>
  <h3 class="epydoc">_httpwww_w3_org2001XMLSchema_token_FacetMap</h3>
...
tern object at 0x9e0444c&gt;<code class="variable-op">,</code>
