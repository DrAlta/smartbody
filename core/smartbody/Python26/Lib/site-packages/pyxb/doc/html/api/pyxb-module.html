...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__version__"></a><span class="summary-name">__version__</span> = <code title="'1.1.1'"><code class="variable-quote">'</code><code class="variable-string">1.1.1</code><code class="variable-quote">'</code></code><br />
      The version of PyXB
    </td>
  </tr>
<tr class="private">
