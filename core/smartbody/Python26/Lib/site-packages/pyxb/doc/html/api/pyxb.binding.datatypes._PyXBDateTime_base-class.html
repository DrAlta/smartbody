...
<head>
  <title>pyxb.binding.datatypes._PyXBDateTime_base</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="pyxb.binding.datatypes._PyXBDateTime_base-class.html"
...
<!-- ==================== CLASS DESCRIPTION ==================== -->
<h1 class="epydoc">Class _PyXBDateTime_base</h1><p class="nomargin-top"><span class="codelink"><a href="pyxb.binding.datatypes-pysrc.html#_PyXBDateTime_base">source&nbsp;code</a></span></p>
<pre class="base-tree">
                    object --+                
                             |                
...
<a href="pyxb.utils.utility._DeconflictSymbols_mixin-class.html" onclick="show_private();">utils.utility._DeconflictSymbols_mixin</a> --+    
            ...
            <a href="pyxb.binding.basis._DynamicCreate_mixin-class.html" onclick="show_private();">basis._DynamicCreate_mixin</a> --+    
                ...
                <a href="pyxb.binding.basis.simpleTypeDefinition-class.html">basis.simpleTypeDefinition</a> --+
                                             |
                                            <strong class="uidshort">_PyXBDateTime_base</strong>
</pre>

<dl><dt>Known Subclasses:</dt>
<dd>
      <ul class="subclass-list">
<li class="private"><a href="pyxb.binding.datatypes._PyXBDateOnly_base-class.html" onclick="show_private();">_PyXBDateOnly_base</a></li><li class="private">, <a href="pyxb.binding.datatypes._PyXBDateTimeZone_base-class.html" onclick="show_private();">_PyXBDateTimeZone_base</a></li>  </ul>
</dd></dl>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="_DateTimePattern"></a><span class="summary-sig-name">_DateTimePattern</span>(<span class="summary-sig-arg">cls</span>,
        <span class="summary-sig-arg">pattern</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.datatypes-pysrc.html#_PyXBDateTime_base._DateTimePattern">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="_LexicalToKeywords"></a><span class="summary-sig-name">_LexicalToKeywords</span>(<span class="summary-sig-arg">cls</span>,
        <span class="summary-sig-arg">text</span>,
        <span class="summary-sig-arg">lexical_re</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.datatypes-pysrc.html#_PyXBDateTime_base._LexicalToKeywords">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="_SetKeysFromPython_csc"></a><span class="summary-sig-name">_SetKeysFromPython_csc</span>(<span class="summary-sig-arg">cls</span>,
        <span class="summary-sig-arg">python_value</span>,
        <span class="summary-sig-arg">kw</span>,
        <span class="summary-sig-arg">fields</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.datatypes-pysrc.html#_PyXBDateTime_base._SetKeysFromPython_csc">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="_SetKeysFromPython"></a><span class="summary-sig-name">_SetKeysFromPython</span>(<span class="summary-sig-arg">cls</span>,
        <span class="summary-sig-arg">python_value</span>,
        <span class="summary-sig-arg">kw</span>,
        <span class="summary-sig-arg">fields</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.datatypes-pysrc.html#_PyXBDateTime_base._SetKeysFromPython">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.datatypes._PyXBDateTime_base-class.html#__PatternMap" class="summary-name" onclick="show_private();">__PatternMap</a> = <code title="{'%Y': '(?P&lt;negYear&gt;-?)(?P&lt;year&gt;\d{4,})', '%m': '(?P&lt;month&gt;\d{2})', '%\
d': '(?P&lt;day&gt;\d{2})', '%H': '(?P&lt;hour&gt;\d{2})', '%M': '(?P&lt;minute&gt;\d{2}\
)', '%S': '(?P&lt;second&gt;\d{2})(?P&lt;fracsec&gt;\.\d+)?', '%Z': '(?P&lt;tzinfo&gt;Z|\
[-+]\d\d:\d\d)'}">{'%Y': '(?P&lt;negYear&gt;-?)(?P&lt;year&gt;\d{4,})', '%m':<code class="variable-ellipsis">...</code></code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__Fields"></a><span class="summary-name">__Fields</span> = <code title="'year', 'month', 'day', 'hour', 'minute', 'second'">'year', 'month', 'day', 'hour', 'minute', 'second'</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="_DefaultYear"></a><span class="summary-name">_DefaultYear</span> = <code title="1983">1983</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="_DefaultMonth"></a><span class="summary-name">_DefaultMonth</span> = <code title="6">6</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="_DefaultDay"></a><span class="summary-name">_DefaultDay</span> = <code title="18">18</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.datatypes._PyXBDateTime_base-class.html#_PyXBDateTime_base__Fields" class="summary-name" onclick="show_private();">_PyXBDateTime_base__Fields</a> = <code title="('year', 'month', 'day', 'hour', 'minute', 'second')"><code class="variable-group">(</code><code class="variable-quote">'</code><code class="variable-string">year</code><code class="variable-quote">'</code><code class="variable-op">, </code><code class="variable-quote">'</code><code class="variable-string">month</code><code class="variable-quote">'</code><code class="variable-op">, </code><code class="variable-quote">'</code><code class="variable-string">day</code><code class="variable-quote">'</code><code class="variable-op">, </code><code class="variable-quote">'</code><code class="variable-string">hour</code><code class="variable-quote">'</code><code class="variable-op">, </code><code class="variable-ellipsis">...</code></code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.datatypes._PyXBDateTime_base-class.html#_PyXBDateTime_base__PatternMap" class="summary-name" onclick="show_private();">_PyXBDateTime_base__PatternMap</a> = <code title="{'%H': '(?P&lt;hour&gt;\\d{2})',
 '%M': '(?P&lt;minute&gt;\\d{2})',
 '%S': '(?P&lt;second&gt;\\d{2})(?P&lt;fracsec&gt;\\.\\d+)?',
 '%Y': '(?P&lt;negYear&gt;-?)(?P&lt;year&gt;\\d{4,})',
 '%Z': '(?P&lt;tzinfo&gt;Z|[-+]\\d\\d:\\d\\d)',
 '%d': '(?P&lt;day&gt;\\d{2})',
 '%m': '(?P&lt;month&gt;\\d{2})'}"><code class="variable-group">{</code><code class="variable-quote">'</code><code class="variable-string">%H</code><code class="variable-quote">'</code><code class="variable-op">: </code><code class="variable-quote">'</code><code class="variable-string">(?P&lt;hour&gt;\\d{2})</code><code class="variable-quote">'</code><code class="variable-op">, </code><code class="variable-quote">'</code><code class="variable-string">%</code><code class="variable-ellipsis">...</code></code>
    </td>
  </tr>
  <tr>
    <td colspan="2" class="summary">
...
<a name="__PatternMap"></a>
<div class="private">
<table class="details" border="1" cellpadding="3"
       cellspacing="0" width="100%" bgcolor="white">
<tr><td>
  <h3 class="epydoc">__PatternMap</h3>
...
{'%Y': '(?P&lt;negYear&gt;-?)(?P&lt;year&gt;\d{4,})', '%m': '(?P&lt;month&gt;\d{2})', '%<span class="variable-linewrap"><img src="crarr.png" alt="\" /></span>
d': '(?P&lt;day&gt;\d{2})', '%H': '(?P&lt;hour&gt;\d{2})', '%M': '(?P&lt;minute&gt;\d{2}<span class="variable-linewrap"><img src="crarr.png" alt="\" /></span>
)', '%S': '(?P&lt;second&gt;\d{2})(?P&lt;fracsec&gt;\.\d+)?', '%Z': '(?P&lt;tzinfo&gt;Z|<span class="variable-linewrap"><img src="crarr.png" alt="\" /></span>
[-+]\d\d:\d\d)'}
</pre></td></tr></table>
</dd>
  </dl>
...
<a name="_PyXBDateTime_base__Fields"></a>
<div class="private">
<table class="details" border="1" cellpadding="3"
       cellspacing="0" width="100%" bgcolor="white">
<tr><td>
  <h3 class="epydoc">_PyXBDateTime_base__Fields</h3>
...
<a name="_PyXBDateTime_base__PatternMap"></a>
<div class="private">
<table class="details" border="1" cellpadding="3"
       cellspacing="0" width="100%" bgcolor="white">
<tr><td>
  <h3 class="epydoc">_PyXBDateTime_base__PatternMap</h3>
  ...
  <dl class="fields">
    <dt>Value:</dt>
      <dd><table><tr><td><pre class="variable">
<code class="variable-group">{</code><code class="variable-quote">'</code><code class="variable-string">%H</code><code class="variable-quote">'</code><code class="variable-op">: </code><code class="variable-quote">'</code><code class="variable-string">(?P&lt;hour&gt;\\d{2})</code><code class="variable-quote">'</code><code class="variable-op">,</code>
 <code class="variable-quote">'</code><code class="variable-string">%M</code><code class="variable-quote">'</code><code class="variable-op">: </code><code class="variable-quote">'</code><code class="variable-string">(?P&lt;minute&gt;\\d{2})</code><code class="variable-quote">'</code><code class="variable-op">,</code>
 <code class="variable-quote">'</code><code class="variable-string">%S</code><code class="variable-quote">'</code><code class="variable-op">: </code><code class="variable-quote">'</code><code class="variable-string">(?P&lt;second&gt;\\d{2})(?P&lt;fracsec&gt;\\.\\d+)?</code><code class="variable-quote">'</code><code class="variable-op">,</code>
 <code class="variable-quote">'</code><code class="variable-string">%Y</code><code class="variable-quote">'</code><code class="variable-op">: </code><code class="variable-quote">'</code><code class="variable-string">(?P&lt;negYear&gt;-?)(?P&lt;year&gt;\\d{4,})</code><code class="variable-quote">'</code><code class="variable-op">,</code>
 <code class="variable-quote">'</code><code class="variable-string">%Z</code><code class="variable-quote">'</code><code class="variable-op">: </code><code class="variable-quote">'</code><code class="variable-string">(?P&lt;tzinfo&gt;Z|[-+]\\d\\d:\\d\\d)</code><code class="variable-quote">'</code><code class="variable-op">,</code>
 <code class="variable-quote">'</code><code class="variable-string">%d</code><code class="variable-quote">'</code><code class="variable-op">: </code><code class="variable-quote">'</code><code class="variable-string">(?P&lt;day&gt;\\d{2})</code><code class="variable-quote">'</code><code class="variable-op">,</code>
 <code class="variable-quote">'</code><code class="variable-string">%m</code><code class="variable-quote">'</code><code class="variable-op">: </code><code class="variable-quote">'</code><code class="variable-string">(?P&lt;month&gt;\\d{2})</code><code class="variable-quote">'</code><code class="variable-group">}</code>
</pre></td></tr></table>
</dd>
  </dl>
</td></tr></table>
