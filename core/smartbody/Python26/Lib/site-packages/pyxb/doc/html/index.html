...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>PyXB: Python XML Schema Bindings &mdash; PyXB v1.1.1 documentation</title>
    ...
    <link rel="top" title="PyXB v1.1.1 documentation" href="" />
  ...
  <body>
    <div class="related">
      ...
      <ul>
        ...
        <li><a href="">PyXB v1.1.1 documentation</a> &raquo;</li>
...
examples are in <a class="reference external" href="userref_index.html#userreference"><em>User Reference</em></a>.</p>
...
<p>For a history of releases, see <a class="reference external" href="releases.html#releases"><em>Release History</em></a>.</p>
</div>
<div class="section" id="contents">
<h2>Contents<a class="headerlink" href="#contents" title="Permalink to this headline">¶</a></h2>
<ul>
<li class="toctree-l1"><a class="reference external" href="overview.html">Overview</a><ul>
<li class="toctree-l2"><a class="reference external" href="overview_what.html">What Is PyXB?</a></li>
<li class="toctree-l2"><a class="reference external" href="overview_how.html">How to use it</a></li>
<li class="toctree-l2"><a class="reference external" href="bundles.html">Examples of Supported Schema</a></li>
<li class="toctree-l2"><a class="reference external" href="limitations.html">Limitations</a></li>
<li class="toctree-l2"><a class="reference external" href="legal.html">License and Disclaimers</a></li>
<li class="toctree-l2"><a class="reference external" href="vision.html">PyXB Vision</a></li>
<li class="toctree-l2"><a class="reference external" href="related.html">Related Packages</a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference external" href="examples.html">Examples</a><ul>
<li class="toctree-l2"><a class="reference external" href="examples.html#dictionary-aonaware">Dictionary (Aonaware)</a></li>
<li class="toctree-l2"><a class="reference external" href="examples.html#simple-weather-cdyne">Simple Weather (CDyne)</a></li>
<li class="toctree-l2"><a class="reference external" href="examples.html#professional-weather-national-digital-forecast-data">Professional Weather (National Digital Forecast Data)</a></li>
<li class="toctree-l2"><a class="reference external" href="examples.html#television-schedules-tribune-media-services">Television Schedules (Tribune Media Services)</a></li>
<li class="toctree-l2"><a class="reference external" href="examples.html#address-to-latitude-longitude-http-geocoder-us">Address-To-Latitude/Longitude (http://geocoder.us)</a></li>
<li class="toctree-l2"><a class="reference external" href="examples.html#opengis-http-www-opengeospatial-org">OpenGIS (http://www.opengeospatial.org)</a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference external" href="releases.html">Release History</a><ul>
<li class="toctree-l2"><a class="reference external" href="releases.html#x-beta">1.1.x (Beta)</a></li>
<li class="toctree-l2"><a class="reference external" href="releases.html#x-stable">1.0.x (Stable)</a></li>
<li class="toctree-l2"><a class="reference external" href="releases.html#id1">0.7.x (Beta)</a></li>
<li class="toctree-l2"><a class="reference external" href="releases.html#id2">0.5.x (Beta)</a></li>
<li class="toctree-l2"><a class="reference external" href="releases.html#id3">0.4.x (Stable)</a></li>
<li class="toctree-l2"><a class="reference external" href="releases.html#id4">0.2.x (Stable)</a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference external" href="architecture.html">Architecture</a><ul>
<li class="toctree-l2"><a class="reference external" href="arch_namespaces.html">Namespaces</a></li>
<li class="toctree-l2"><a class="reference external" href="arch_component.html">Component Model</a></li>
<li class="toctree-l2"><a class="reference external" href="arch_binding.html">Binding Model</a></li>
<li class="toctree-l2"><a class="reference external" href="arch_content.html">Content Model</a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference external" href="userref_index.html">User Reference</a><ul>
<li class="toctree-l2"><a class="reference external" href="userref_pyxbgen.html">Generating Binding Classes</a></li>
<li class="toctree-l2"><a class="reference external" href="userref_usebind.html">Using Binding Classes</a></li>
<li class="toctree-l2"><a class="reference external" href="pyxbgen_cli.html"><tt class="docutils literal"><span class="pre">pyxbgen</span></tt> Command Line Options</a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference external" href="maintref.html">Maintainer Reference</a><ul>
<li class="toctree-l2"><a class="reference external" href="maintref.html#the-api">The API</a></li>
<li class="toctree-l2"><a class="reference external" href="maintref.html#coding-practices">Coding Practices</a></li>
</ul>
</li>
</ul>
</div>
...
bindings:</p>
<div class="highlight-python"><pre>mnservices[4]$ pyxbgen \
...
<span class="n">uri</span> <span class="o">=</span> <span class="s">&#39;http://ws.cdyne.com/WeatherWS/Weather.asmx/GetCityForecastByZIP?ZIP=85711&#39;</span>
...
<span class="k">if</span> <span class="n">fc_return</span><span class="o">.</span><span class="n">Success</span><span class="p">:</span>
    <span class="k">print</span> <span class="s">&#39;Weather forecast for </span><span class="si">%s</span><span class="s">, </span><span class="si">%s</span><span class="s">:&#39;</span> <span class="o">%</span> <span class="p">(</span><span class="n">fc_return</span><span class="o">.</span><span class="n">City</span><span class="p">,</span> <span class="n">fc_return</span><span class="o">.</span><span class="n">State</span><span class="p">)</span>
...
<p>And run it:</p>
<div class="highlight-python"><pre>mnservices[5]$ python client_get.py
...
<li><a class="reference external" href="search.html"><em>Search Page</em></a></li>
      ...
      <div class="sphinxsidebar">
        <div class="sphinxsidebarwrapper">
            ...
            <ul>
<li><a class="reference external" href="">PyXB: Python XML Schema Bindings</a><ul>
...
<li><a class="reference external" href="#thirty-second-example">Thirty Second Example</a></li>
