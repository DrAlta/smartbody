...
# Generated 2010-01-28 08:42:41.698000 by PyXB version 1.1.1
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:c43fabe0-0c23-11df-ace7-000c29370554')
...
class AppearancePropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netcitygmltexturedsurface1_0_AppearancePropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    ...
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netcitygmltexturedsurface1_0_AppearancePropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
TexturedSurfaceType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=TexturedSurfaceType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'baseSurface'))),
    ...
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TexturedSurfaceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'appearance'))),
    ])
...
SimpleTextureType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
    ...
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=SimpleTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'textureType'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=SimpleTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'repeat'))),
    ])
...
MaterialType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=MaterialType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=MaterialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ambientIntensity'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=MaterialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'transparency'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=MaterialType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=MaterialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'specularColor'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=MaterialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'emissiveColor'))),
