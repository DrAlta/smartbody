...
# Generated 2010-01-28 08:40:29.899000 by PyXB version 1.1.1
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:76a66810-0c23-11df-ad15-000c29370554')
...
EndpointReferenceType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=EndpointReferenceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Address'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=EndpointReferenceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Metadata'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=EndpointReferenceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ReferenceParameters'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/2005/08/addressing'))),
    ])
