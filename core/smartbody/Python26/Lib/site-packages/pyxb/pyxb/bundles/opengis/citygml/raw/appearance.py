...
# Generated 2010-01-28 08:42:16.805000 by PyXB version 1.1.1
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:b5677850-0c23-11df-961b-000c29370554')
...
class TextureAssociationType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netcitygmlappearance1_0_TextureAssociationType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netcitygmlappearance1_0_TextureAssociationType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class SurfaceDataPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netcitygmlappearance1_0_SurfaceDataPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    
    actuate = property(__actuate.value, __actuate.set, None, u"\n        The 'actuate' attribute is used to communicate the desired timing \n        of traversal from the starting resource to the ending resource; \n        it's value should be treated as follows:\n        onLoad - traverse to the ending resource immediately on loading \n                 the starting resource \n        onRequest - traverse from the starting resource to the ending \n                    resource only on a post-loading event triggered for \n                    this purpose \n        other - behavior is unconstrained; examine other markup in link \n                for hints \n        none - behavior is unconstrained\n      ")

    
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netcitygmlappearance1_0_SurfaceDataPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
AppearanceType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=AppearanceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'surfaceDataMember'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=AppearanceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfAppearance'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=AppearanceType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=AppearanceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'theme'))),
    ])
...
AbstractTextureParameterizationType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=AbstractTextureParameterizationType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=AbstractTextureParameterizationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfTextureParameterization'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=AbstractTextureParameterizationType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=AbstractTextureParameterizationType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=AbstractTextureParameterizationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfTextureParameterization'))),
...
AbstractSurfaceDataType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=AbstractSurfaceDataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'isFront'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=AbstractSurfaceDataType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=AbstractSurfaceDataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfSurfaceData'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=AbstractSurfaceDataType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'boundedBy'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=AbstractSurfaceDataType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=AbstractSurfaceDataType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=AbstractSurfaceDataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'isFront'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=AbstractSurfaceDataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfSurfaceData'))),
...
AbstractTextureType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=AbstractTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'isFront'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=AbstractTextureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=AbstractTextureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'boundedBy'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=AbstractTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfSurfaceData'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=AbstractTextureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=AbstractTextureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=AbstractTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'imageURI'))),
    ])
    ...
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=AbstractTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'mimeType'))),
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=AbstractTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'borderColor'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=AbstractTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'textureType'))),
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=AbstractTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfTexture'))),
        pyxb.binding.content.ContentModelTransition(next_state=10, element_use=AbstractTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'wrapMode'))),
    ])
...
X3DMaterialType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'isFront'))),
        pyxb.binding.content.ContentModelTransition(next_state=10, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'specularColor'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'boundedBy'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'shininess'))),
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'emissiveColor'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfSurfaceData'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'transparency'))),
        pyxb.binding.content.ContentModelTransition(next_state=12, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'isSmooth'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'target'))),
        pyxb.binding.content.ContentModelTransition(next_state=12, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=11, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ambientIntensity'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfX3DMaterial'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'diffuseColor'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'specularColor'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'shininess'))),
...
GeoreferencedTextureType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'isFront'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'boundedBy'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfSurfaceData'))),
        pyxb.binding.content.ContentModelTransition(next_state=12, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=12, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'imageURI'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'orientation'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfGeoreferencedTexture'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'target'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'borderColor'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfTexture'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'preferWorldFile'))),
        pyxb.binding.content.ContentModelTransition(next_state=11, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'referencePoint'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfGeoreferencedTexture'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'target'))),
    ...
    , 9 : pyxb.binding.content.ContentModelState(state=9, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'orientation'))),
        pyxb.binding.content.ContentModelTransition(next_state=13, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'textureType'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfGeoreferencedTexture'))),
        pyxb.binding.content.ContentModelTransition(next_state=10, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'mimeType'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'borderColor'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfTexture'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'preferWorldFile'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'target'))),
        pyxb.binding.content.ContentModelTransition(next_state=11, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'referencePoint'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'wrapMode'))),
    ])
    , 10 : pyxb.binding.content.ContentModelState(state=10, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'orientation'))),
        pyxb.binding.content.ContentModelTransition(next_state=13, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'textureType'))),
...
TexCoordGenType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=TexCoordGenType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=TexCoordGenType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TexCoordGenType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfTextureParameterization'))),
...
ParameterizedTextureType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'isFront'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'boundedBy'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfSurfaceData'))),
        pyxb.binding.content.ContentModelTransition(next_state=11, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=11, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'imageURI'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfSurfaceData'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'imageURI'))),
    ...
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'target'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfParameterizedTexture'))),
    ])
    , 6 : pyxb.binding.content.ContentModelState(state=6, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'target'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfTexture'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfParameterizedTexture'))),
    ])
    , 7 : pyxb.binding.content.ContentModelState(state=7, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'target'))),
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'textureType'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfTexture'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'borderColor'))),
        pyxb.binding.content.ContentModelTransition(next_state=10, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'wrapMode'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfParameterizedTexture'))),
    ])
    , 8 : pyxb.binding.content.ContentModelState(state=8, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'target'))),
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'textureType'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'mimeType'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'borderColor'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfTexture'))),
        pyxb.binding.content.ContentModelTransition(next_state=10, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'wrapMode'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfParameterizedTexture'))),
