...
<head>
  <title>pyxb.binding.facets.CF_length</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="pyxb.binding.facets.CF_length-class.html"
...
<!-- ==================== CLASS DESCRIPTION ==================== -->
<h1 class="epydoc">Class CF_length</h1><p class="nomargin-top"><span class="codelink"><a href="pyxb.binding.facets-pysrc.html#CF_length">source&nbsp;code</a></span></p>
<pre class="base-tree">
object --+            
         |            
 ...
 <a href="pyxb.binding.facets.ConstrainingFacet-class.html">ConstrainingFacet</a> --+
    ...
    object --+       |
      ...
      <a href="pyxb.binding.facets._Fixed_mixin-class.html" onclick="show_private();">_Fixed_mixin</a> --+
                     |
                    <strong class="uidshort">CF_length</strong>
</pre>

<hr />
<p>A facet that specifies the length of the lexical representation of a 
  value.</p>
  <p>See <a href="http://www.w3.org/TR/xmlschema-2/#rf-length" 
  target="_top">http://www.w3.org/TR/xmlschema-2/#rf-length</a></p>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.binding.facets.CF_length-class.html#_validateConstraint_vx" class="summary-sig-name" onclick="show_private();">_validateConstraint_vx</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">value</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.facets-pysrc.html#CF_length._validateConstraint_vx">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="_Name"></a><span class="summary-name">_Name</span> = <code title="'length'"><code class="variable-quote">'</code><code class="variable-string">length</code><code class="variable-quote">'</code></code>
    </td>
  </tr>
  <tr>
    <td colspan="2" class="summary">
