...
<head>
  <title>pyxb.binding.facets.CF_maxInclusive</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="pyxb.binding.facets.CF_maxInclusive-class.html"
...
<!-- ==================== CLASS DESCRIPTION ==================== -->
<h1 class="epydoc">Class CF_maxInclusive</h1><p class="nomargin-top"><span class="codelink"><a href="pyxb.binding.facets-pysrc.html#CF_maxInclusive">source&nbsp;code</a></span></p>
<pre class="base-tree">
 object --+            
          |            
...
<a href="pyxb.binding.facets._LateDatatype_mixin-class.html" onclick="show_private();">_LateDatatype_mixin</a> --+
                      |
                     <strong class="uidshort">CF_maxInclusive</strong>
</pre>

<hr />
<p>Specify the maximum legal value for the constrained type.</p>
  <p>See <a href="http://www.w3.org/TR/xmlschema-2/#rf-maxInclusive" 
  target="_top">http://www.w3.org/TR/xmlschema-2/#rf-maxInclusive</a></p>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.binding.facets.CF_maxInclusive-class.html#_validateConstraint_vx" class="summary-sig-name" onclick="show_private();">_validateConstraint_vx</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">value</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.facets-pysrc.html#CF_maxInclusive._validateConstraint_vx">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="_Name"></a><span class="summary-name">_Name</span> = <code title="'maxInclusive'"><code class="variable-quote">'</code><code class="variable-string">maxInclusive</code><code class="variable-quote">'</code></code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
