...
<head>
  <title>pyxb.binding.datatypes.hexBinary</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="pyxb.binding.datatypes.hexBinary-class.html"
...
<!-- ==================== CLASS DESCRIPTION ==================== -->
<h1 class="epydoc">Class hexBinary</h1><p class="nomargin-top"><span class="codelink"><a href="pyxb.binding.datatypes-pysrc.html#hexBinary">source&nbsp;code</a></span></p>
<pre class="base-tree">
                    object --+                
                             |                
            ...
            <a href="pyxb.binding.basis._DynamicCreate_mixin-class.html" onclick="show_private();">basis._DynamicCreate_mixin</a> --+    
                ...
                <a href="pyxb.binding.basis.simpleTypeDefinition-class.html">basis.simpleTypeDefinition</a> --+
                                ...
                                object --+   |
                                      ...
                                      long --+
                                             |
                                            <strong class="uidshort">hexBinary</strong>
</pre>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="length"></a><span class="summary-sig-name">length</span>(<span class="summary-sig-arg">self</span>)</span><br />
      Return the length of the value, in octets.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.datatypes-pysrc.html#hexBinary.length">source&nbsp;code</a></span>
  ...
  <tr>
    ...
    <p class="indent-wrapped-lines"><b>Inherited from <code>long</code></b>:
      <code>__abs__</code>,
      <code>__add__</code>,
      <code>__and__</code>,
      <code>__cmp__</code>,
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="_ConvertString"></a><span class="summary-sig-name">_ConvertString</span>(<span class="summary-sig-arg">cls</span>,
        <span class="summary-sig-arg">text</span>)</span><br />
      Convert a sequence of pairs of hex digits into a length (in octets) 
      and a binary value.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.datatypes-pysrc.html#hexBinary._ConvertString">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="_ConvertValue"></a><span class="summary-sig-name">_ConvertValue</span>(<span class="summary-sig-arg">cls</span>,
        <span class="summary-sig-arg">value</span>)</span><br />
      Given an integral value, return a pair consisting of the number of 
      octets required to represent the value, and the value.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.datatypes-pysrc.html#hexBinary._ConvertValue">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.binding.datatypes.hexBinary-class.html#XsdLiteral" class="summary-sig-name">XsdLiteral</a>(<span class="summary-sig-arg">cls</span>,
        <span class="summary-sig-arg">value</span>)</span><br />
      Convert from a python value to a string usable in an XML document.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.datatypes-pysrc.html#hexBinary.XsdLiteral">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.binding.datatypes.hexBinary-class.html#XsdValueLength" class="summary-sig-name">XsdValueLength</a>(<span class="summary-sig-arg">cls</span>,
        <span class="summary-sig-arg">value</span>)</span><br />
      Return the length of the given value.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.datatypes-pysrc.html#hexBinary.XsdValueLength">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.binding.datatypes.hexBinary-class.html#__new__" class="summary-sig-name">__new__</a>(<span class="summary-sig-arg">cls</span>,
        <span class="summary-sig-arg">*args</span>,
        <span class="summary-sig-arg">**kw</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.datatypes-pysrc.html#hexBinary.__new__">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.datatypes.hexBinary-class.html#_ExpandedName" class="summary-name" onclick="show_private();">_ExpandedName</a> = <code title="pyxb.namespace.XMLSchema.createExpandedName('hexBinary')">pyxb.namespace.XMLSchema.createExpandedName('h<code class="variable-ellipsis">...</code></code><br />
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__length"></a><span class="summary-name">__length</span> = <code title="None">None</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.datatypes.hexBinary-class.html#_CF_enumeration" class="summary-name" onclick="show_private();">_CF_enumeration</a> = <code title="&lt;pyxb.binding.facets.CF_enumeration object at 0x9c6662c&gt;">&lt;pyxb.binding.facets.CF_enumeration object a<code class="variable-ellipsis">...</code></code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="_CF_length"></a><span class="summary-name">_CF_length</span> = <code title="&lt;pyxb.binding.facets.CF_length object at 0x9c66f0c&gt;">&lt;pyxb.binding.facets.CF_length object at 0x9c66f0c&gt;</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.datatypes.hexBinary-class.html#_CF_maxLength" class="summary-name" onclick="show_private();">_CF_maxLength</a> = <code title="&lt;pyxb.binding.facets.CF_maxLength object at 0x9c66f2c&gt;">&lt;pyxb.binding.facets.CF_maxLength object at 0x<code class="variable-ellipsis">...</code></code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.datatypes.hexBinary-class.html#_CF_minLength" class="summary-name" onclick="show_private();">_CF_minLength</a> = <code title="&lt;pyxb.binding.facets.CF_minLength object at 0x9c66f6c&gt;">&lt;pyxb.binding.facets.CF_minLength object at 0x<code class="variable-ellipsis">...</code></code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.datatypes.hexBinary-class.html#_CF_pattern" class="summary-name" onclick="show_private();">_CF_pattern</a> = <code title="&lt;pyxb.binding.facets.CF_pattern object at 0x9c6666c&gt;">&lt;pyxb.binding.facets.CF_pattern object at 0x9c66<code class="variable-ellipsis">...</code></code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.datatypes.hexBinary-class.html#_CF_whiteSpace" class="summary-name" onclick="show_private();">_CF_whiteSpace</a> = <code title="&lt;pyxb.binding.facets.CF_whiteSpace object at 0x9c66f4c&gt;">&lt;pyxb.binding.facets.CF_whiteSpace object at <code class="variable-ellipsis">...</code></code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.datatypes.hexBinary-class.html#_httpwww_w3_org2001XMLSchema_hexBinary_FacetMap" class="summary-name" onclick="show_private();">_httpwww_w3_org2001XMLSchema_hexBinary_FacetMap</a> = <code title="{&lt;class 'pyxb.binding.facets.CF_whiteSpace'&gt;: &lt;pyxb.binding.facets.CF_\
...
<a name="_httpwww_w3_org2001XMLSchema_hexBinary_FacetMap"></a>
<div class="private">
<table class="details" border="1" cellpadding="3"
       cellspacing="0" width="100%" bgcolor="white">
<tr><td>
  <h3 class="epydoc">_httpwww_w3_org2001XMLSchema_hexBinary_FacetMap</h3>
...
whiteSpace object at 0x9c66f4c&gt;<code class="variable-op">,</code>
...
tern object at 0x9c6666c&gt;<code class="variable-op">,</code>
...
_enumeration object at 0x9c6662c&gt;<code class="variable-op">,</code>
...
th object at 0x9c66f0c&gt;<code class="variable-op">,</code>
