...
<head>
  <title>pyxb.binding.facets.CF_pattern</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="pyxb.binding.facets.CF_pattern-class.html"
...
<!-- ==================== CLASS DESCRIPTION ==================== -->
<h1 class="epydoc">Class CF_pattern</h1><p class="nomargin-top"><span class="codelink"><a href="pyxb.binding.facets-pysrc.html#CF_pattern">source&nbsp;code</a></span></p>
<pre class="base-tree">
    object --+            
             |            
...
<a href="pyxb.binding.facets._CollectionFacet_mixin-class.html" onclick="show_private();">_CollectionFacet_mixin</a> --+
                         |
                        <strong class="uidshort">CF_pattern</strong>
</pre>

<hr />
<p>A facet that constrains the lexical representation of a value to match
  one of a set of patterns.</p>
  <p>See <a href="http://www.w3.org/TR/xmlschema-2/#rf-pattern" 
  target="_top">http://www.w3.org/TR/xmlschema-2/#rf-pattern</a></p>

<hr />
<div class="fields">      <p><strong>Note:</strong>
        In PyXB, pattern constraints are ignored for any type with a Python
        representation that does not derive from <code>basestring</code>. 
      ...
      <p><strong>To Do:</strong>
        On creating new instances of non-string simple types from string 
    representations, we could apply pattern constraints.  That would mean 
    checking them prior to invoking the Factory method.
      </p>
</div><!-- ==================== NESTED CLASSES ==================== -->
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.facets._PatternElement-class.html" class="summary-name" onclick="show_private();">_CollectionFacet_itemType</a><br />
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.datatypes.string-class.html" class="summary-name" onclick="show_private();">_ValueDatatype</a><br />
      string.
    </td>
  </tr>
</table>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="patternElements"></a><span class="summary-sig-name">patternElements</span>(<span class="summary-sig-arg">self</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.facets-pysrc.html#CF_pattern.patternElements">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.binding.facets.CF_pattern-class.html#__init__" class="summary-sig-name">__init__</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">**kw</span>)</span><br />
      Create a facet instance, initializing it from the keyword parameters.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.facets-pysrc.html#CF_pattern.__init__">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="addPattern"></a><span class="summary-sig-name">addPattern</span>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">**kw</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.facets-pysrc.html#CF_pattern.addPattern">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.binding.facets.CF_pattern-class.html#_validateConstraint_vx" class="summary-sig-name" onclick="show_private();">_validateConstraint_vx</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">value</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.facets-pysrc.html#CF_pattern._validateConstraint_vx">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="_Name"></a><span class="summary-name">_Name</span> = <code title="'pattern'"><code class="variable-quote">'</code><code class="variable-string">pattern</code><code class="variable-quote">'</code></code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__patternElements"></a><span class="summary-name">__patternElements</span> = <code title="None">None</code>
    </td>
  </tr>
  <tr>
    <td colspan="2" class="summary">
