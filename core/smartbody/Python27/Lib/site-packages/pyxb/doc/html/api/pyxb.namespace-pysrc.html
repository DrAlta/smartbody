...
<a name="L91"></a><tt class="py-lineno"> 91</tt>  <tt class="py-line"><tt class="py-comment"></tt>        <tt class="py-keyword">if</tt> <tt id="link-16" class="py-name" targets="Method pyxb.binding.basis.element.name()=pyxb.binding.basis.element-class.html#name,Method pyxb.binding.content.AttributeUse.name()=pyxb.binding.content.AttributeUse-class.html#name,Method pyxb.binding.content.ElementUse.name()=pyxb.binding.content.ElementUse-class.html#name,Variable pyxb.utils.saxdom.Node.name=pyxb.utils.saxdom.Node-class.html#name,Method pyxb.xmlschema.structures._NamedComponent_mixin.name()=pyxb.xmlschema.structures._NamedComponent_mixin-class.html#name"><a title="pyxb.binding.basis.element.name
...
<a name="L96"></a><tt class="py-lineno"> 96</tt>  <tt class="py-line"><tt class="py-comment"></tt>        <tt class="py-name">category_value</tt> <tt class="py-op">=</tt> <tt class="py-name">self</tt><tt class="py-op">.</tt><tt id="link-21" class="py-name"><a title="pyxb.binding.generate.NamespaceModule.namespace
pyxb.exceptions_.NamespaceError.namespace
pyxb.exceptions_.SchemaUniquenessError.namespace
pyxb.namespace
pyxb.namespace.ExpandedName.namespace
...
<a name="L155"></a><tt class="py-lineno">155</tt>  <tt class="py-line"><tt class="py-comment"></tt>            <tt class="py-op">(</tt> <tt class="py-name">ns</tt><tt class="py-op">,</tt> <tt class="py-name">ln</tt> <tt class="py-op">)</tt> <tt class="py-op">=</tt> <tt class="py-name">args</tt> </tt>
...
<a name="L158"></a><tt class="py-lineno">158</tt>  <tt class="py-line"><tt class="py-comment"></tt>            <tt class="py-keyword">assert</tt> <tt class="py-number">1</tt> <tt class="py-op">==</tt> <tt class="py-name">len</tt><tt class="py-op">(</tt><tt class="py-name">args</tt><tt class="py-op">)</tt> </tt>
...
<a name="L360"></a><tt class="py-lineno">360</tt>  <tt class="py-line"><tt class="py-comment"></tt>    <tt class="py-comment"># is the state that should hold prior to loading a saved namespace; at</tt> </tt>
<a name="L361"></a><tt class="py-lineno">361</tt>  <tt class="py-line"><tt class="py-comment"></tt>    <tt class="py-comment"># tthe moment, we do not support aggregating components defined separately</tt> </tt>
<a name="L362"></a><tt class="py-lineno">362</tt>  <tt class="py-line"><tt class="py-comment"></tt>    <tt class="py-comment"># into the same namespace.  That should be done at the schema level using</tt> </tt>
<a name="L363"></a><tt class="py-lineno">363</tt>  <tt class="py-line"><tt class="py-comment"></tt>    <tt class="py-comment"># the "include" element.</tt> </tt>
<a name="_NamespaceCategory_mixin.__checkCategoriesEmpty"></a><div id="_NamespaceCategory_mixin.__checkCategoriesEmpty-def"><a name="L364"></a><tt class="py-lineno">364</tt> <a class="py-toggle" href="#" id="_NamespaceCategory_mixin.__checkCategoriesEmpty-toggle" onclick="return toggle('_NamespaceCategory_mixin.__checkCategoriesEmpty');">-</a><tt class="py-line"><tt class="py-comment"></tt>    <tt class="py-keyword">def</tt> <a class="py-def-name" href="pyxb.namespace._NamespaceCategory_mixin-class.html#__checkCategoriesEmpty">__checkCategoriesEmpty</a> <tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="L477"></a><tt class="py-lineno">477</tt>  <tt class="py-line"><tt class="py-comment"></tt>    <tt class="py-comment"># namespace.</tt> </tt>
<a name="L478"></a><tt class="py-lineno">478</tt>  <tt class="py-line"><tt class="py-comment"></tt>    <tt id="link-219" class="py-name" targets="Variable pyxb.binding.generate.NamespaceGroupModule.__components=pyxb.binding.generate.NamespaceGroupModule-class.html#__components,Variable pyxb.binding.generate.NamespaceModule.__components=pyxb.binding.generate.NamespaceModule-class.html#__components,Variable pyxb.namespace._NamespaceComponentAssociation_mixin.__components=pyxb.namespace._NamespaceComponentAssociation_mixin-class.html#__components"><a title="pyxb.binding.generate.NamespaceGroupModule.__components
...
pyxb.binding.generate.NamespaceModule.__components
pyxb.namespace._NamespaceComponentAssociation_mixin.__components" class="py-name" href="#" onclick="return doclink('link-229', '__components', 'link-219');">__components</a></tt><tt class="py-op">.</tt><tt id="link-230" class="py-name"><a title="pyxb.binding.nfa.AllWalker.add
pyxb.namespace.archive.NamespaceArchive.add
...
pyxb.binding.generate.NamespaceModule.__components
pyxb.namespace._NamespaceComponentAssociation_mixin.__components" class="py-name" href="#" onclick="return doclink('link-233', '__components', 'link-219');">__components</a></tt><tt class="py-op">.</tt><tt id="link-234" class="py-name"><a title="pyxb.binding.nfa.AllWalker.add
pyxb.namespace.archive.NamespaceArchive.add
...
<a name="L515"></a><tt class="py-lineno">515</tt>  <tt class="py-line">        <tt class="py-name">self</tt><tt class="py-op">.</tt><tt id="link-256" class="py-name"><a title="pyxb.namespace._NamespaceComponentAssociation_mixin.__origins" class="py-name" href="#" onclick="return doclink('link-256', '__origins', 'link-223');">__origins</a></tt><tt class="py-op">.</tt><tt id="link-257" class="py-name"><a title="pyxb.binding.nfa.AllWalker.add
pyxb.namespace.archive.NamespaceArchive.add
...
<a name="L531"></a><tt class="py-lineno">531</tt>  <tt class="py-line">                <tt class="py-name">s</tt><tt class="py-op">.</tt><tt id="link-272" class="py-name"><a title="pyxb.binding.nfa.AllWalker.add
pyxb.namespace.archive.NamespaceArchive.add
...
<a name="L566"></a><tt class="py-lineno">566</tt>  <tt class="py-line"><tt class="py-comment"></tt>    <tt class="py-comment"># namespace.</tt> </tt>
<a name="L567"></a><tt class="py-lineno">567</tt>  <tt class="py-line"><tt class="py-comment"></tt>    <tt id="link-283" class="py-name" targets="Variable pyxb.namespace.Namespace.__uri=pyxb.namespace.Namespace-class.html#__uri"><a title="pyxb.namespace.Namespace.__uri" class="py-name" href="#" onclick="return doclink('link-283', '__uri', 'link-283');">__uri</a></tt> <tt class="py-op">=</tt> <tt class="py-name">None</tt> </tt>
...
<a name="L570"></a><tt class="py-lineno">570</tt>  <tt class="py-line"><tt class="py-comment"></tt>    <tt class="py-comment"># absent namespaces.  Currently this value is not accessible to the user,</tt> </tt>
<a name="L571"></a><tt class="py-lineno">571</tt>  <tt class="py-line"><tt class="py-comment"></tt>    <tt class="py-comment"># and exists solely to provide a unique identifier when printing the</tt> </tt>
<a name="L572"></a><tt class="py-lineno">572</tt>  <tt class="py-line"><tt class="py-comment"></tt>    <tt class="py-comment"># namespace as a string.  The class variable is used as a one-up counter,</tt> </tt>
<a name="L573"></a><tt class="py-lineno">573</tt>  <tt class="py-line"><tt class="py-comment"></tt>    <tt class="py-comment"># which is assigned to the instance variable when an absent namespace</tt> </tt>
<a name="L574"></a><tt class="py-lineno">574</tt>  <tt class="py-line"><tt class="py-comment"></tt>    <tt class="py-comment"># instance is created.</tt> </tt>
<a name="L575"></a><tt class="py-lineno">575</tt>  <tt class="py-line"><tt class="py-comment"></tt>    <tt id="link-284" class="py-name" targets="Variable pyxb.namespace.Namespace.__absentNamespaceID=pyxb.namespace.Namespace-class.html#__absentNamespaceID"><a title="pyxb.namespace.Namespace.__absentNamespaceID" class="py-name" href="#" onclick="return doclink('link-284', '__absentNamespaceID', 'link-284');">__absentNamespaceID</a></tt> <tt class="py-op">=</tt> <tt class="py-number">0</tt> </tt>
...
<a name="L578"></a><tt class="py-lineno">578</tt>  <tt class="py-line"><tt class="py-comment"></tt>    <tt class="py-comment"># xml and xmlns.</tt> </tt>
<a name="L579"></a><tt class="py-lineno">579</tt>  <tt class="py-line"><tt class="py-comment"></tt>    <tt id="link-285" class="py-name" targets="Variable pyxb.namespace.Namespace.__boundPrefix=pyxb.namespace.Namespace-class.html#__boundPrefix"><a title="pyxb.namespace.Namespace.__boundPrefix" class="py-name" href="#" onclick="return doclink('link-285', '__boundPrefix', 'link-285');">__boundPrefix</a></tt> <tt class="py-op">=</tt> <tt class="py-name">None</tt> </tt>
...
<a name="L582"></a><tt class="py-lineno">582</tt>  <tt class="py-line"><tt class="py-comment"></tt>    <tt class="py-comment"># declaration.</tt> </tt>
<a name="L583"></a><tt class="py-lineno">583</tt>  <tt class="py-line"><tt class="py-comment"></tt>    <tt id="link-286" class="py-name" targets="Variable pyxb.binding.datatypes.QName.__prefix=pyxb.binding.datatypes.QName-class.html#__prefix,Variable pyxb.namespace.Namespace.__prefix=pyxb.namespace.Namespace-class.html#__prefix,Variable pyxb.xmlschema.structures._ImportElementInformationItem.__prefix=pyxb.xmlschema.structures._ImportElementInformationItem-class.html#__prefix"><a title="pyxb.binding.datatypes.QName.__prefix
...
<a name="L586"></a><tt class="py-lineno">586</tt>  <tt class="py-line"><tt class="py-comment"></tt>    <tt class="py-comment"># must be unique for their URI.  See __new__().</tt> </tt>
<a name="L587"></a><tt class="py-lineno">587</tt>  <tt class="py-line"><tt class="py-comment"></tt>    <tt id="link-287" class="py-name" targets="Variable pyxb.namespace.Namespace.__Registry=pyxb.namespace.Namespace-class.html#__Registry"><a title="pyxb.namespace.Namespace.__Registry" class="py-name" href="#" onclick="return doclink('link-287', '__Registry', 'link-287');">__Registry</a></tt> <tt class="py-op">=</tt> <tt class="py-op">{</tt> <tt class="py-op">}</tt> </tt>
...
<a name="L616"></a><tt class="py-lineno">616</tt>  <tt class="py-line"><tt class="py-comment"></tt>    <tt class="py-comment"># were generated.  Not currently used, since we don't have different</tt> </tt>
<a name="L617"></a><tt class="py-lineno">617</tt>  <tt class="py-line"><tt class="py-comment"></tt>    <tt class="py-comment"># binding configurations yet.</tt> </tt>
<a name="L618"></a><tt class="py-lineno">618</tt>  <tt class="py-line"><tt class="py-comment"></tt>    <tt id="link-297" class="py-name" targets="Variable pyxb.namespace.Namespace.__bindingConfiguration=pyxb.namespace.Namespace-class.html#__bindingConfiguration"><a title="pyxb.namespace.Namespace.__bindingConfiguration" class="py-name" href="#" onclick="return doclink('link-297', '__bindingConfiguration', 'link-297');">__bindingConfiguration</a></tt> <tt class="py-op">=</tt> <tt class="py-name">None</tt> </tt>
...
<a name="L621"></a><tt class="py-lineno">621</tt>  <tt class="py-line"><tt class="py-comment"></tt>    <tt class="py-comment"># The namespace context used when creating built-in components that belong</tt> </tt>
<a name="L622"></a><tt class="py-lineno">622</tt>  <tt class="py-line"><tt class="py-comment"></tt>    <tt class="py-comment"># to this namespace.  This is used to satisfy the low-level requirement</tt> </tt>
<a name="L623"></a><tt class="py-lineno">623</tt>  <tt class="py-line"><tt class="py-comment"></tt>    <tt class="py-comment"># that all schema components have a namespace context; normally, that</tt> </tt>
<a name="L624"></a><tt class="py-lineno">624</tt>  <tt class="py-line"><tt class="py-comment"></tt>    <tt class="py-comment"># context is built dynamically from the schema element.</tt> </tt>
<a name="L625"></a><tt class="py-lineno">625</tt>  <tt class="py-line"><tt class="py-comment"></tt>    <tt id="link-298" class="py-name" targets="Variable pyxb.namespace.Namespace.__initialNamespaceContext=pyxb.namespace.Namespace-class.html#__initialNamespaceContext"><a title="pyxb.namespace.Namespace.__initialNamespaceContext" class="py-name" href="#" onclick="return doclink('link-298', '__initialNamespaceContext', 'link-298');">__initialNamespaceContext</a></tt> <tt class="py-op">=</tt> <tt class="py-name">None</tt> </tt>
...
<a name="L632"></a><tt class="py-lineno">632</tt>  <tt class="py-line"><tt class="py-comment"></tt>    <tt class="py-comment"># this namespace.  Only used with built-in namespaces.</tt> </tt>
<a name="L633"></a><tt class="py-lineno">633</tt>  <tt class="py-line"><tt class="py-comment"></tt>    <tt id="link-300" class="py-name" targets="Variable pyxb.namespace.Namespace.__contextInScopeNamespaces=pyxb.namespace.Namespace-class.html#__contextInScopeNamespaces"><a title="pyxb.namespace.Namespace.__contextInScopeNamespaces" class="py-name" href="#" onclick="return doclink('link-300', '__contextInScopeNamespaces', 'link-300');">__contextInScopeNamespaces</a></tt> <tt class="py-op">=</tt> <tt class="py-name">None</tt> </tt>
...
<a name="L670"></a><tt class="py-lineno">670</tt>  <tt class="py-line"><tt class="py-comment"></tt>            <tt class="py-keyword">if</tt> <tt id="link-315" class="py-name"><a title="pyxb.namespace.Namespace.uri" class="py-name" href="#" onclick="return doclink('link-315', 'uri', 'link-73');">uri</a></tt> <tt class="py-keyword">is</tt> <tt class="py-name">None</tt><tt class="py-op">:</tt> </tt>
<a name="L671"></a><tt class="py-lineno">671</tt>  <tt class="py-line">                <tt class="py-name">cls</tt><tt class="py-op">.</tt><tt id="link-316" class="py-name"><a title="pyxb.namespace.Namespace.__AbsentNamespaces" class="py-name" href="#" onclick="return doclink('link-316', '__AbsentNamespaces', 'link-288');">__AbsentNamespaces</a></tt><tt class="py-op">.</tt><tt id="link-317" class="py-name"><a title="pyxb.binding.nfa.AllWalker.add
pyxb.namespace.archive.NamespaceArchive.add
...
<a name="L701"></a><tt class="py-lineno">701</tt>  <tt class="py-line"><tt class="py-comment"></tt>        <tt class="py-name">super</tt><tt class="py-op">(</tt><tt id="link-325" class="py-name"><a title="pyxb.binding.xml_.Namespace
...
<a name="L707"></a><tt class="py-lineno">707</tt>  <tt class="py-line"><tt class="py-comment"></tt>        <tt class="py-comment"># built-in namespaces</tt> </tt>
<a name="L708"></a><tt class="py-lineno">708</tt>  <tt class="py-line"><tt class="py-comment"></tt>        <tt class="py-name">is_builtin_namespace</tt> <tt class="py-op">=</tt> <tt class="py-keyword">not</tt> <tt class="py-op">(</tt><tt class="py-name">builtin_namespace</tt> <tt class="py-keyword">is</tt> <tt class="py-name">None</tt><tt class="py-op">)</tt> </tt>
...
<a name="L714"></a><tt class="py-lineno">714</tt>  <tt class="py-line"><tt class="py-comment"></tt>        <tt class="py-comment"># see __new__().</tt> </tt>
<a name="L715"></a><tt class="py-lineno">715</tt>  <tt class="py-line"><tt class="py-comment"></tt>        <tt class="py-keyword">assert</tt> <tt class="py-name">self</tt><tt class="py-op">.</tt><tt id="link-331" class="py-name"><a title="pyxb.namespace.Namespace.__uri" class="py-name" href="#" onclick="return doclink('link-331', '__uri', 'link-283');">__uri</a></tt> <tt class="py-op">==</tt> <tt id="link-332" class="py-name"><a title="pyxb.namespace.Namespace.uri" class="py-name" href="#" onclick="return doclink('link-332', 'uri', 'link-73');">uri</a></tt> </tt>
...
<a name="L898"></a><tt class="py-lineno">898</tt>  <tt class="py-line"><tt class="py-comment"></tt>            <tt class="py-keyword">if</tt> <tt class="py-name">structures_module</tt> <tt class="py-keyword">is</tt> <tt class="py-name">None</tt><tt class="py-op">:</tt> </tt>
...
<a name="L984"></a><tt class="py-lineno">984</tt>  <tt class="py-line"><tt class="py-comment"></tt><tt class="py-comment">## fill-column:78</tt> </tt>
<a name="L985"></a><tt class="py-lineno">985</tt>  <tt class="py-line"><tt class="py-comment"></tt><tt class="py-comment">## End:</tt> </tt>
<a name="L986"></a><tt class="py-lineno">986</tt>  <tt class="py-line"><tt class="py-comment"></tt> </tt><script type="text/javascript">
<!--
