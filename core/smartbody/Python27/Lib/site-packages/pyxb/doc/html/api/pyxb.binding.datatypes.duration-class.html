...
<head>
  <title>pyxb.binding.datatypes.duration</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="pyxb.binding.datatypes.duration-class.html"
...
<!-- ==================== CLASS DESCRIPTION ==================== -->
<h1 class="epydoc">Class duration</h1><p class="nomargin-top"><span class="codelink"><a href="pyxb.binding.datatypes-pysrc.html#duration">source&nbsp;code</a></span></p>
<pre class="base-tree">
                    object --+                
                             |                
...
<hr />
<p><a href="http://www.w3.org/TR/xmlschema-2/#duration" 
  target="_top">http://www.w3.org/TR/xmlschema-2/#duration</a></p>
  <p>This class uses the Python <code>datetime.timedelta</code> class as 
  ...
  microseconds.</p>
  <p>In other words, the implementation of this type is a little 
  shakey.</p>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="negativeDuration"></a><span class="summary-sig-name">negativeDuration</span>(<span class="summary-sig-arg">self</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.datatypes-pysrc.html#duration.negativeDuration">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="durationData"></a><span class="summary-sig-name">durationData</span>(<span class="summary-sig-arg">self</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.datatypes-pysrc.html#duration.durationData">source&nbsp;code</a></span>
  ...
  <tr>
    ...
    <p class="indent-wrapped-lines"><b>Inherited from <code>datetime.timedelta</code></b>:
      <code>__abs__</code>,
      <code>__add__</code>,
      <code>__div__</code>,
      <code>__eq__</code>,
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.binding.datatypes.duration-class.html#XsdLiteral" class="summary-sig-name">XsdLiteral</a>(<span class="summary-sig-arg">cls</span>,
        <span class="summary-sig-arg">value</span>)</span><br />
      Convert from a python value to a string usable in an XML document.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.datatypes-pysrc.html#duration.XsdLiteral">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.binding.datatypes.duration-class.html#__new__" class="summary-sig-name">__new__</a>(<span class="summary-sig-arg">cls</span>,
        <span class="summary-sig-arg">*args</span>,
        <span class="summary-sig-arg">**kw</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.datatypes-pysrc.html#duration.__new__">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.datatypes.duration-class.html#_ExpandedName" class="summary-name" onclick="show_private();">_ExpandedName</a> = <code title="pyxb.namespace.XMLSchema.createExpandedName('duration')">pyxb.namespace.XMLSchema.createExpandedName('d<code class="variable-ellipsis">...</code></code><br />
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.datatypes.duration-class.html#__Lexical_re" class="summary-name" onclick="show_private();">__Lexical_re</a> = <code title="re.compile(r'^(?P&lt;neg&gt;-?)P((?P&lt;years&gt;\d+)Y)?((?P&lt;months&gt;\d+)M)?((?P&lt;da\
ys&gt;\d+)D)?(?P&lt;Time&gt;T((?P&lt;hours&gt;\d+)H)?((?P&lt;minutes&gt;\d+)M)?(((?P&lt;second\
s&gt;\d+)(?P&lt;fracsec&gt;\.\d+)?)S)?)?$')">re.compile(r'^<code class="re-group">(?P&lt;</code><code class="re-ref">neg</code><code class="re-group">&gt;</code>-<code class="re-op">?</code><code class="re-group">)</code>P<code class="re-group">(</code><code class="re-group">(?P&lt;</code><code class="re-ref">years</code><code class="re-group">&gt;</code>\d<code class="re-op">+</code><code class="re-group">)</code>Y<code class="re-group">)</code><code class="re-op">?</code><code class="re-group">(</code><code class="re-group">(?</code><code class="variable-ellipsis">...</code></code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.datatypes.duration-class.html#__XSDFields" class="summary-name" onclick="show_private();">__XSDFields</a> = <code title="('years', 'months', 'days', 'hours', 'minutes', 'seconds')"><code class="variable-group">(</code><code class="variable-quote">'</code><code class="variable-string">years</code><code class="variable-quote">'</code><code class="variable-op">, </code><code class="variable-quote">'</code><code class="variable-string">months</code><code class="variable-quote">'</code><code class="variable-op">, </code><code class="variable-quote">'</code><code class="variable-string">days</code><code class="variable-quote">'</code><code class="variable-op">, </code><code class="variable-quote">'</code><code class="variable-string">hours</code><code class="variable-quote">'</code><code class="variable-op">, </code><code class="variable-quote">'</code><code class="variable-string">minutes</code><code class="variable-quote">'</code><code class="variable-op">, </code><code class="variable-ellipsis">...</code></code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.datatypes.duration-class.html#__PythonFields" class="summary-name" onclick="show_private();">__PythonFields</a> = <code title="('days', 'seconds', 'microseconds', 'minutes', 'hours')"><code class="variable-group">(</code><code class="variable-quote">'</code><code class="variable-string">days</code><code class="variable-quote">'</code><code class="variable-op">, </code><code class="variable-quote">'</code><code class="variable-string">seconds</code><code class="variable-quote">'</code><code class="variable-op">, </code><code class="variable-quote">'</code><code class="variable-string">microseconds</code><code class="variable-quote">'</code><code class="variable-op">, </code><code class="variable-quote">'</code><code class="variable-string">minutes</code><code class="variable-quote">'</code><code class="variable-ellipsis">...</code></code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__negativeDuration"></a><span class="summary-name">__negativeDuration</span> = <code title="None">None</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__durationData"></a><span class="summary-name">__durationData</span> = <code title="None">None</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.datatypes.duration-class.html#_CF_enumeration" class="summary-name" onclick="show_private();">_CF_enumeration</a> = <code title="&lt;pyxb.binding.facets.CF_enumeration object at 0x9c669cc&gt;">&lt;pyxb.binding.facets.CF_enumeration object a<code class="variable-ellipsis">...</code></code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.datatypes.duration-class.html#_CF_maxExclusive" class="summary-name" onclick="show_private();">_CF_maxExclusive</a> = <code title="&lt;pyxb.binding.facets.CF_maxExclusive object at 0x9c66a6c&gt;">&lt;pyxb.binding.facets.CF_maxExclusive object<code class="variable-ellipsis">...</code></code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.datatypes.duration-class.html#_CF_maxInclusive" class="summary-name" onclick="show_private();">_CF_maxInclusive</a> = <code title="&lt;pyxb.binding.facets.CF_maxInclusive object at 0x9c66a4c&gt;">&lt;pyxb.binding.facets.CF_maxInclusive object<code class="variable-ellipsis">...</code></code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.datatypes.duration-class.html#_CF_minExclusive" class="summary-name" onclick="show_private();">_CF_minExclusive</a> = <code title="&lt;pyxb.binding.facets.CF_minExclusive object at 0x9c6698c&gt;">&lt;pyxb.binding.facets.CF_minExclusive object<code class="variable-ellipsis">...</code></code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.datatypes.duration-class.html#_CF_minInclusive" class="summary-name" onclick="show_private();">_CF_minInclusive</a> = <code title="&lt;pyxb.binding.facets.CF_minInclusive object at 0x9c66a0c&gt;">&lt;pyxb.binding.facets.CF_minInclusive object<code class="variable-ellipsis">...</code></code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.datatypes.duration-class.html#_CF_pattern" class="summary-name" onclick="show_private();">_CF_pattern</a> = <code title="&lt;pyxb.binding.facets.CF_pattern object at 0x9c669ec&gt;">&lt;pyxb.binding.facets.CF_pattern object at 0x9c66<code class="variable-ellipsis">...</code></code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.datatypes.duration-class.html#_CF_whiteSpace" class="summary-name" onclick="show_private();">_CF_whiteSpace</a> = <code title="&lt;pyxb.binding.facets.CF_whiteSpace object at 0x9c66a2c&gt;">&lt;pyxb.binding.facets.CF_whiteSpace object at <code class="variable-ellipsis">...</code></code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.datatypes.duration-class.html#_httpwww_w3_org2001XMLSchema_duration_FacetMap" class="summary-name" onclick="show_private();">_httpwww_w3_org2001XMLSchema_duration_FacetMap</a> = <code title="{&lt;class 'pyxb.binding.facets.CF_whiteSpace'&gt;: &lt;pyxb.binding.facets.CF_\
whiteSpace object at 0x9c66a2c&gt;,
 &lt;class 'pyxb.binding.facets.CF_minInclusive'&gt;: &lt;pyxb.binding.facets.C\
F_minInclusive object at 0x9c66a0c&gt;,
 &lt;class 'pyxb.binding.facets.CF_maxInclusive'&gt;: &lt;pyxb.binding.facets.C\
F_maxInclusive object at 0x9c66a4c&gt;,
 &lt;class 'pyxb.binding.facets.CF_minExclusive'&gt;: &lt;pyxb.binding.facets.C\
F_minExclusive object at 0x9c6698c&gt;,
...
<tr><td>
  ...
  <dl class="fields">
    <dt>Value:</dt>
      <dd><table><tr><td><pre class="variable">
re.compile(r'^<code class="re-group">(?P&lt;</code><code class="re-ref">neg</code><code class="re-group">&gt;</code>-<code class="re-op">?</code><code class="re-group">)</code>P<code class="re-group">(</code><code class="re-group">(?P&lt;</code><code class="re-ref">years</code><code class="re-group">&gt;</code>\d<code class="re-op">+</code><code class="re-group">)</code>Y<code class="re-group">)</code><code class="re-op">?</code><code class="re-group">(</code><code class="re-group">(?P&lt;</code><code class="re-ref">months</code><code class="re-group">&gt;</code>\d<code class="re-op">+</code><code class="re-group">)</code>M<code class="re-group">)</code><code class="re-op">?</code><code class="re-group">(</code><code class="re-group">(?P&lt;</code><code class="re-ref">da</code><span class="variable-linewrap"><img src="crarr.png" alt="\" /></span>
<code class="re-ref">ys</code><code class="re-group">&gt;</code>\d<code class="re-op">+</code><code class="re-group">)</code>D<code class="re-group">)</code><code class="re-op">?</code><code class="re-group">(?P&lt;</code><code class="re-ref">Time</code><code class="re-group">&gt;</code>T<code class="re-group">(</code><code class="re-group">(?P&lt;</code><code class="re-ref">hours</code><code class="re-group">&gt;</code>\d<code class="re-op">+</code><code class="re-group">)</code>H<code class="re-group">)</code><code class="re-op">?</code><code class="re-group">(</code><code class="re-group">(?P&lt;</code><code class="re-ref">minutes</code><code class="re-group">&gt;</code>\d<code class="re-op">+</code><code class="re-group">)</code>M<code class="re-group">)</code><code class="re-op">?</code><code class="re-group">(</code><code class="re-group">(</code><code class="re-group">(?P&lt;</code><code class="re-ref">second</code><span class="variable-linewrap"><img src="crarr.png" alt="\" /></span>
<code class="re-ref">s</code><code class="re-group">&gt;</code>\d<code class="re-op">+</code><code class="re-group">)</code><code class="re-group">(?P&lt;</code><code class="re-ref">fracsec</code><code class="re-group">&gt;</code>\.\d<code class="re-op">+</code><code class="re-group">)</code><code class="re-op">?</code><code class="re-group">)</code>S<code class="re-group">)</code><code class="re-op">?</code><code class="re-group">)</code><code class="re-op">?</code>$')
</pre></td></tr></table>
</dd>
  </dl>
</td></tr></table>
</div>
<a name="__XSDFields"></a>
<div class="private">
<table class="details" border="1" cellpadding="3"
       cellspacing="0" width="100%" bgcolor="white">
<tr><td>
  <h3 class="epydoc">__XSDFields</h3>
...
<a name="__PythonFields"></a>
<div class="private">
<table class="details" border="1" cellpadding="3"
       cellspacing="0" width="100%" bgcolor="white">
<tr><td>
  <h3 class="epydoc">__PythonFields</h3>
...
<tr><td>
  ...
  <dl class="fields">
    <dt>Value:</dt>
      <dd><table><tr><td><pre class="variable">
&lt;pyxb.binding.facets.CF_enumeration object at 0x9c669cc&gt;
</pre></td></tr></table>
</dd>
  </dl>
</td></tr></table>
...
<tr><td>
  ...
  <dl class="fields">
    <dt>Value:</dt>
      <dd><table><tr><td><pre class="variable">
&lt;pyxb.binding.facets.CF_maxExclusive object at 0x9c66a6c&gt;
</pre></td></tr></table>
</dd>
  </dl>
</td></tr></table>
...
<tr><td>
  ...
  <dl class="fields">
    <dt>Value:</dt>
      <dd><table><tr><td><pre class="variable">
&lt;pyxb.binding.facets.CF_maxInclusive object at 0x9c66a4c&gt;
</pre></td></tr></table>
</dd>
  </dl>
</td></tr></table>
...
<tr><td>
  ...
  <dl class="fields">
    <dt>Value:</dt>
      <dd><table><tr><td><pre class="variable">
&lt;pyxb.binding.facets.CF_minExclusive object at 0x9c6698c&gt;
</pre></td></tr></table>
</dd>
  </dl>
</td></tr></table>
...
<tr><td>
  ...
  <dl class="fields">
    <dt>Value:</dt>
      <dd><table><tr><td><pre class="variable">
&lt;pyxb.binding.facets.CF_minInclusive object at 0x9c66a0c&gt;
</pre></td></tr></table>
</dd>
  </dl>
</td></tr></table>
...
<tr><td>
  ...
  <dl class="fields">
    <dt>Value:</dt>
      <dd><table><tr><td><pre class="variable">
&lt;pyxb.binding.facets.CF_pattern object at 0x9c669ec&gt;
</pre></td></tr></table>
</dd>
  </dl>
</td></tr></table>
...
<tr><td>
  ...
  <dl class="fields">
    <dt>Value:</dt>
      <dd><table><tr><td><pre class="variable">
&lt;pyxb.binding.facets.CF_whiteSpace object at 0x9c66a2c&gt;
</pre></td></tr></table>
</dd>
  </dl>
</td></tr></table>
</div>
<a name="_httpwww_w3_org2001XMLSchema_duration_FacetMap"></a>
<div class="private">
<table class="details" border="1" cellpadding="3"
       cellspacing="0" width="100%" bgcolor="white">
<tr><td>
  <h3 class="epydoc">_httpwww_w3_org2001XMLSchema_duration_FacetMap</h3>
  ...
  <dl class="fields">
    <dt>Value:</dt>
      <dd><table><tr><td><pre class="variable">
<code class="variable-group">{</code>&lt;class 'pyxb.binding.facets.CF_whiteSpace'&gt;<code class="variable-op">: </code>&lt;pyxb.binding.facets.CF_<span class="variable-linewrap"><img src="crarr.png" alt="\" /></span>
whiteSpace object at 0x9c66a2c&gt;<code class="variable-op">,</code>
...
F_minInclusive object at 0x9c66a0c&gt;<code class="variable-op">,</code>
...
F_maxInclusive object at 0x9c66a4c&gt;<code class="variable-op">,</code>
...
F_minExclusive object at 0x9c6698c&gt;<code class="variable-op">,</code>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%%">
  <tr>
    ...
    Generated by Epydoc 3.0.1 on Thu Jan 28 08:39:49 2010
    </td>
