...
# Generated 2010-01-28 08:41:28.850000 by PyXB version 1.1.1
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:98bee440-0c23-11df-9601-000c29370554')
...
class VectorPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_VectorPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    ...
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_VectorPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
class CTD_ANON_1 (AbstractDataComponentType):
    ...
    __quality = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'quality'), 'quality', '__httpwww_opengis_netswe1_0_CTD_ANON_1_httpwww_opengis_netswe1_0quality', False)
    ...
    __uom = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'uom'), 'uom', '__httpwww_opengis_netswe1_0_CTD_ANON_1_httpwww_opengis_netswe1_0uom', False)
    ...
    __referenceTime = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'referenceTime'), 'referenceTime', '__httpwww_opengis_netswe1_0_CTD_ANON_1_referenceTime', timeIso8601)
    ...
    __localFrame = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'localFrame'), 'localFrame', '__httpwww_opengis_netswe1_0_CTD_ANON_1_localFrame', pyxb.binding.datatypes.anyURI)
...
class CTD_ANON_2 (AbstractDataComponentType):
    ...
    __codeSpace = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'codeSpace'), 'codeSpace', '__httpwww_opengis_netswe1_0_CTD_ANON_2_httpwww_opengis_netswe1_0codeSpace', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}quality uses Python identifier quality
    __quality = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'quality'), 'quality', '__httpwww_opengis_netswe1_0_CTD_ANON_2_httpwww_opengis_netswe1_0quality', False)
...
class AllowedValuesPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_AllowedValuesPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    
    actuate = property(__actuate.value, __actuate.set, None, u"\n        The 'actuate' attribute is used to communicate the desired timing \n        of traversal from the starting resource to the ending resource; \n        it's value should be treated as follows:\n        onLoad - traverse to the ending resource immediately on loading \n                 the starting resource \n        onRequest - traverse from the starting resource to the ending \n                    resource only on a post-loading event triggered for \n                    this purpose \n        other - behavior is unconstrained; examine other markup in link \n                for hints \n        none - behavior is unconstrained\n      ")

    
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_AllowedValuesPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class BlockEncodingPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_BlockEncodingPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_BlockEncodingPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class CTD_ANON_4 (AbstractEncodingType):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_EMPTY
    _Abstract = False
    _ExpandedName = None
    ...
    __decimalSeparator = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'decimalSeparator'), 'decimalSeparator', '__httpwww_opengis_netswe1_0_CTD_ANON_4_decimalSeparator', decimalSeparator, required=True)
    ...
    __blockSeparator = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'blockSeparator'), 'blockSeparator', '__httpwww_opengis_netswe1_0_CTD_ANON_4_blockSeparator', textSeparator, required=True)
    ...
    __tokenSeparator = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'tokenSeparator'), 'tokenSeparator', '__httpwww_opengis_netswe1_0_CTD_ANON_4_tokenSeparator', textSeparator, required=True)
...
class CTD_ANON_5 (AbstractDataComponentType):
    ...
    # Element {http://www.opengis.net/swe/1.0}value uses Python identifier value_
    __value = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'value'), 'value_', '__httpwww_opengis_netswe1_0_CTD_ANON_5_httpwww_opengis_netswe1_0value', False)
...
class CTD_ANON_6 (AbstractDataComponentType):
    ...
    # Attribute axisID uses Python identifier axisID
    __axisID = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'axisID'), 'axisID', '__httpwww_opengis_netswe1_0_CTD_ANON_6_axisID', pyxb.binding.datatypes.token)
...
class CTD_ANON_7 (AbstractDataComponentType):
    ...
    # Element {http://www.opengis.net/swe/1.0}quality uses Python identifier quality
    __quality = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'quality'), 'quality', '__httpwww_opengis_netswe1_0_CTD_ANON_7_httpwww_opengis_netswe1_0quality', True)
    ...
    # Element {http://www.opengis.net/swe/1.0}constraint uses Python identifier constraint
    __constraint = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'constraint'), 'constraint', '__httpwww_opengis_netswe1_0_CTD_ANON_7_httpwww_opengis_netswe1_0constraint', False)
    ...
    # Attribute referenceFrame uses Python identifier referenceFrame
    __referenceFrame = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'referenceFrame'), 'referenceFrame', '__httpwww_opengis_netswe1_0_CTD_ANON_7_referenceFrame', pyxb.binding.datatypes.anyURI)
    ...
    # Attribute axisID uses Python identifier axisID
    __axisID = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'axisID'), 'axisID', '__httpwww_opengis_netswe1_0_CTD_ANON_7_axisID', pyxb.binding.datatypes.token)
...
class CTD_ANON_8 (AbstractDataComponentType):
    ...
    # Element {http://www.opengis.net/swe/1.0}uom uses Python identifier uom
    __uom = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'uom'), 'uom', '__httpwww_opengis_netswe1_0_CTD_ANON_8_httpwww_opengis_netswe1_0uom', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}constraint uses Python identifier constraint
    __constraint = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'constraint'), 'constraint', '__httpwww_opengis_netswe1_0_CTD_ANON_8_httpwww_opengis_netswe1_0constraint', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}quality uses Python identifier quality
    __quality = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'quality'), 'quality', '__httpwww_opengis_netswe1_0_CTD_ANON_8_httpwww_opengis_netswe1_0quality', False)
    ...
    # Attribute referenceFrame uses Python identifier referenceFrame
    __referenceFrame = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'referenceFrame'), 'referenceFrame', '__httpwww_opengis_netswe1_0_CTD_ANON_8_referenceFrame', pyxb.binding.datatypes.anyURI)
    
    referenceFrame = property(__referenceFrame.value, __referenceFrame.set, None, u'Points to a temporal reference frame definition. Time value will be expressed relative to this frame')

    
    # Attribute localFrame uses Python identifier localFrame
    __localFrame = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'localFrame'), 'localFrame', '__httpwww_opengis_netswe1_0_CTD_ANON_8_localFrame', pyxb.binding.datatypes.anyURI)
    
    localFrame = property(__localFrame.value, __localFrame.set, None, u'Specifies the temporal frame which origin is given by this time component')

    
    # Attribute referenceTime uses Python identifier referenceTime
    __referenceTime = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'referenceTime'), 'referenceTime', '__httpwww_opengis_netswe1_0_CTD_ANON_8_referenceTime', timeIso8601)
...
class PhenomenonPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_PhenomenonPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_PhenomenonPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class CTD_ANON_9 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __Boolean = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Boolean'), 'Boolean', '__httpwww_opengis_netswe1_0_CTD_ANON_9_httpwww_opengis_netswe1_0Boolean', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}Category uses Python identifier Category
    __Category = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Category'), 'Category', '__httpwww_opengis_netswe1_0_CTD_ANON_9_httpwww_opengis_netswe1_0Category', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}Time uses Python identifier Time
    __Time = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Time'), 'Time', '__httpwww_opengis_netswe1_0_CTD_ANON_9_httpwww_opengis_netswe1_0Time', False)
    ...
    __Text = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Text'), 'Text', '__httpwww_opengis_netswe1_0_CTD_ANON_9_httpwww_opengis_netswe1_0Text', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}Quantity uses Python identifier Quantity
    __Quantity = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Quantity'), 'Quantity', '__httpwww_opengis_netswe1_0_CTD_ANON_9_httpwww_opengis_netswe1_0Quantity', False)
    ...
    __QuantityRange = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'QuantityRange'), 'QuantityRange', '__httpwww_opengis_netswe1_0_CTD_ANON_9_httpwww_opengis_netswe1_0QuantityRange', False)
    ...
    __CountRange = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'CountRange'), 'CountRange', '__httpwww_opengis_netswe1_0_CTD_ANON_9_httpwww_opengis_netswe1_0CountRange', False)
    ...
    __TimeRange = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'TimeRange'), 'TimeRange', '__httpwww_opengis_netswe1_0_CTD_ANON_9_httpwww_opengis_netswe1_0TimeRange', False)
    ...
    __AbstractDataRecord = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'AbstractDataRecord'), 'AbstractDataRecord', '__httpwww_opengis_netswe1_0_CTD_ANON_9_httpwww_opengis_netswe1_0AbstractDataRecord', False)
    ...
    __AbstractDataArray = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'AbstractDataArray'), 'AbstractDataArray', '__httpwww_opengis_netswe1_0_CTD_ANON_9_httpwww_opengis_netswe1_0AbstractDataArray', False)
    ...
    __Count = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Count'), 'Count', '__httpwww_opengis_netswe1_0_CTD_ANON_9_httpwww_opengis_netswe1_0Count', False)
    ...
    # Attribute {http://www.w3.org/1999/xlink}arcrole uses Python identifier arcrole
    __arcrole = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'arcrole'), 'arcrole', '__httpwww_opengis_netswe1_0_CTD_ANON_9_httpwww_w3_org1999xlinkarcrole', pyxb.binding.datatypes.anyURI)
    
    arcrole = property(__arcrole.value, __arcrole.set, None, None)

    
    # Attribute {http://www.w3.org/1999/xlink}role uses Python identifier role
    __role = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'role'), 'role', '__httpwww_opengis_netswe1_0_CTD_ANON_9_httpwww_w3_org1999xlinkrole', pyxb.binding.datatypes.anyURI)
    
    role = property(__role.value, __role.set, None, None)

    
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_CTD_ANON_9_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    
    show = property(__show.value, __show.set, None, u"\n        The 'show' attribute is used to communicate the desired presentation \n        of the ending resource on traversal from the starting resource; it's \n        value should be treated as follows: \n        new - load ending resource in a new window, frame, pane, or other \n              presentation context\n        replace - load the resource in the same window, frame, pane, or \n                  other presentation context\n        embed - load ending resource in place of the presentation of the \n                starting resource\n        other - behavior is unconstrained; examine other markup in the \n                link for hints \n        none - behavior is unconstrained \n      ")

    
    # Attribute {http://www.w3.org/1999/xlink}href uses Python identifier href
    __href = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'href'), 'href', '__httpwww_opengis_netswe1_0_CTD_ANON_9_httpwww_w3_org1999xlinkhref', pyxb.binding.datatypes.anyURI)
    
    href = property(__href.value, __href.set, None, None)

    
    # Attribute {http://www.w3.org/1999/xlink}type uses Python identifier type
    __type = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'type'), 'type', '__httpwww_opengis_netswe1_0_CTD_ANON_9_httpwww_w3_org1999xlinktype', pyxb.binding.datatypes.string, fixed=True, unicode_default=u'simple')
    
    type = property(__type.value, __type.set, None, None)

    
    # Attribute {http://www.opengis.net/gml}remoteSchema uses Python identifier remoteSchema
    __remoteSchema = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'remoteSchema'), 'remoteSchema', '__httpwww_opengis_netswe1_0_CTD_ANON_9_httpwww_opengis_netgmlremoteSchema', pyxb.binding.datatypes.anyURI)
    
    remoteSchema = property(__remoteSchema.value, __remoteSchema.set, None, u'Reference to an XML Schema fragment that specifies the content model of the propertys value. This is in conformance with the XML Schema Section 4.14 Referencing Schemas from Elsewhere.')

    
    # Attribute {http://www.w3.org/1999/xlink}title uses Python identifier title
    __title = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'title'), 'title', '__httpwww_opengis_netswe1_0_CTD_ANON_9_httpwww_w3_org1999xlinktitle', pyxb.binding.datatypes.string)
    
    title = property(__title.value, __title.set, None, None)

    
    # Attribute name uses Python identifier name
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'name'), 'name', '__httpwww_opengis_netswe1_0_CTD_ANON_9_name', pyxb.binding.datatypes.token, required=True)
    
    name = property(__name.value, __name.set, None, None)

    
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_CTD_ANON_9_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
class CTD_ANON_10 (AbstractDataComponentType):
    ...
    # Element {http://www.opengis.net/swe/1.0}quality uses Python identifier quality
    __quality = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'quality'), 'quality', '__httpwww_opengis_netswe1_0_CTD_ANON_10_httpwww_opengis_netswe1_0quality', True)
    ...
    # Attribute axisID uses Python identifier axisID
    __axisID = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'axisID'), 'axisID', '__httpwww_opengis_netswe1_0_CTD_ANON_10_axisID', pyxb.binding.datatypes.token)
...
class CTD_ANON_11 (AbstractDataComponentType):
    ...
    # Element {http://www.opengis.net/swe/1.0}quality uses Python identifier quality
    __quality = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'quality'), 'quality', '__httpwww_opengis_netswe1_0_CTD_ANON_11_httpwww_opengis_netswe1_0quality', True)
...
class CTD_ANON_12 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __interval = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'interval'), 'interval', '__httpwww_opengis_netswe1_0_CTD_ANON_12_httpwww_opengis_netswe1_0interval', True)
    ...
    __max = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'max'), 'max', '__httpwww_opengis_netswe1_0_CTD_ANON_12_httpwww_opengis_netswe1_0max', False)
    ...
    __min = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'min'), 'min', '__httpwww_opengis_netswe1_0_CTD_ANON_12_httpwww_opengis_netswe1_0min', False)
    ...
    __valueList = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'valueList'), 'valueList', '__httpwww_opengis_netswe1_0_CTD_ANON_12_httpwww_opengis_netswe1_0valueList', True)
    ...
    # Attribute id uses Python identifier id
    __id = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'id'), 'id', '__httpwww_opengis_netswe1_0_CTD_ANON_12_id', pyxb.binding.datatypes.ID)
...
class DataValuePropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_DataValuePropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_DataValuePropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
class TimeGridPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_TimeGridPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_TimeGridPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
class QualityPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_QualityPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_QualityPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
class CTD_ANON_13 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __low = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'low'), 'low', '__httpwww_opengis_netswe1_0_CTD_ANON_13_httpwww_opengis_netswe1_0low', False)
    ...
    __high = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'high'), 'high', '__httpwww_opengis_netswe1_0_CTD_ANON_13_httpwww_opengis_netswe1_0high', False)
...
class CodeSpacePropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_CodeSpacePropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    
    show = property(__show.value, __show.set, None, u"\n        The 'show' attribute is used to communicate the desired presentation \n        of the ending resource on traversal from the starting resource; it's \n        value should be treated as follows: \n        new - load ending resource in a new window, frame, pane, or other \n              presentation context\n        replace - load the resource in the same window, frame, pane, or \n                  other presentation context\n        embed - load ending resource in place of the presentation of the \n                starting resource\n        other - behavior is unconstrained; examine other markup in the \n                link for hints \n        none - behavior is unconstrained \n      ")

    
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_CodeSpacePropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
class UomPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_UomPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_UomPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
class CTD_ANON_14 (AbstractVectorType):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = None
    ...
    __name_ = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'name'), 'name_', '__httpwww_opengis_netswe1_0_CTD_ANON_14_name', pyxb.binding.datatypes.token)
...
class CTD_ANON_16 (AbstractEncodingType):
    ...
    # Element {http://www.opengis.net/swe/1.0}member uses Python identifier member
    __member = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'member'), 'member', '__httpwww_opengis_netswe1_0_CTD_ANON_16_httpwww_opengis_netswe1_0member', True)
    ...
    __byteOrder = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'byteOrder'), 'byteOrder', '__httpwww_opengis_netswe1_0_CTD_ANON_16_byteOrder', byteOrder, required=True)
    
    byteOrder = property(__byteOrder.value, __byteOrder.set, None, None)

    
    # Attribute byteLength uses Python identifier byteLength
    __byteLength = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'byteLength'), 'byteLength', '__httpwww_opengis_netswe1_0_CTD_ANON_16_byteLength', pyxb.binding.datatypes.positiveInteger)
    ...
    __byteEncoding = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'byteEncoding'), 'byteEncoding', '__httpwww_opengis_netswe1_0_CTD_ANON_16_byteEncoding', byteEncoding, required=True)
...
class TimeGeometricComplexPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_TimeGeometricComplexPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_TimeGeometricComplexPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class AllowedTokensPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_AllowedTokensPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_AllowedTokensPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class SimpleDataPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_SimpleDataPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_SimpleDataPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
class CTD_ANON_17 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __ref = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'ref'), 'ref', '__httpwww_opengis_netswe1_0_CTD_ANON_17_ref', pyxb.binding.datatypes.IDREF)
...
class CTD_ANON_18 (AbstractEncodingType):
    ...
    __mimeType = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'mimeType'), 'mimeType', '__httpwww_opengis_netswe1_0_CTD_ANON_18_mimeType', pyxb.binding.datatypes.token, required=True)
...
class DataComponentPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_DataComponentPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_DataComponentPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
class AllowedTimesPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_AllowedTimesPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    
    actuate = property(__actuate.value, __actuate.set, None, u"\n        The 'actuate' attribute is used to communicate the desired timing \n        of traversal from the starting resource to the ending resource; \n        it's value should be treated as follows:\n        onLoad - traverse to the ending resource immediately on loading \n                 the starting resource \n        onRequest - traverse from the starting resource to the ending \n                    resource only on a post-loading event triggered for \n                    this purpose \n        other - behavior is unconstrained; examine other markup in link \n                for hints \n        none - behavior is unconstrained\n      ")

    
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_AllowedTimesPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class TimeInstantGridPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_TimeInstantGridPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_TimeInstantGridPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class CTD_ANON_19 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __Block = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Block'), 'Block', '__httpwww_opengis_netswe1_0_CTD_ANON_19_httpwww_opengis_netswe1_0Block', False)
    ...
    __Component = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Component'), 'Component', '__httpwww_opengis_netswe1_0_CTD_ANON_19_httpwww_opengis_netswe1_0Component', False)
...
class TimeIntervalGridPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_TimeIntervalGridPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_TimeIntervalGridPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class CTD_ANON_21 (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {http://www.opengis.net/swe/1.0}valueList uses Python identifier valueList
    __valueList = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'valueList'), 'valueList', '__httpwww_opengis_netswe1_0_CTD_ANON_21_httpwww_opengis_netswe1_0valueList', True)
    ...
    # Attribute id uses Python identifier id
    __id = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'id'), 'id', '__httpwww_opengis_netswe1_0_CTD_ANON_21_id', pyxb.binding.datatypes.ID)
...
class DataStreamDefinitionPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_DataStreamDefinitionPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_DataStreamDefinitionPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
class DataBlockDefinitionPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_DataBlockDefinitionPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_DataBlockDefinitionPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class CTD_ANON_22 (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute ref uses Python identifier ref
    __ref = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'ref'), 'ref', '__httpwww_opengis_netswe1_0_CTD_ANON_22_ref', pyxb.binding.datatypes.token, required=True)
    
    ref = property(__ref.value, __ref.set, None, None)

    
    # Attribute paddingBytes-before uses Python identifier paddingBytes_before
    __paddingBytes_before = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'paddingBytes-before'), 'paddingBytes_before', '__httpwww_opengis_netswe1_0_CTD_ANON_22_paddingBytes_before', pyxb.binding.datatypes.nonNegativeInteger, unicode_default=u'0')
    ...
    __encryption = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'encryption'), 'encryption', '__httpwww_opengis_netswe1_0_CTD_ANON_22_encryption', pyxb.binding.datatypes.anyURI)
    
    encryption = property(__encryption.value, __encryption.set, None, None)

    
    # Attribute byteLength uses Python identifier byteLength
    __byteLength = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'byteLength'), 'byteLength', '__httpwww_opengis_netswe1_0_CTD_ANON_22_byteLength', pyxb.binding.datatypes.positiveInteger)
    
    byteLength = property(__byteLength.value, __byteLength.set, None, None)

    
    # Attribute paddingBytes-after uses Python identifier paddingBytes_after
    __paddingBytes_after = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'paddingBytes-after'), 'paddingBytes_after', '__httpwww_opengis_netswe1_0_CTD_ANON_22_paddingBytes_after', pyxb.binding.datatypes.nonNegativeInteger, unicode_default=u'0')
    ...
    __compression = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'compression'), 'compression', '__httpwww_opengis_netswe1_0_CTD_ANON_22_compression', pyxb.binding.datatypes.anyURI)
...
class EnvelopePropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_EnvelopePropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_EnvelopePropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
class TimeGeometricPrimitivePropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_TimeGeometricPrimitivePropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_TimeGeometricPrimitivePropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class CTD_ANON_23 (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {http://www.opengis.net/swe/1.0}max uses Python identifier max
    __max = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'max'), 'max', '__httpwww_opengis_netswe1_0_CTD_ANON_23_httpwww_opengis_netswe1_0max', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}valueList uses Python identifier valueList
    __valueList = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'valueList'), 'valueList', '__httpwww_opengis_netswe1_0_CTD_ANON_23_httpwww_opengis_netswe1_0valueList', True)
    ...
    # Element {http://www.opengis.net/swe/1.0}min uses Python identifier min
    __min = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'min'), 'min', '__httpwww_opengis_netswe1_0_CTD_ANON_23_httpwww_opengis_netswe1_0min', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}interval uses Python identifier interval
    __interval = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'interval'), 'interval', '__httpwww_opengis_netswe1_0_CTD_ANON_23_httpwww_opengis_netswe1_0interval', True)
    ...
    # Attribute id uses Python identifier id
    __id = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'id'), 'id', '__httpwww_opengis_netswe1_0_CTD_ANON_23_id', pyxb.binding.datatypes.ID)
...
class CTD_ANON_24 (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_CTD_ANON_24_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_CTD_ANON_24_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class CTD_ANON_25 (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute encryption uses Python identifier encryption
    __encryption = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'encryption'), 'encryption', '__httpwww_opengis_netswe1_0_CTD_ANON_25_encryption', pyxb.binding.datatypes.anyURI)
    
    encryption = property(__encryption.value, __encryption.set, None, None)

    
    # Attribute paddingBits-before uses Python identifier paddingBits_before
    __paddingBits_before = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'paddingBits-before'), 'paddingBits_before', '__httpwww_opengis_netswe1_0_CTD_ANON_25_paddingBits_before', pyxb.binding.datatypes.nonNegativeInteger, unicode_default=u'0')
    
    paddingBits_before = property(__paddingBits_before.value, __paddingBits_before.set, None, None)

    
    # Attribute ref uses Python identifier ref
    __ref = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'ref'), 'ref', '__httpwww_opengis_netswe1_0_CTD_ANON_25_ref', pyxb.binding.datatypes.token, required=True)
    
    ref = property(__ref.value, __ref.set, None, None)

    
    # Attribute dataType uses Python identifier dataType
    __dataType = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'dataType'), 'dataType', '__httpwww_opengis_netswe1_0_CTD_ANON_25_dataType', pyxb.binding.datatypes.anyURI)
    ...
    __significantBits = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'significantBits'), 'significantBits', '__httpwww_opengis_netswe1_0_CTD_ANON_25_significantBits', pyxb.binding.datatypes.positiveInteger)
    ...
    __bitLength = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'bitLength'), 'bitLength', '__httpwww_opengis_netswe1_0_CTD_ANON_25_bitLength', pyxb.binding.datatypes.positiveInteger)
    ...
    __paddingBits_after = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'paddingBits-after'), 'paddingBits_after', '__httpwww_opengis_netswe1_0_CTD_ANON_25_paddingBits_after', pyxb.binding.datatypes.nonNegativeInteger, unicode_default=u'0')
...
class TimeObjectPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_TimeObjectPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    
    show = property(__show.value, __show.set, None, u"\n        The 'show' attribute is used to communicate the desired presentation \n        of the ending resource on traversal from the starting resource; it's \n        value should be treated as follows: \n        new - load ending resource in a new window, frame, pane, or other \n              presentation context\n        replace - load the resource in the same window, frame, pane, or \n                  other presentation context\n        embed - load ending resource in place of the presentation of the \n                starting resource\n        other - behavior is unconstrained; examine other markup in the \n                link for hints \n        none - behavior is unconstrained \n      ")

    
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_TimeObjectPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
class TimeAggregatePropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_TimeAggregatePropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_TimeAggregatePropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
class MultiplexedStreamFormatPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_MultiplexedStreamFormatPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_MultiplexedStreamFormatPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class CTD_ANON_26 (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {http://www.opengis.net/swe/1.0}CountRange uses Python identifier CountRange
    __CountRange = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'CountRange'), 'CountRange', '__httpwww_opengis_netswe1_0_CTD_ANON_26_httpwww_opengis_netswe1_0CountRange', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}TimeRange uses Python identifier TimeRange
    __TimeRange = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'TimeRange'), 'TimeRange', '__httpwww_opengis_netswe1_0_CTD_ANON_26_httpwww_opengis_netswe1_0TimeRange', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}AbstractDataRecord uses Python identifier AbstractDataRecord
    __AbstractDataRecord = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'AbstractDataRecord'), 'AbstractDataRecord', '__httpwww_opengis_netswe1_0_CTD_ANON_26_httpwww_opengis_netswe1_0AbstractDataRecord', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}Quantity uses Python identifier Quantity
    __Quantity = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Quantity'), 'Quantity', '__httpwww_opengis_netswe1_0_CTD_ANON_26_httpwww_opengis_netswe1_0Quantity', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}AbstractDataArray uses Python identifier AbstractDataArray
    __AbstractDataArray = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'AbstractDataArray'), 'AbstractDataArray', '__httpwww_opengis_netswe1_0_CTD_ANON_26_httpwww_opengis_netswe1_0AbstractDataArray', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}Count uses Python identifier Count
    __Count = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Count'), 'Count', '__httpwww_opengis_netswe1_0_CTD_ANON_26_httpwww_opengis_netswe1_0Count', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}Text uses Python identifier Text
    __Text = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Text'), 'Text', '__httpwww_opengis_netswe1_0_CTD_ANON_26_httpwww_opengis_netswe1_0Text', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}Time uses Python identifier Time
    __Time = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Time'), 'Time', '__httpwww_opengis_netswe1_0_CTD_ANON_26_httpwww_opengis_netswe1_0Time', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}Boolean uses Python identifier Boolean
    __Boolean = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Boolean'), 'Boolean', '__httpwww_opengis_netswe1_0_CTD_ANON_26_httpwww_opengis_netswe1_0Boolean', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}Category uses Python identifier Category
    __Category = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Category'), 'Category', '__httpwww_opengis_netswe1_0_CTD_ANON_26_httpwww_opengis_netswe1_0Category', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}QuantityRange uses Python identifier QuantityRange
    __QuantityRange = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'QuantityRange'), 'QuantityRange', '__httpwww_opengis_netswe1_0_CTD_ANON_26_httpwww_opengis_netswe1_0QuantityRange', False)
    ...
    # Attribute {http://www.w3.org/1999/xlink}title uses Python identifier title
    __title = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'title'), 'title', '__httpwww_opengis_netswe1_0_CTD_ANON_26_httpwww_w3_org1999xlinktitle', pyxb.binding.datatypes.string)
    
    title = property(__title.value, __title.set, None, None)

    
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_CTD_ANON_26_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    
    show = property(__show.value, __show.set, None, u"\n        The 'show' attribute is used to communicate the desired presentation \n        of the ending resource on traversal from the starting resource; it's \n        value should be treated as follows: \n        new - load ending resource in a new window, frame, pane, or other \n              presentation context\n        replace - load the resource in the same window, frame, pane, or \n                  other presentation context\n        embed - load ending resource in place of the presentation of the \n                starting resource\n        other - behavior is unconstrained; examine other markup in the \n                link for hints \n        none - behavior is unconstrained \n      ")

    
    # Attribute {http://www.w3.org/1999/xlink}role uses Python identifier role
    __role = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'role'), 'role', '__httpwww_opengis_netswe1_0_CTD_ANON_26_httpwww_w3_org1999xlinkrole', pyxb.binding.datatypes.anyURI)
    
    role = property(__role.value, __role.set, None, None)

    
    # Attribute {http://www.w3.org/1999/xlink}arcrole uses Python identifier arcrole
    __arcrole = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'arcrole'), 'arcrole', '__httpwww_opengis_netswe1_0_CTD_ANON_26_httpwww_w3_org1999xlinkarcrole', pyxb.binding.datatypes.anyURI)
    
    arcrole = property(__arcrole.value, __arcrole.set, None, None)

    
    # Attribute {http://www.w3.org/1999/xlink}href uses Python identifier href
    __href = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'href'), 'href', '__httpwww_opengis_netswe1_0_CTD_ANON_26_httpwww_w3_org1999xlinkhref', pyxb.binding.datatypes.anyURI)
    
    href = property(__href.value, __href.set, None, None)

    
    # Attribute {http://www.w3.org/1999/xlink}type uses Python identifier type
    __type = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'type'), 'type', '__httpwww_opengis_netswe1_0_CTD_ANON_26_httpwww_w3_org1999xlinktype', pyxb.binding.datatypes.string, fixed=True, unicode_default=u'simple')
    
    type = property(__type.value, __type.set, None, None)

    
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_CTD_ANON_26_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    
    actuate = property(__actuate.value, __actuate.set, None, u"\n        The 'actuate' attribute is used to communicate the desired timing \n        of traversal from the starting resource to the ending resource; \n        it's value should be treated as follows:\n        onLoad - traverse to the ending resource immediately on loading \n                 the starting resource \n        onRequest - traverse from the starting resource to the ending \n                    resource only on a post-loading event triggered for \n                    this purpose \n        other - behavior is unconstrained; examine other markup in link \n                for hints \n        none - behavior is unconstrained\n      ")

    
    # Attribute {http://www.opengis.net/gml}remoteSchema uses Python identifier remoteSchema
    __remoteSchema = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'remoteSchema'), 'remoteSchema', '__httpwww_opengis_netswe1_0_CTD_ANON_26_httpwww_opengis_netgmlremoteSchema', pyxb.binding.datatypes.anyURI)
...
class AnyScalarPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_AnyScalarPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_AnyScalarPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
TextBlock = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'TextBlock'), CTD_ANON_4)
...
Time = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Time'), CTD_ANON_1, documentation=u'Either ISO 8601 (e.g. 2004-04-18T12:03:04.6Z) or time relative to a time origin')
...
AllowedValues = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AllowedValues'), CTD_ANON_12, documentation=u'List of allowed values (There is an implicit AND between all members)')
...
QuantityRange = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'QuantityRange'), CTD_ANON_10, documentation=u'Decimal pair for specifying a quantity range with constraints')
...
GeoLocationArea = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'GeoLocationArea'), CTD_ANON_14, documentation=u'Area used to define bounding boxes')
Namespace.addCategoryObject('elementBinding', GeoLocationArea.name().localName(), GeoLocationArea)

ObservableProperty = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ObservableProperty'), CTD_ANON_15, documentation=u'ObservableProperty should be used to identify (through reference only) stimuli or measurable property types. The consequence is that it does not have a uom because it has not been measured yet.  This is used to define sensor/detector/actuator inputs and outputs, for instance.')
...
CountRange = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'CountRange'), CTD_ANON_11, documentation=u'Integer pair used for specifying a count range')
...
AllowedTokens = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AllowedTokens'), CTD_ANON_21, documentation=u'Enumeration of allowed values')
...
AllowedTimes = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AllowedTimes'), CTD_ANON_23, documentation=u'List of allowed time values (There is an implicit AND between all members)')
Namespace.addCategoryObject('elementBinding', AllowedTimes.name().localName(), AllowedTimes)

Boolean = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Boolean'), CTD_ANON_6, documentation=u'Scalar component used to express truth: True or False, 0 or 1')
Namespace.addCategoryObject('elementBinding', Boolean.name().localName(), Boolean)

Text = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Text'), CTD_ANON_5, documentation=u'Free textual component')
...
TimeRange = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'TimeRange'), CTD_ANON_8, documentation=u'Time value pair for specifying a time range (can be a decimal or ISO 8601)')
...
CTD_ANON_1._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'constraint'), AllowedTimesPropertyType, scope=CTD_ANON_1, documentation=u'The constraint property defines the permitted values, as a range or enumerated list'))
...
CTD_ANON_1._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'value'), timePositionType, scope=CTD_ANON_1, documentation=u'Value is optional, to enable structure to act in a schema for values provided using other encodings'))
...
CTD_ANON_1._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=CTD_ANON_1._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'value'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=CTD_ANON_1._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'uom'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_1._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'quality'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_1._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'constraint'))),
...
CTD_ANON_2._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'codeSpace'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'constraint'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'quality'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'value'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'codeSpace'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'constraint'))),
...
AllowedValuesPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AllowedValues'), CTD_ANON_12, scope=AllowedValuesPropertyType, documentation=u'List of allowed values (There is an implicit AND between all members)'))
...
CTD_ANON_3._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'constraint'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'quality'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'uom'))),
...
BlockEncodingPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'TextBlock'), CTD_ANON_4, scope=BlockEncodingPropertyType))
...
CTD_ANON_5._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'value'), pyxb.binding.datatypes.string, scope=CTD_ANON_5, documentation=u'Value is optional, to enable structure to act in a schema for values provided using other encodings'))
CTD_ANON_5._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'value'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
...
PositionType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=PositionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'orientation'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=PositionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'angularVelocity'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=10, element_use=PositionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=PositionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'angularAcceleration'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=PositionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'time'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=10, element_use=PositionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=PositionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'angularVelocity'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=PositionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'acceleration'))),
...
CTD_ANON_6._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'value'), pyxb.binding.datatypes.boolean, scope=CTD_ANON_6, documentation=u'Value is optional, to enable structure to act in a schema for values provided using other encodings'))
...
CTD_ANON_6._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'quality'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
...
CTD_ANON_8._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'constraint'), AllowedTimesPropertyType, scope=CTD_ANON_8, documentation=u'The constraint property defines the permitted values, as a range or enumerated list'))
...
CTD_ANON_8._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'value'), timePair, scope=CTD_ANON_8, documentation=u'Value is optional, to enable structure to act in a schema for values provided using other encodings'))
CTD_ANON_8._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'uom'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'quality'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'value'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'uom'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'constraint'))),
...
CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Boolean'), CTD_ANON_6, scope=CTD_ANON_9, documentation=u'Scalar component used to express truth: True or False, 0 or 1'))

CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Category'), CTD_ANON_2, scope=CTD_ANON_9, documentation=u'A simple token identifying a term or category (single spaces allowed); definition attribute should provide dictionary entry useful for interpretation of the value'))

CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Time'), CTD_ANON_1, scope=CTD_ANON_9, documentation=u'Either ISO 8601 (e.g. 2004-04-18T12:03:04.6Z) or time relative to a time origin'))

CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Text'), CTD_ANON_5, scope=CTD_ANON_9, documentation=u'Free textual component'))

CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Quantity'), CTD_ANON_3, scope=CTD_ANON_9, documentation=u'Decimal number with optional unit and constraints'))

CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'QuantityRange'), CTD_ANON_10, scope=CTD_ANON_9, documentation=u'Decimal pair for specifying a quantity range with constraints'))

CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'CountRange'), CTD_ANON_11, scope=CTD_ANON_9, documentation=u'Integer pair used for specifying a count range'))

CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'TimeRange'), CTD_ANON_8, scope=CTD_ANON_9, documentation=u'Time value pair for specifying a time range (can be a decimal or ISO 8601)'))

CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AbstractDataRecord'), AbstractDataRecordType, abstract=pyxb.binding.datatypes.boolean(1), scope=CTD_ANON_9))

CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AbstractDataArray'), AbstractDataArrayType, abstract=pyxb.binding.datatypes.boolean(1), scope=CTD_ANON_9, documentation=u'Implemetation of ISO-11404 Array datatype. This defines an array of identical data components with a elementCount. Values are given as a block and can be encoded in different ways'))

CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Count'), CTD_ANON_7, scope=CTD_ANON_9, documentation=u'Integer number used for a counting value'))
CTD_ANON_9._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Time'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Category'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Text'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Boolean'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'QuantityRange'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'CountRange'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'TimeRange'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AbstractDataRecord'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AbstractDataArray'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Count'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Quantity'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'value'), decimalPair, scope=CTD_ANON_10, documentation=u'Value is optional, to enable structure to act in a schema for values provided using other encodings'))
...
CTD_ANON_10._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'quality'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'value'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'uom'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'constraint'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'quality'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'value'))),
...
NormalizedCurveType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=NormalizedCurveType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'inputGain'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=NormalizedCurveType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'outputGain'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=NormalizedCurveType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'outputBias'))),
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=NormalizedCurveType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'interpolationMethod'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=NormalizedCurveType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'extrapolationMethod'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=NormalizedCurveType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'function'))),
...
CTD_ANON_11._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'value'), countPair, scope=CTD_ANON_11, documentation=u'Value is optional, to enable structure to act in a schema for values provided using other encodings'))

CTD_ANON_11._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'constraint'), AllowedValuesPropertyType, scope=CTD_ANON_11, documentation=u'The constraint property defines the permitted values, as a range or enumerated list'))
CTD_ANON_11._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_11._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_11._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'quality'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_11._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_11._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'constraint'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
...
BooleanPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Boolean'), CTD_ANON_6, scope=BooleanPropertyType, documentation=u'Scalar component used to express truth: True or False, 0 or 1'))
...
AbstractDataArrayType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'elementCount'), CTD_ANON_17, scope=AbstractDataArrayType, documentation=u'Specifies the size of the array (i.e. the number of elements of the defined type it contains)'))
...
EnvelopeType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=EnvelopeType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lowerCorner'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=EnvelopeType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'time'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=EnvelopeType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lowerCorner'))),
    ])
...
CTD_ANON_12._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'interval'), decimalPair, scope=CTD_ANON_12, documentation=u'Range of allowed values (closed interval) for this component'))

CTD_ANON_12._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'max'), pyxb.binding.datatypes.double, scope=CTD_ANON_12, documentation=u'Specifies maximum allowed value for an open interval (no min)'))

CTD_ANON_12._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'min'), pyxb.binding.datatypes.double, scope=CTD_ANON_12, documentation=u'Specifies minimum allowed value for an open interval (no max)'))

CTD_ANON_12._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'valueList'), decimalList, scope=CTD_ANON_12, documentation=u'List of allowed values for this component'))
CTD_ANON_12._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_12._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'interval'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_12._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'max'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_12._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'min'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_12._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'valueList'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_12._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'interval'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_12._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'valueList'))),
...
QuantityRangePropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'QuantityRange'), CTD_ANON_10, scope=QuantityRangePropertyType, documentation=u'Decimal pair for specifying a quantity range with constraints'))
...
QualityPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'QuantityRange'), CTD_ANON_10, scope=QualityPropertyType, documentation=u'Decimal pair for specifying a quantity range with constraints'))
...
QualityPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Text'), CTD_ANON_5, scope=QualityPropertyType, documentation=u'Free textual component'))
...
CTD_ANON_13._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'low'), pyxb.binding.datatypes.integer, scope=CTD_ANON_13))

CTD_ANON_13._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'high'), pyxb.binding.datatypes.integer, scope=CTD_ANON_13))
CTD_ANON_13._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_13._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'low'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_13._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'high'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
    ])
})
...
CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'member'), EnvelopePropertyType, scope=CTD_ANON_14, documentation=u'Is this an aggregate geometry?'))
CTD_ANON_14._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'member'))),
...
CTD_ANON_15._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
    ])
...
TimeGridEnvelopePropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'TimeGridEnvelope'), CTD_ANON_13, scope=TimeGridEnvelopePropertyType, documentation=u'Grid extent specified in grid coordinates - i.e. 2 integers'))
...
CTD_ANON_16._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'member'), CTD_ANON_19, scope=CTD_ANON_16))
...
TimeRangePropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'TimeRange'), CTD_ANON_8, scope=TimeRangePropertyType, documentation=u'Time value pair for specifying a time range (can be a decimal or ISO 8601)'))
...
AllowedTokensPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AllowedTokens'), CTD_ANON_21, scope=AllowedTokensPropertyType, documentation=u'Enumeration of allowed values'))
...
SimpleDataPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Text'), CTD_ANON_5, scope=SimpleDataPropertyType, documentation=u'Free textual component'))

SimpleDataPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Quantity'), CTD_ANON_3, scope=SimpleDataPropertyType, documentation=u'Decimal number with optional unit and constraints'))

SimpleDataPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Category'), CTD_ANON_2, scope=SimpleDataPropertyType, documentation=u'A simple token identifying a term or category (single spaces allowed); definition attribute should provide dictionary entry useful for interpretation of the value'))

SimpleDataPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'QuantityRange'), CTD_ANON_10, scope=SimpleDataPropertyType, documentation=u'Decimal pair for specifying a quantity range with constraints'))
...
SimpleDataPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Boolean'), CTD_ANON_6, scope=SimpleDataPropertyType, documentation=u'Scalar component used to express truth: True or False, 0 or 1'))

SimpleDataPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'CountRange'), CTD_ANON_11, scope=SimpleDataPropertyType, documentation=u'Integer pair used for specifying a count range'))
...
SimpleDataPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Count'), CTD_ANON_7, scope=SimpleDataPropertyType, documentation=u'Integer number used for a counting value'))

SimpleDataPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'TimeRange'), CTD_ANON_8, scope=SimpleDataPropertyType, documentation=u'Time value pair for specifying a time range (can be a decimal or ISO 8601)'))

SimpleDataPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Time'), CTD_ANON_1, scope=SimpleDataPropertyType, documentation=u'Either ISO 8601 (e.g. 2004-04-18T12:03:04.6Z) or time relative to a time origin'))
...
CTD_ANON_17._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Count'), CTD_ANON_7, scope=CTD_ANON_17, documentation=u'Integer number used for a counting value'))
...
DataComponentPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Time'), CTD_ANON_1, scope=DataComponentPropertyType, documentation=u'Either ISO 8601 (e.g. 2004-04-18T12:03:04.6Z) or time relative to a time origin'))
...
DataComponentPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Text'), CTD_ANON_5, scope=DataComponentPropertyType, documentation=u'Free textual component'))
...
DataComponentPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'QuantityRange'), CTD_ANON_10, scope=DataComponentPropertyType, documentation=u'Decimal pair for specifying a quantity range with constraints'))

DataComponentPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'TimeRange'), CTD_ANON_8, scope=DataComponentPropertyType, documentation=u'Time value pair for specifying a time range (can be a decimal or ISO 8601)'))

DataComponentPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'CountRange'), CTD_ANON_11, scope=DataComponentPropertyType, documentation=u'Integer pair used for specifying a count range'))

DataComponentPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Boolean'), CTD_ANON_6, scope=DataComponentPropertyType, documentation=u'Scalar component used to express truth: True or False, 0 or 1'))
...
AllowedTimesPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AllowedTimes'), CTD_ANON_23, scope=AllowedTimesPropertyType, documentation=u'List of allowed time values (There is an implicit AND between all members)'))
...
CTD_ANON_19._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Block'), CTD_ANON_22, scope=CTD_ANON_19))

CTD_ANON_19._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Component'), CTD_ANON_25, scope=CTD_ANON_19))
CTD_ANON_19._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_19._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Block'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_19._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Component'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
CTD_ANON_20._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Quantity'), CTD_ANON_3, scope=CTD_ANON_20, documentation=u'Decimal number with optional unit and constraints'))

CTD_ANON_20._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Time'), CTD_ANON_1, scope=CTD_ANON_20, documentation=u'Either ISO 8601 (e.g. 2004-04-18T12:03:04.6Z) or time relative to a time origin'))

CTD_ANON_20._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Count'), CTD_ANON_7, scope=CTD_ANON_20, documentation=u'Integer number used for a counting value'))
CTD_ANON_20._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_20._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Count'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_20._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Time'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_20._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Quantity'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
AbstractConditionalType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'condition'), CTD_ANON_9, scope=AbstractConditionalType, documentation=u'Specifies one or more conditions for which the given value is valid'))
AbstractConditionalType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=AbstractConditionalType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=AbstractConditionalType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'condition'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=AbstractConditionalType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
...
ConditionalValueType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'data'), CTD_ANON_26, scope=ConditionalValueType))
...
CTD_ANON_21._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'valueList'), tokenList, scope=CTD_ANON_21, documentation=u'List of allowed token values for this component'))
CTD_ANON_21._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_21._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'valueList'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_21._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'valueList'))),
    ])
...
CountRangePropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'CountRange'), CTD_ANON_11, scope=CountRangePropertyType, documentation=u'Integer pair used for specifying a count range'))
...
CTD_ANON_23._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'max'), timePositionType, scope=CTD_ANON_23, documentation=u'Specifies maximum allowed time value for an open interval (no min)'))

CTD_ANON_23._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'valueList'), timeList, scope=CTD_ANON_23, documentation=u'List of allowed time values for this component'))

CTD_ANON_23._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'min'), timePositionType, scope=CTD_ANON_23, documentation=u'Specifies minimum allowed time value for an open interval (no max)'))

CTD_ANON_23._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'interval'), timePair, scope=CTD_ANON_23, documentation=u'Range of allowed time values (closed interval) for this component'))
CTD_ANON_23._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_23._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'max'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_23._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'valueList'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_23._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'min'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_23._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'interval'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_23._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'interval'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_23._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'valueList'))),
...
TimePropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Time'), CTD_ANON_1, scope=TimePropertyType, documentation=u'Either ISO 8601 (e.g. 2004-04-18T12:03:04.6Z) or time relative to a time origin'))
...
TextPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Text'), CTD_ANON_5, scope=TextPropertyType, documentation=u'Free textual component'))
...
CTD_ANON_26._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'CountRange'), CTD_ANON_11, scope=CTD_ANON_26, documentation=u'Integer pair used for specifying a count range'))

CTD_ANON_26._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'TimeRange'), CTD_ANON_8, scope=CTD_ANON_26, documentation=u'Time value pair for specifying a time range (can be a decimal or ISO 8601)'))

CTD_ANON_26._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AbstractDataRecord'), AbstractDataRecordType, abstract=pyxb.binding.datatypes.boolean(1), scope=CTD_ANON_26))

CTD_ANON_26._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Quantity'), CTD_ANON_3, scope=CTD_ANON_26, documentation=u'Decimal number with optional unit and constraints'))

CTD_ANON_26._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AbstractDataArray'), AbstractDataArrayType, abstract=pyxb.binding.datatypes.boolean(1), scope=CTD_ANON_26, documentation=u'Implemetation of ISO-11404 Array datatype. This defines an array of identical data components with a elementCount. Values are given as a block and can be encoded in different ways'))

CTD_ANON_26._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Count'), CTD_ANON_7, scope=CTD_ANON_26, documentation=u'Integer number used for a counting value'))

CTD_ANON_26._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Text'), CTD_ANON_5, scope=CTD_ANON_26, documentation=u'Free textual component'))

CTD_ANON_26._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Time'), CTD_ANON_1, scope=CTD_ANON_26, documentation=u'Either ISO 8601 (e.g. 2004-04-18T12:03:04.6Z) or time relative to a time origin'))

CTD_ANON_26._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Boolean'), CTD_ANON_6, scope=CTD_ANON_26, documentation=u'Scalar component used to express truth: True or False, 0 or 1'))

CTD_ANON_26._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Category'), CTD_ANON_2, scope=CTD_ANON_26, documentation=u'A simple token identifying a term or category (single spaces allowed); definition attribute should provide dictionary entry useful for interpretation of the value'))

CTD_ANON_26._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'QuantityRange'), CTD_ANON_10, scope=CTD_ANON_26, documentation=u'Decimal pair for specifying a quantity range with constraints'))
CTD_ANON_26._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_26._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'CountRange'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_26._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AbstractDataRecord'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_26._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AbstractDataArray'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_26._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Count'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_26._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'TimeRange'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_26._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Quantity'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_26._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Time'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_26._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Boolean'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_26._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Category'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_26._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Text'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_26._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'QuantityRange'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
AnyScalarPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Text'), CTD_ANON_5, scope=AnyScalarPropertyType, documentation=u'Free textual component'))
...
AnyScalarPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Time'), CTD_ANON_1, scope=AnyScalarPropertyType, documentation=u'Either ISO 8601 (e.g. 2004-04-18T12:03:04.6Z) or time relative to a time origin'))
...
AnyScalarPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Boolean'), CTD_ANON_6, scope=AnyScalarPropertyType, documentation=u'Scalar component used to express truth: True or False, 0 or 1'))
