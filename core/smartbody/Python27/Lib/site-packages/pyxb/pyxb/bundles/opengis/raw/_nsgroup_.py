...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:91bebf30-0c23-11df-9ac2-000c29370554')
...
STD_ANON_1.XML = STD_ANON_1._CF_enumeration.addEnumeration(unicode_value=u'XML')
STD_ANON_1.CSS = STD_ANON_1._CF_enumeration.addEnumeration(unicode_value=u'CSS')
STD_ANON_1.auto = STD_ANON_1._CF_enumeration.addEnumeration(unicode_value=u'auto')
...
STD_ANON_2.discrete = STD_ANON_2._CF_enumeration.addEnumeration(unicode_value=u'discrete')
STD_ANON_2.linear = STD_ANON_2._CF_enumeration.addEnumeration(unicode_value=u'linear')
STD_ANON_2.paced = STD_ANON_2._CF_enumeration.addEnumeration(unicode_value=u'paced')
...
STD_ANON_3.none = STD_ANON_3._CF_enumeration.addEnumeration(unicode_value=u'none')
...
STD_ANON_4.replace = STD_ANON_4._CF_enumeration.addEnumeration(unicode_value=u'replace')
STD_ANON_4.sum = STD_ANON_4._CF_enumeration.addEnumeration(unicode_value=u'sum')
...
class setPrototype (pyxb.binding.basis.complexTypeDefinition):
    ...
    __attributeType = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'attributeType'), 'attributeType', '__httpwww_w3_org2001SMIL20_setPrototype_attributeType', STD_ANON_1, unicode_default=u'auto')
...
class animateColorPrototype (pyxb.binding.basis.complexTypeDefinition):
    ...
    __additive = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'additive'), 'additive', '__httpwww_w3_org2001SMIL20_animateColorPrototype_additive', STD_ANON_4, unicode_default=u'replace')
    
    additive = property(__additive.value, __additive.set, None, None)

    
    # Attribute attributeType uses Python identifier attributeType
    __attributeType = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'attributeType'), 'attributeType', '__httpwww_w3_org2001SMIL20_animateColorPrototype_attributeType', STD_ANON_1, unicode_default=u'auto')
...
class animateColorType (animateColorPrototype):
    ...
    __calcMode = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'calcMode'), 'calcMode', '__httpwww_w3_org2001SMIL20Language_animateColorType_calcMode', STD_ANON_2, unicode_default=u'linear')
...
class animatePrototype (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute additive uses Python identifier additive
    __additive = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'additive'), 'additive', '__httpwww_w3_org2001SMIL20_animatePrototype_additive', STD_ANON_4, unicode_default=u'replace')
    
    additive = property(__additive.value, __additive.set, None, None)

    
    # Attribute attributeType uses Python identifier attributeType
    __attributeType = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'attributeType'), 'attributeType', '__httpwww_w3_org2001SMIL20_animatePrototype_attributeType', STD_ANON_1, unicode_default=u'auto')
...
class animateType (animatePrototype):
    ...
    # Attribute calcMode uses Python identifier calcMode
    __calcMode = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'calcMode'), 'calcMode', '__httpwww_w3_org2001SMIL20Language_animateType_calcMode', STD_ANON_2, unicode_default=u'linear')
...
class animateMotionPrototype (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute additive uses Python identifier additive
    __additive = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'additive'), 'additive', '__httpwww_w3_org2001SMIL20_animateMotionPrototype_additive', STD_ANON_4, unicode_default=u'replace')
...
class animateMotionType (animateMotionPrototype):
    ...
    # Attribute calcMode uses Python identifier calcMode
    __calcMode = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'calcMode'), 'calcMode', '__httpwww_w3_org2001SMIL20Language_animateMotionType_calcMode', STD_ANON_2, unicode_default=u'linear')
...
set = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(_Namespace_smil20, u'set'), setType)
_Namespace_smil20.addCategoryObject('elementBinding', set.name().localName(), set)

animateColor = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(_Namespace_smil20lang, u'animateColor'), animateColorType)
_Namespace_smil20lang.addCategoryObject('elementBinding', animateColor.name().localName(), animateColor)

set_ = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(_Namespace_smil20lang, u'set'), setType)
_Namespace_smil20lang.addCategoryObject('elementBinding', set_.name().localName(), set_)
...
animateColor_ = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(_Namespace_smil20, u'animateColor'), animateColorType)
_Namespace_smil20.addCategoryObject('elementBinding', animateColor_.name().localName(), animateColor_)
...
set._setSubstitutionGroup(set_)

animate._setSubstitutionGroup(animate_)

animateColor_._setSubstitutionGroup(animateColor)
