...
# Generated 2010-01-28 08:40:14.020000 by PyXB version 1.1.1
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:6d227e50-0c23-11df-9307-000c29370554')
...
STD_ANON_3.any = STD_ANON_3._CF_enumeration.addEnumeration(unicode_value=u'#any')
STD_ANON_3.none = STD_ANON_3._CF_enumeration.addEnumeration(unicode_value=u'#none')
STD_ANON_3.other = STD_ANON_3._CF_enumeration.addEnumeration(unicode_value=u'#other')
...
class ElementReferenceType (pyxb.binding.basis.STD_union):
    ...
    _MemberTypes = ( pyxb.binding.datatypes.QName, STD_ANON_3, )
...
ElementReferenceType.any = u'#any'                # originally STD_ANON_3.any
ElementReferenceType.none = u'#none'              # originally STD_ANON_3.none
ElementReferenceType.other = u'#other'            # originally STD_ANON_3.other
...
class InterfaceType (ExtensibleDocumentedType):
    ...
    __styleDefault = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'styleDefault'), 'styleDefault', '__httpwww_w3_orgnswsdl_InterfaceType_styleDefault', STD_ANON_1)
