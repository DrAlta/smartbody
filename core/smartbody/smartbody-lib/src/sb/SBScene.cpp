...
std::string SBScene::save(bool remoteSetup)
{
		 ...
		 cameraIter++)
	{
		...
		strstr << "camera = scene.createCamera(\"" << camera->getName() << "\")\n";
		
		strstr << "camera.setEye(" << camera->getEye().x << ", " << camera->getEye().y << ", " << camera->getEye().z << ")\n";
		strstr << "camera.setCenter(" << camera->getCenter().x << ", " << camera->getCenter().y << ", " << camera->getCenter().z << ")\n";
		strstr << "camera.setUpVector(SrVec(" << camera->getUpVector().x << ", " << camera->getUpVector().y << ", " << camera->getUpVector().z << "))\n";
		strstr << "camera.setScale(" << camera->getScale() << ")\n";
		strstr << "camera.setFov(" << camera->getFov() << ")\n";
		strstr << "camera.setFarPlane(" << camera->getFarPlane() << ")\n";
		strstr << "camera.setNearPlane(" << camera->getNearPlane() << ")\n";
		strstr << "camera.setAspectRatio(" << camera->getAspectRatio() << ")\n";
		...
		{
			strstr << "scene.setActiveCamera(camera)\n";
		}
	}
...
SBAPI SrCamera* SBScene::createCamera(const std::string& name)
{
	mcuCBHandle& mcu = mcuCBHandle::singleton();
...
SBAPI void SBScene::removeCamera(SrCamera* camera)
{
	mcuCBHandle& mcu = mcuCBHandle::singleton();
...
SBAPI void SBScene::setActiveCamera(SrCamera* camera)
{
	mcuCBHandle& mcu = mcuCBHandle::singleton();
	if (camera)
	{
...
SBAPI SrCamera* SBScene::getActiveCamera()
{
	mcuCBHandle& mcu = mcuCBHandle::singleton();
...
SBAPI SrCamera* SBScene::getCamera(const std::string& name)
{
	mcuCBHandle& mcu = mcuCBHandle::singleton();
