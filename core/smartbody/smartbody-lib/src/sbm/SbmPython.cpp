...
BOOST_PYTHON_MODULE(SmartBody)
{
	...
	boost::python::class_<Viseme>("Viseme")
		.def("getName", &Viseme::getVisemeName, "Get the viseme name. \n Input: NULL \n Output: viseme name")
		.def("getCharacterName", &Viseme::getCharName, "Get the character name. \n Input: NULL \n Output: character name")
	...
	boost::python::class_<Motion>("Motion")
		...
		.def("getMotionFileName", &Motion::getMotionFileName, "Returns the motion file name. \n Input: NULL \n Output: motion file name")
		.def("getMotionName", &Motion::getMotionName, "Returns the motion name. \n Input: NULL \n Output: motion name")
	...
	boost::python::class_<SBController, boost::python::bases<DObject> >("SBController")
		...
		.def("getType", &SBController::getType, "Returns the type for this controller.")
	...
	//	.def(boost::python::init<>())
		...
		.def("getName", &SBSkeleton::getName, "Returns the name of the skeleton.")
	...
	boost::python::class_<SBJoint>("SBJoint")
		...
		.def("getName", &SBJoint::getName, "Returns the name of the joint.")
	...
	boost::python::class_<SBCharacter>("SBCharacter")
		...
		.def("getName", &SBCharacter::getName, "Returns the name of the character.")
