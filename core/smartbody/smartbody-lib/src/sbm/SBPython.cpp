...
boost::python::class_<SBAttribute, boost::python::bases<SBSubject> >("SBAttribute")
	...
	boost::python::class_<SBAnimationTransition>("SBAnimationTransition")
		...
		.def("setSourceState", &SBAnimationTransition::setSourceState, "")
		...
		.def("setDestinationState", &SBAnimationTransition::setDestinationState, "")
	...
	boost::python::class_<SBAnimationStateManager>("SBAnimationStateManager")
		...
		.def("isStateScheduled", &SBAnimationStateManager::isStateScheduled, boost::python::return_value_policy<boost::python::return_by_value>(), "Returns whether the character has the state scheduled. Used to avoid scheduling the same state.")
		;
