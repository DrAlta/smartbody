...
class SrGlRenderFuncs
 { public:
    SBAPI static void render_model ( SrSnShapeBase* shape );

    SBAPI static void render_lines ( SrSnShapeBase* shape );

    SBAPI static void render_points ( SrSnShapeBase* shape );

    /*! The default render mode is smooth, and flat has the same
        effect of smooth shading. */
    SBAPI static void render_box ( SrSnShapeBase* shape );
    ...
    SBAPI static void render_sphere ( SrSnShapeBase* shape );
    ...
    SBAPI static void render_cylinder ( SrSnShapeBase* shape );

    SBAPI static void render_polygon ( SrSnShapeBase* shape );

    SBAPI static void render_polygons ( SrSnShapeBase* shape );
 };
