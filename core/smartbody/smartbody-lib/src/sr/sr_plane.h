...
class SrPlane
 { public :
   ...
   public:
    ...
    SBAPI SrPlane ( const SrVec& center, const SrVec& normal );

    /*! Constructor from three points in the plane. */
    SBAPI SrPlane ( const SrVec& p1, const SrVec& p2, const SrVec& p3 );

    /*! Set as the plane passing at center with given normal. Normal will be normalized. */
    SBAPI bool set ( const SrVec& center, const SrVec& normal );

    /*! Set as the plane passing trough three points. */
    SBAPI bool set ( const SrVec& p1, const SrVec& p2, const SrVec& p3 );
    ...
    SBAPI bool parallel ( const SrVec& p1, const SrVec& p2, float ds=0 ) const;
    ...
    SBAPI SrVec intersect ( const SrVec& p1, const SrVec& p2, float *t=0 ) const;
 };
