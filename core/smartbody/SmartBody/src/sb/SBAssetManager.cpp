...
SBNavigationMesh* SBAssetManager::createNewNavigationMesh( const std::string& naviMeshName )
{
...
SBNavigationMesh* SBAssetManager::getNavigationMesh( const std::string& naviMeshName )
{
...
std::vector<std::string> SBAssetManager::getNavigationMeshNames()
{
