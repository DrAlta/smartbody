...
SBSteerManager::SBSteerManager() : SBService()
{
	...
	createIntAttribute("gridDatabaseOptions.maxItemsPerGridCell", 10, true, "Basic", 60, false, false, false, "Max units per grid cell. If agent density is high, make sure increase this value.");
