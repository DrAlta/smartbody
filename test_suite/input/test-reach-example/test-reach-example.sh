#!/bin/sh
#SBMINPUT="-seqpath ../../../../test_suite/input/test-reach-example -seq test-reach-example.seq -facebone"
SBMINPUT="-scriptpath ../../../../test_suite/input/test-reach-example -script test-reach-example.py"
OPTION_1=IMG
THRESHOLD_1=500
OPTION_2=IMG
THRESHOLD_2=500
