...
doctor = scene.createCharacter("doctor", "doctor")
...
elder = scene.createCharacter("elder", "elder")
...
brad = scene.createCharacter("brad", "brad")
...
utah = scene.createCharacter("utah", "utah")
