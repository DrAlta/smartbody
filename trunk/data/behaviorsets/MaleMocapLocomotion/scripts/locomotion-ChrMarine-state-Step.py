...
def mocapStepSetup(skeletonName, baseJoint, preFix, statePreFix):
	...
	motions.append(statePreFix+"ChrMarine@Idle01_StepBackwardsLf01")
	motions.append(statePreFix+"ChrMarine@Idle01_StepBackwardsRt01")
	motions.append(statePreFix+"ChrMarine@Idle01_StepForwardLf01")
	motions.append(statePreFix+"ChrMarine@Idle01_StepForwardRt01")
	motions.append(statePreFix+"ChrMarine@Idle01_StepSidewaysLf01")
	motions.append(statePreFix+"ChrMarine@Idle01_StepSidewaysRt01")
	...
	stateChrMarineStep.addTriangle(statePreFix+"ChrMarine@Idle01", statePreFix+"ChrMarine@Idle01_StepBackwardsLf01", statePreFix+"ChrMarine@Idle01_StepSidewaysLf01")
	stateChrMarineStep.addTriangle(statePreFix+"ChrMarine@Idle01", statePreFix+"ChrMarine@Idle01_StepForwardLf01", statePreFix+"ChrMarine@Idle01_StepSidewaysLf01")
	stateChrMarineStep.addTriangle(statePreFix+"ChrMarine@Idle01", statePreFix+"ChrMarine@Idle01_StepBackwardsRt01", statePreFix+"ChrMarine@Idle01_StepSidewaysRt01")
	stateChrMarineStep.addTriangle(statePreFix+"ChrMarine@Idle01", statePreFix+"ChrMarine@Idle01_StepForwardRt01", statePreFix+"ChrMarine@Idle01_StepSidewaysRt01")
