def mocapIdleTurnSetup(skeletonName, baseJoint, preFix, statePreFix):
	...
	motions.append(statePreFix+"ChrMarine@Turn90Lf01")
	motions.append(statePreFix+"ChrMarine@Turn180Lf01")
	motions.append(statePreFix+"ChrMarine@Turn90Rt01")
	motions.append(statePreFix+"ChrMarine@Turn180Rt01")
	params = DoubleVec()
	params.append(0)
	params.append(-90)
	params.append(-180)
