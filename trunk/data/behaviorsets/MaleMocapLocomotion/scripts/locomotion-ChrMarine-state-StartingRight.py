...
def mocapStartRightSetup(origSkelName,skeletonName, baseJoint, preFix, statePreFix):
	...
	originalMotions.append("ChrMarine@Idle01_ToWalk01_Turn90Rt01")
	originalMotions.append("ChrMarine@Idle01_ToWalk01_Turn180Rt01")
