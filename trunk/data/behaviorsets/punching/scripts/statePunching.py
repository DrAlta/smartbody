def punchingSetup(skeletonName, baseJoint, prefix, statePreFix):
	...
	motions = StringVec()
	motions = StringVec()
	motions.append(prefix + "ChrGarza@IdleFight01_PunchForwardFloor01")
	motions.append(prefix + "ChrGarza@IdleFight01_PunchForwardMediumFar01")
	motions.append(prefix + "ChrGarza@IdleFight01_PunchLeft45Floor01")
	motions.append(prefix + "ChrGarza@IdleFight01_PunchLeft45High01")
	motions.append(prefix + "ChrGarza@IdleFight01_PunchLeft45Low01")
	motions.append(prefix + "ChrGarza@IdleFight01_PunchLeft45MediumFar01")
	motions.append(prefix + "ChrGarza@IdleFight01_PunchLeft90Floor01")
	motions.append(prefix + "ChrGarza@IdleFight01_PunchLeft90High01")
	motions.append(prefix + "ChrGarza@IdleFight01_PunchLeft90Low01")
	motions.append(prefix + "ChrGarza@IdleFight01_PunchLeft90MediumFar01")
	motions.append(prefix + "ChrGarza@IdleFight01_PunchLeft90MediumNear01")
	motions.append(prefix + "ChrGarza@IdleFight01_PunchRight45Floor01")
	motions.append(prefix + "ChrGarza@IdleFight01_PunchRight45High01")
	motions.append(prefix + "ChrGarza@IdleFight01_PunchRight45Low01")
	motions.append(prefix + "ChrGarza@IdleFight01_PunchRight45MediumFar01")
	motions.append(prefix + "ChrGarza@IdleFight01_PunchRight45MediumNear01")
	motions.append(prefix + "ChrGarza@IdleFight01_PunchRight90Floor01")
	motions.append(prefix + "ChrGarza@IdleFight01_PunchRight90High01")
	motions.append(prefix + "ChrGarza@IdleFight01_PunchRight90Low01")
	motions.append(prefix + "ChrGarza@IdleFight01_PunchRight90MediumFar01")
	motions.append(prefix + "ChrGarza@IdleFight01_PunchRight90MediumNear01")
