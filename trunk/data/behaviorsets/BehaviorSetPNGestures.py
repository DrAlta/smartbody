...
def setupBehaviorSet():
	...
	motions = StringVec()
	stateTest.addMotion("me2", 0.0)
	stateTest.addMotion("me_intense2", 1.0)

	stateTest = scene.getBlendManager().createState1D("YouBlend")
	stateTest.setBlendSkeleton(skeleton)
	motions = StringVec()
	stateTest.addMotion("you2", 0.0)
	stateTest.addMotion("you_intense2", 1.0)
	
	stateTest = scene.getBlendManager().createState1D("UsBlend")
	stateTest.setBlendSkeleton(skeleton)
	motions = StringVec()
	stateTest.addMotion("us2", 0.0)
	stateTest.addMotion("us_intense2", 1.0)	
	
	stateTest = scene.getBlendManager().createState1D("WeBlend")
	stateTest.setBlendSkeleton(skeleton)
	motions = StringVec()
	stateTest.addMotion("we2", 0.0)
	stateTest.addMotion("we_intense2", 1.0)	
	
	stateTest = scene.getBlendManager().createState1D("StopBlend")
	stateTest.setBlendSkeleton(skeleton)
	motions = StringVec()
	stateTest.addMotion("stop2", 0.0)
	stateTest.addMotion("stop_intense2", 1.0)	
	
	stateTest = scene.getBlendManager().createState1D("QuestionBlend")
	stateTest.setBlendSkeleton(skeleton)
	motions = StringVec()
	stateTest.addMotion("question2", 0.0)
	stateTest.addMotion("question_intense2", 1.0)	
	
	stateTest = scene.getBlendManager().createState1D("PointRightBlend")
	stateTest.setBlendSkeleton(skeleton)
	motions = StringVec()
	stateTest.addMotion("pointright2", 0.0)
	stateTest.addMotion("pointright_intense2", 1.0)	
		
	stateTest = scene.getBlendManager().createState1D("PointLeftBlend")
	stateTest.setBlendSkeleton(skeleton)
	motions = StringVec()
	stateTest.addMotion("pointleft2", 0.0)
	stateTest.addMotion("pointleft_intense2", 1.0)	

	stateTest = scene.getBlendManager().createState1D("PointCenterBlend")
	stateTest.setBlendSkeleton(skeleton)
	motions = StringVec()
	stateTest.addMotion("pointcenter2", 0.0)
	stateTest.addMotion("pointcenter_intense2", 1.0)	
	
	stateTest = scene.getBlendManager().createState1D("PointHereBlend")
	stateTest.setBlendSkeleton(skeleton)
	motions = StringVec()
	stateTest.addMotion("pointhere2", 0.0)
	stateTest.addMotion("pointhere_intense2", 1.0)		
	
	stateTest = scene.getBlendManager().createState1D("NegationBlend")
	stateTest.setBlendSkeleton(skeleton)
	motions = StringVec()
	stateTest.addMotion("negation2", 0.0)
	stateTest.addMotion("negation_intense2", 1.0)	
	...
	stateTest.setBlendSkeleton(skeleton)
	motions = StringVec()
	stateTest.addMotion("bigger2", 0.0)
	stateTest.addMotion("bigger_intense2", 1.0)	
