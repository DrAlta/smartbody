...
copy /Y "%VS140COMNTOOLS%\..\..\VC\redist\x86\Microsoft.VC100.CRT\msvcp140.dll" %BIN_DIR%
copy /Y "%VS140COMNTOOLS%\..\..\VC\redist\x86\Microsoft.VC100.CRT\vcruntime140.dll" %BIN_DIR%
