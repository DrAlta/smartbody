...
# Generated 2010-01-28 08:40:12.601000 by PyXB version 1.1.1
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:6c4cded0-0c23-11df-863a-000c29370554')
...
tBindingOperation._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=tBindingOperation._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'fault'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=tBindingOperation._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'output'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=tBindingOperation._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'documentation'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://schemas.xmlsoap.org/wsdl/'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=tBindingOperation._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'input'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=tBindingOperation._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'fault'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=tBindingOperation._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'output'))),
