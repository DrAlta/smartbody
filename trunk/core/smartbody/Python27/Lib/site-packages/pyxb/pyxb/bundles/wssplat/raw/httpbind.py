...
# Generated 2010-01-28 08:40:16.992000 by PyXB version 1.1.1
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:6ef605d0-0c23-11df-a964-000c29370554')
...
urlReplacement = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'urlReplacement'), CTD_ANON_1)
Namespace.addCategoryObject('elementBinding', urlReplacement.name().localName(), urlReplacement)

urlEncoded = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'urlEncoded'), CTD_ANON_2)
