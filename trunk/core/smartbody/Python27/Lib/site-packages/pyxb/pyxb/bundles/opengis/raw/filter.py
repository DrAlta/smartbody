...
# Generated 2010-01-28 08:41:26.490000 by PyXB version 1.1.1
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:97a16650-0c23-11df-b0d8-000c29370554')
...
SimpleArithmetic = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'SimpleArithmetic'), CTD_ANON_1)
...
ArithmeticOperatorsType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'SimpleArithmetic'), CTD_ANON_1, scope=ArithmeticOperatorsType))
...
FilterType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=FilterType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'comparisonOps'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=FilterType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'spatialOps'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=FilterType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_Id'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=FilterType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'logicOps'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
...
Scalar_CapabilitiesType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=Scalar_CapabilitiesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'LogicalOperators'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=Scalar_CapabilitiesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ComparisonOperators'))),
