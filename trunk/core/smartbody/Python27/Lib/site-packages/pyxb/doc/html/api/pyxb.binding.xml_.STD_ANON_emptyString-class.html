...
<head>
  <title>pyxb.binding.xml_.STD_ANON_emptyString</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="pyxb.binding.xml_.STD_ANON_emptyString-class.html"
...
<!-- ==================== CLASS DESCRIPTION ==================== -->
<h1 class="epydoc">Class STD_ANON_emptyString</h1><p class="nomargin-top"><span class="codelink"><a href="pyxb.binding.xml_-pysrc.html#STD_ANON_emptyString">source&nbsp;code</a></span></p>
<pre class="base-tree">
                    object --+                    
                             |                    
            ...
            <a href="pyxb.binding.basis._DynamicCreate_mixin-class.html" onclick="show_private();">basis._DynamicCreate_mixin</a> --+        
                ...
                <a href="pyxb.binding.basis.simpleTypeDefinition-class.html">basis.simpleTypeDefinition</a> --+    
                       ...
                       <a href="pyxb.binding.basis.enumeration_mixin-class.html">basis.enumeration_mixin</a> --+
                                                 |
                                                <strong class="uidshort">STD_ANON_emptyString</strong>
</pre>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.xml_.STD_ANON_emptyString-class.html#_CF_enumeration" class="summary-name" onclick="show_private();">_CF_enumeration</a> = <code title="pyxb.binding.facets.CF_enumeration(value_datatype= STD_ANON_emptyStrin\
g, enum_prefix= None)">pyxb.binding.facets.CF_enumeration(value_dat<code class="variable-ellipsis">...</code></code>
    </td>
  </tr>
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="emptyString"></a><span class="summary-name">emptyString</span> = <code title="u''">u''</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.xml_.STD_ANON_emptyString-class.html#_STD_ANON_emptyString_FacetMap" class="summary-name" onclick="show_private();">_STD_ANON_emptyString_FacetMap</a> = <code title="{&lt;class 'pyxb.binding.facets.CF_whiteSpace'&gt;: &lt;pyxb.binding.facets.CF_\
...
_enumeration object at 0x9d49f4c&gt;,
 &lt;class 'pyxb.binding.facets.CF_length'&gt;: &lt;pyxb.binding.facets.CF_leng\
th object at 0x9e043ec&gt;,
..."><code class="variable-group">{</code>&lt;class 'pyxb.binding.facets.<code class="variable-ellipsis">...</code></code>
    </td>
  </tr>
  <tr>
    <td colspan="2" class="summary">
    <div class="private">    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.datatypes.string-class.html">datatypes.string</a></code></b> (private):
      ...
      <code><a href="pyxb.binding.datatypes.string-class.html#_CF_whiteSpace" onclick="show_private();">_CF_whiteSpace</a></code>,
...
pyxb.binding.facets.CF_enumeration(value_datatype= STD_ANON_emptyStrin<span class="variable-linewrap"><img src="crarr.png" alt="\" /></span>
g, enum_prefix= None)
</pre></td></tr></table>
</dd>
  </dl>
...
<a name="_STD_ANON_emptyString_FacetMap"></a>
<div class="private">
<table class="details" border="1" cellpadding="3"
       cellspacing="0" width="100%" bgcolor="white">
<tr><td>
  <h3 class="epydoc">_STD_ANON_emptyString_FacetMap</h3>
...
_enumeration object at 0x9d49f4c&gt;<code class="variable-op">,</code>
