...
<head>
  <title>pyxb.utils.utility._DeconflictSymbols_mixin</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="pyxb.utils.utility._DeconflictSymbols_mixin-class.html"
...
<!-- ==================== CLASS DESCRIPTION ==================== -->
<h1 class="epydoc">Class _DeconflictSymbols_mixin</h1><p class="nomargin-top"><span class="codelink"><a href="pyxb.utils.utility-pysrc.html#_DeconflictSymbols_mixin">source&nbsp;code</a></span></p>
<pre class="base-tree">
object --+
         |
        <strong class="uidshort">_DeconflictSymbols_mixin</strong>
</pre>

<dl><dt>Known Subclasses:</dt>
<dd>
      <ul class="subclass-list">
<li><a href="pyxb.binding.basis.simpleTypeDefinition-class.html">binding.basis.simpleTypeDefinition</a></li><li>, <a href="pyxb.binding.basis.complexTypeDefinition-class.html">binding.basis.complexTypeDefinition</a></li><li>, <a href="pyxb.binding.basis.element-class.html">binding.basis.element</a></li>  </ul>
</dd></dl>

<hr />
<p>Mix-in used to deconflict public symbols in classes that may be 
  inherited by generated binding classes.</p>
  <p>Some classes, like the <a href="pyxb.binding.basis.element-class.html"
  class="link">pyxb.binding.basis.element</a> or <a 
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="_ReservedSymbols"></a><span class="summary-name">_ReservedSymbols</span> = <code title="set([])"><code class="variable-group">set([</code><code class="variable-group">])</code></code><br />
