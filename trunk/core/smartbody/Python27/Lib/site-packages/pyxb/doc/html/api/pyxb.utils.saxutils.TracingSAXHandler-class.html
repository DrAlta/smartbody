...
<head>
  <title>pyxb.utils.saxutils.TracingSAXHandler</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="pyxb.utils.saxutils.TracingSAXHandler-class.html"
...
<!-- ==================== CLASS DESCRIPTION ==================== -->
<h1 class="epydoc">Class TracingSAXHandler</h1><p class="nomargin-top"><span class="codelink"><a href="pyxb.utils.saxutils-pysrc.html#TracingSAXHandler">source&nbsp;code</a></span></p>
<pre class="base-tree">
xml.sax.handler.ContentHandler --+
                                 |
                                <strong class="uidshort">TracingSAXHandler</strong>
</pre>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.utils.saxutils.TracingSAXHandler-class.html#setDocumentLocator" class="summary-sig-name">setDocumentLocator</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">locator</span>)</span><br />
      Called by the parser to give the application a locator for locating 
      the origin of document events.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.utils.saxutils-pysrc.html#TracingSAXHandler.setDocumentLocator">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.utils.saxutils.TracingSAXHandler-class.html#startDocument" class="summary-sig-name">startDocument</a>(<span class="summary-sig-arg">self</span>)</span><br />
      Receive notification of the beginning of a document.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.utils.saxutils-pysrc.html#TracingSAXHandler.startDocument">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.utils.saxutils.TracingSAXHandler-class.html#startPrefixMapping" class="summary-sig-name">startPrefixMapping</a>(<span class="summary-sig-arg">self</span>,
      ...
      Begin the scope of a prefix-URI Namespace mapping.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.utils.saxutils-pysrc.html#TracingSAXHandler.startPrefixMapping">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.utils.saxutils.TracingSAXHandler-class.html#endPrefixMapping" class="summary-sig-name">endPrefixMapping</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">prefix</span>)</span><br />
      End the scope of a prefix-URI mapping.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.utils.saxutils-pysrc.html#TracingSAXHandler.endPrefixMapping">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.utils.saxutils.TracingSAXHandler-class.html#startElementNS" class="summary-sig-name">startElementNS</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">name</span>,
        <span class="summary-sig-arg">qname</span>,
        <span class="summary-sig-arg">attrs</span>)</span><br />
      Signals the start of an element in namespace mode.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.utils.saxutils-pysrc.html#TracingSAXHandler.startElementNS">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.utils.saxutils.TracingSAXHandler-class.html#endElementNS" class="summary-sig-name">endElementNS</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">name</span>,
        <span class="summary-sig-arg">qname</span>)</span><br />
      Signals the end of an element in namespace mode.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.utils.saxutils-pysrc.html#TracingSAXHandler.endElementNS">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.utils.saxutils.TracingSAXHandler-class.html#characters" class="summary-sig-name">characters</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">content</span>)</span><br />
      Receive notification of character data.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.utils.saxutils-pysrc.html#TracingSAXHandler.characters">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.utils.saxutils.TracingSAXHandler-class.html#ignorableWhitespace" class="summary-sig-name">ignorableWhitespace</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">whitespace</span>)</span><br />
      Receive notification of ignorable whitespace in element content.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.utils.saxutils-pysrc.html#TracingSAXHandler.ignorableWhitespace">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.utils.saxutils.TracingSAXHandler-class.html#processingInstruction" class="summary-sig-name">processingInstruction</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">data</span>)</span><br />
      Receive notification of a processing instruction.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.utils.saxutils-pysrc.html#TracingSAXHandler.processingInstruction">source&nbsp;code</a></span>
...
<tr><td>
  ...
  attempt to use it at any other time.</p>
  <dl class="fields">
    <dt>Overrides:
...
<tr><td>
  ...
  http://xml.org/sax/features/namespaces feature is true (the default).</p>
  ...
  <p>Note that start/endPrefixMapping events are not guaranteed to be 
  ...
  event, but their order is not guaranteed.</p>
  <dl class="fields">
    <dt>Overrides:
...
<tr><td>
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr valign="top"><td>
  <h3 class="epydoc"><span class="sig"><span class="sig-name">endPrefixMapping</span>(<span class="sig-arg">self</span>,
  ...
  <p>See startPrefixMapping for details. This event will always occur after
  the corresponding endElement event, but the order of endPrefixMapping 
  events is not otherwise guaranteed.</p>
  <dl class="fields">
    <dt>Overrides:
...
<tr><td>
  ...
  <p>The uri part of the name tuple is None for elements which have no 
  namespace.</p>
  <dl class="fields">
    <dt>Overrides:
...
<tr><td>
  ...
  <p>The name parameter contains the name of the element type, just as with
  the startElementNS event.</p>
  <dl class="fields">
    <dt>Overrides:
...
<tr><td>
  ...
  that the Locator provides useful information.</p>
  <dl class="fields">
    <dt>Overrides:
...
<tr><td>
  ...
  parsing and using content models.</p>
  <p>SAX parsers may return all contiguous whitespace in a single chunk, or
