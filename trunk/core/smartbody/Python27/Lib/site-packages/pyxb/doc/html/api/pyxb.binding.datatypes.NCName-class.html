...
<head>
  <title>pyxb.binding.datatypes.NCName</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="pyxb.binding.datatypes.NCName-class.html"
...
<!-- ==================== CLASS DESCRIPTION ==================== -->
<h1 class="epydoc">Class NCName</h1><p class="nomargin-top"><span class="codelink"><a href="pyxb.binding.datatypes-pysrc.html#NCName">source&nbsp;code</a></span></p>
<pre class="base-tree">
                    object --+                                
                             |                                
            ...
            <a href="pyxb.binding.basis._DynamicCreate_mixin-class.html" onclick="show_private();">basis._DynamicCreate_mixin</a> --+                    
                ...
                <a href="pyxb.binding.basis.simpleTypeDefinition-class.html">basis.simpleTypeDefinition</a> --+                
                            ...
                            basestring --+   |                
                                   ...
                                   unicode --+                
                                             |                
                                        <a href="pyxb.binding.datatypes.string-class.html">string</a> --+            
                                                 |            
                                  <a href="pyxb.binding.datatypes.normalizedString-class.html">normalizedString</a> --+        
                                                     |        
                                                 <a href="pyxb.binding.datatypes.token-class.html">token</a> --+    
                                                         |    
                                                      <a href="pyxb.binding.datatypes.Name-class.html">Name</a> --+
                                                             |
                                                            <strong class="uidshort">NCName</strong>
</pre>

<dl><dt>Known Subclasses:</dt>
<dd>
      <ul class="subclass-list">
<li><a href="pyxb.binding.xml_.STD_ANON_space-class.html">xml_.STD_ANON_space</a></li><li>, <a href="pyxb.binding.datatypes.ENTITY-class.html">ENTITY</a></li><li>, <a href="pyxb.binding.datatypes.ID-class.html">ID</a></li><li>, <a href="pyxb.binding.datatypes.IDREF-class.html">IDREF</a></li>  </ul>
</dd></dl>

<hr />
<p>See 
  http://www.w3.org/TR/1999/REC-xml-names-19990114/index.html#NT-NCName</p>
...
<tr bgcolor="#70b0f0" class="table-header">
  ...
  <tr>
    ...
    <div class="private">    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.datatypes.string-class.html">string</a></code></b> (private):
...
<tr bgcolor="#70b0f0" class="table-header">
  ...
  <tr>
    <td colspan="2" class="summary">
    <div class="private">    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.datatypes.token-class.html">token</a></code></b> (private):
      <code><a href="pyxb.binding.datatypes.token-class.html#_ValidateString_va" onclick="show_private();">_ValidateString_va</a></code>
      </p></div>
    <div class="private">    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.datatypes.normalizedString-class.html">normalizedString</a></code></b> (private):
    ...
    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.datatypes.string-class.html">string</a></code></b>:
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.datatypes.NCName-class.html#_ExpandedName" class="summary-name" onclick="show_private();">_ExpandedName</a> = <code title="pyxb.namespace.XMLSchema.createExpandedName('NCName')">pyxb.namespace.XMLSchema.createExpandedName('N<code class="variable-ellipsis">...</code></code><br />
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="_ValidRE"></a><span class="summary-name">_ValidRE</span> = <code title="re.compile(r'^[A-Za-z_][-_\.A-Za-z0-9]*$')">re.compile(r'^<code class="re-group">[</code>A<code class="re-op">-</code>Za<code class="re-op">-</code>z_<code class="re-group">]</code><code class="re-group">[</code>-_\.A<code class="re-op">-</code>Za<code class="re-op">-</code>z0<code class="re-op">-</code>9<code class="re-group">]</code><code class="re-op">*</code>$')</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.datatypes.NCName-class.html#_CF_pattern" class="summary-name" onclick="show_private();">_CF_pattern</a> = <code title="&lt;pyxb.binding.facets.CF_pattern object at 0x9e04aac&gt;">&lt;pyxb.binding.facets.CF_pattern object at 0x9e04<code class="variable-ellipsis">...</code></code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.datatypes.NCName-class.html#_httpwww_w3_org2001XMLSchema_NCName_FacetMap" class="summary-name" onclick="show_private();">_httpwww_w3_org2001XMLSchema_NCName_FacetMap</a> = <code title="{&lt;class 'pyxb.binding.facets.CF_whiteSpace'&gt;: &lt;pyxb.binding.facets.CF_\
...
_enumeration object at 0x9e0440c&gt;,
...
..."><code class="variable-group">{</code>&lt;class 'pyxb.b<code class="variable-ellipsis">...</code></code>
  ...
  <tr>
    <td colspan="2" class="summary">
    <div class="private">    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.datatypes.Name-class.html">Name</a></code></b> (private):
    ...
    <div class="private">    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.datatypes.string-class.html">string</a></code></b> (private):
      <code><a href="pyxb.binding.datatypes.string-class.html#_CF_enumeration" onclick="show_private();">_CF_enumeration</a></code>,
...
<tr><td>
  ...
  <dl class="fields">
    <dt>Value:</dt>
      <dd><table><tr><td><pre class="variable">
&lt;pyxb.binding.facets.CF_pattern object at 0x9e04aac&gt;
</pre></td></tr></table>
</dd>
  </dl>
</td></tr></table>
</div>
<a name="_httpwww_w3_org2001XMLSchema_NCName_FacetMap"></a>
<div class="private">
<table class="details" border="1" cellpadding="3"
       cellspacing="0" width="100%" bgcolor="white">
<tr><td>
  <h3 class="epydoc">_httpwww_w3_org2001XMLSchema_NCName_FacetMap</h3>
...
_enumeration object at 0x9e0440c&gt;<code class="variable-op">,</code>
