...
<li><a href="pyxb.binding.datatypes.string-class.html">datatypes.string</a></li><li>, <a href="pyxb.binding.datatypes.anySimpleType-class.html">datatypes.anySimpleType</a></li><li>, <a href="pyxb.binding.basis.STD_union-class.html">STD_union</a></li><li>, <a href="pyxb.binding.datatypes.integer-class.html">datatypes.integer</a></li><li>, <a href="pyxb.binding.datatypes.decimal-class.html">datatypes.decimal</a></li><li>, <a href="pyxb.binding.datatypes.boolean-class.html">datatypes.boolean</a></li><li>, <a href="pyxb.binding.basis.STD_list-class.html">STD_list</a></li><li>, <a href="pyxb.binding.datatypes.NOTATION-class.html">datatypes.NOTATION</a></li><li>, <a href="pyxb.binding.datatypes.QName-class.html">datatypes.QName</a></li><li class="private">, <a href="pyxb.binding.datatypes._PyXBDateTime_base-class.html" onclick="show_private();">datatypes._PyXBDateTime_base</a></li><li>, <a href="pyxb.binding.datatypes.anyURI-class.html">datatypes.anyURI</a></li><li>, <a href="pyxb.binding.datatypes.base64Binary-class.html">datatypes.base64Binary</a></li><li>, <a href="pyxb.binding.datatypes.int-class.html">datatypes.int</a></li><li>, <a href="pyxb.binding.datatypes.double-class.html">datatypes.double</a></li><li>, <a href="pyxb.binding.datatypes.duration-class.html">datatypes.duration</a></li><li>, <a href="pyxb.binding.datatypes.float-class.html">datatypes.float</a></li><li>, <a href="pyxb.binding.datatypes.hexBinary-class.html">datatypes.hexBinary</a></li>  </ul>
</dd></dl>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.basis.simpleTypeDefinition-class.html#__FacetMapAttributeNameMap" class="summary-name" onclick="show_private();">__FacetMapAttributeNameMap</a> = <code title="{&lt;class 'pyxb.binding.datatypes.boolean'&gt;: '_httpwww_w3_org2001XMLSche\
ma_boolean_FacetMap',
 &lt;class 'pyxb.binding.datatypes.anySimpleType'&gt;: '_httpwww_w3_org2001X\
MLSchema_anySimpleType_FacetMap',
 &lt;class 'pyxb.binding.xml_.STD_ANON_emptyString'&gt;: '_STD_ANON_emptyStr\
ing_FacetMap',
 &lt;class 'pyxb.binding.datatypes.duration'&gt;: '_httpwww_w3_org2001XMLSch\
ema_duration_FacetMap',
..."><code class="variable-group">{</code>&lt;class 'pyxb.binding.datatypes.b<code class="variable-ellipsis">...</code></code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
...
<tr><td>
  ...
  <dl class="fields">
    <dt>Value:</dt>
      <dd><table><tr><td><pre class="variable">
<code class="variable-group">{</code>&lt;class 'pyxb.binding.datatypes.boolean'&gt;<code class="variable-op">: </code><code class="variable-quote">'</code><code class="variable-string">_httpwww_w3_org2001XMLSche</code><span class="variable-linewrap"><img src="crarr.png" alt="\" /></span>
<code class="variable-string">ma_boolean_FacetMap</code><code class="variable-quote">'</code><code class="variable-op">,</code>
...
<code class="variable-string">MLSchema_anySimpleType_FacetMap</code><code class="variable-quote">'</code><code class="variable-op">,</code>
 &lt;class 'pyxb.binding.xml_.STD_ANON_emptyString'&gt;<code class="variable-op">: </code><code class="variable-quote">'</code><code class="variable-string">_STD_ANON_emptyStr</code><span class="variable-linewrap"><img src="crarr.png" alt="\" /></span>
<code class="variable-string">ing_FacetMap</code><code class="variable-quote">'</code><code class="variable-op">,</code>
 &lt;class 'pyxb.binding.datatypes.duration'&gt;<code class="variable-op">: </code><code class="variable-quote">'</code><code class="variable-string">_httpwww_w3_org2001XMLSch</code><span class="variable-linewrap"><img src="crarr.png" alt="\" /></span>
<code class="variable-string">ema_duration_FacetMap</code><code class="variable-quote">'</code><code class="variable-op">,</code>
<code class="variable-ellipsis">...</code>
</pre></td></tr></table>
</dd>
  </dl>
