...
<!-- ==================== CLASS DESCRIPTION ==================== -->
<h1 class="epydoc">Class _SchemaComponent_mixin</h1><p class="nomargin-top"><span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#_SchemaComponent_mixin">source&nbsp;code</a></span></p>
<pre class="base-tree">
                       object --+            
                                |            
...
<tr><td>
  ...
  createas, the in-scope namespace declarations, etc.  Must be defined for 
