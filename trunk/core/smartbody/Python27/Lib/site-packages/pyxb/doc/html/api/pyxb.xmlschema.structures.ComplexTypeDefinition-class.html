...
<head>
  <title>pyxb.xmlschema.structures.ComplexTypeDefinition</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html"
...
<!-- ==================== CLASS DESCRIPTION ==================== -->
<h1 class="epydoc">Class ComplexTypeDefinition</h1><p class="nomargin-top"><span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition">source&nbsp;code</a></span></p>
<pre class="base-tree">
                       object --+                
                                |                
       ...
       <a href="pyxb.namespace.resolution._Resolvable_mixin-class.html" onclick="show_private();">namespace.resolution._Resolvable_mixin</a> --+
                             ...
                             <a href="pyxb.xmlschema.structures._Annotated_mixin-class.html" onclick="show_private();">_Annotated_mixin</a> --+
                               ...
                               object --+       |
                                  ...
                                  <a href="pyxb.cscRoot-class.html">cscRoot</a> --+   |
                                            |   |
                     <a href="pyxb.xmlschema.structures._AttributeWildcard_mixin-class.html" onclick="show_private();">_AttributeWildcard_mixin</a> --+
                                                |
...
<li class="private"><a href="pyxb.xmlschema.structures._UrTypeDefinition-class.html" onclick="show_private();">_UrTypeDefinition</a></li>  </ul>
</dd></dl>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="baseTypeDefinition"></a><span class="summary-sig-name">baseTypeDefinition</span>(<span class="summary-sig-arg">self</span>)</span><br />
      The type resolved from the base attribute.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition.baseTypeDefinition">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="derivationMethod"></a><span class="summary-sig-name">derivationMethod</span>(<span class="summary-sig-arg">self</span>)</span><br />
      How the type was derived.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition.derivationMethod">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="abstract"></a><span class="summary-sig-name">abstract</span>(<span class="summary-sig-arg">self</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition.abstract">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="attributeUses"></a><span class="summary-sig-name">attributeUses</span>(<span class="summary-sig-arg">self</span>)</span><br />
      A frozenset() of AttributeUse instances.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition.attributeUses">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#lookupScopedAttributeDeclaration" class="summary-sig-name">lookupScopedAttributeDeclaration</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">expanded_name</span>)</span><br />
      Find an attribute declaration with the given name that is local to 
      this type.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition.lookupScopedAttributeDeclaration">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#lookupScopedElementDeclaration" class="summary-sig-name">lookupScopedElementDeclaration</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">expanded_name</span>)</span><br />
      Find an element declaration with the given name that is local to this
      type.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition.lookupScopedElementDeclaration">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#localScopedDeclarations" class="summary-sig-name">localScopedDeclarations</a>(<span class="summary-sig-arg">self</span>,
      ...
      introduced in this definition (i.e., their scope is this CTD).</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition.localScopedDeclarations">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="_recordLocalDeclaration"></a><span class="summary-sig-name">_recordLocalDeclaration</span>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">decl</span>)</span><br />
      Record the given declaration as being locally scoped in this type.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition._recordLocalDeclaration">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="_isHierarchyRoot"></a><span class="summary-sig-name">_isHierarchyRoot</span>(<span class="summary-sig-arg">self</span>)</span><br />
      Return <code>True</code> iff this is the root of a complex type 
      definition hierarchy.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition._isHierarchyRoot">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#_contentTypeTag" class="summary-sig-name" onclick="show_private();">_contentTypeTag</a>(<span class="summary-sig-arg">self</span>)</span><br />
      Return the value of the content type identifier, i.e.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition._contentTypeTag">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="_contentTypeComponent"></a><span class="summary-sig-name">_contentTypeComponent</span>(<span class="summary-sig-arg">self</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition._contentTypeComponent">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#contentType" class="summary-sig-name">contentType</a>(<span class="summary-sig-arg">self</span>)</span><br />
      Identify the sort of content in this type.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition.contentType">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="contentTypeAsString"></a><span class="summary-sig-name">contentTypeAsString</span>(<span class="summary-sig-arg">self</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition.contentTypeAsString">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#__init__" class="summary-sig-name">__init__</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">*args</span>,
        <span class="summary-sig-arg">**kw</span>)</span><br />
      Initialize portions of a component.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition.__init__">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="hasWildcardElement"></a><span class="summary-sig-name">hasWildcardElement</span>(<span class="summary-sig-arg">self</span>)</span><br />
      Return True iff this type includes a wildcard element in its content 
      model.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition.hasWildcardElement">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#_updateFromOther_csc" class="summary-sig-name" onclick="show_private();">_updateFromOther_csc</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">other</span>)</span><br />
      Override fields in this instance with those from the other.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition._updateFromOther_csc">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      Indicate whether this simple type is a built-in type.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition.isBuiltin">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#_bindingRequires_vx" class="summary-sig-name" onclick="show_private();">_bindingRequires_vx</a>(<span class="summary-sig-arg">self</span>,
      ...
      the type definitions of any local element declarations.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition._bindingRequires_vx">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="__completeProcessing"></a><span class="summary-sig-name">__completeProcessing</span>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">method</span>,
        <span class="summary-sig-arg">content_style</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition.__completeProcessing">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="__simpleContent"></a><span class="summary-sig-name">__simpleContent</span>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">method</span>,
        <span class="summary-sig-arg">**kw</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition.__simpleContent">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="__setComplexContentFromDOM"></a><span class="summary-sig-name">__setComplexContentFromDOM</span>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">type_node</span>,
        <span class="summary-sig-arg">content_node</span>,
        <span class="summary-sig-arg">definition_node_list</span>,
        <span class="summary-sig-arg">method</span>,
        <span class="summary-sig-arg">**kw</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition.__setComplexContentFromDOM">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="__complexContent"></a><span class="summary-sig-name">__complexContent</span>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">method</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition.__complexContent">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#isResolved" class="summary-sig-name">isResolved</a>(<span class="summary-sig-arg">self</span>)</span><br />
      Indicate whether this complex type is fully defined.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition.isResolved">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="_setDerivationMethod"></a><span class="summary-sig-name">_setDerivationMethod</span>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">derivation_method</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition._setDerivationMethod">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="__setContentFromDOM"></a><span class="summary-sig-name">__setContentFromDOM</span>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">node</span>,
        <span class="summary-sig-arg">**kw</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition.__setContentFromDOM">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#_resolve" class="summary-sig-name" onclick="show_private();">_resolve</a>(<span class="summary-sig-arg">self</span>)</span><br />
      Perform whatever steps are required to resolve this component.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition._resolve">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="pythonSupport"></a><span class="summary-sig-name">pythonSupport</span>(<span class="summary-sig-arg">self</span>)</span><br />
      Complex type definitions have no built-in type support.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition.pythonSupport">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#__str__" class="summary-sig-name">__str__</a>(<span class="summary-sig-arg">self</span>)</span><br />
      str(x)</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition.__str__">source&nbsp;code</a></span>
  ...
  <tr>
    ...
    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.xmlschema.structures._AttributeWildcard_mixin-class.html" onclick="show_private();">_AttributeWildcard_mixin</a></code></b>:
      <code><a href="pyxb.xmlschema.structures._AttributeWildcard_mixin-class.html#attributeWildcard">attributeWildcard</a></code>
      </p>
    <div class="private">    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.xmlschema.structures._AttributeWildcard_mixin-class.html" onclick="show_private();">_AttributeWildcard_mixin</a></code></b> (private):
      <code><a href="pyxb.xmlschema.structures._AttributeWildcard_mixin-class.html#_attributeRelevantChildren" onclick="show_private();">_attributeRelevantChildren</a></code>,
      <code><a href="pyxb.xmlschema.structures._AttributeWildcard_mixin-class.html#_setAttributeWildcard" onclick="show_private();">_setAttributeWildcard</a></code>
      </p></div>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#UrTypeDefinition" class="summary-sig-name">UrTypeDefinition</a>(<span class="summary-sig-arg">cls</span>,
      ...
      Create the ComplexTypeDefinition instance that approximates the 
      ur-type.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition.UrTypeDefinition">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        ...
        <span class="summary-sig-arg">**kw</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition.CreateFromDOM">source&nbsp;code</a></span>
  ...
  <tr>
    <td colspan="2" class="summary">
    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.xmlschema.structures._AttributeWildcard_mixin-class.html" onclick="show_private();">_AttributeWildcard_mixin</a></code></b>:
      <code><a href="pyxb.xmlschema.structures._AttributeWildcard_mixin-class.html#CompleteWildcard">CompleteWildcard</a></code>
      </p>
    </td>
  </tr>
</table>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#__PrivateTransient" class="summary-name" onclick="show_private();">__PrivateTransient</a> = <code title="set(['anyAttribute',
     'attributeGroupAttributes',
     'attributeGroups',
     'ckw',
     'usesC1',
     'usesC1C2'])"><code class="variable-group">set([</code><code class="variable-quote">'</code><code class="variable-string">anyAttribute</code><code class="variable-quote">'</code><code class="variable-op">, </code><code class="variable-quote">'</code><code class="variable-string">attributeGroupAttri</code><code class="variable-ellipsis">...</code></code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__baseTypeDefinition"></a><span class="summary-name">__baseTypeDefinition</span> = <code title="None">None</code>
    </td>
  </tr>
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="DM_empty"></a><span class="summary-name">DM_empty</span> = <code title="0">0</code>
    </td>
  </tr>
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="DM_extension"></a><span class="summary-name">DM_extension</span> = <code title="1">1</code>
    </td>
  </tr>
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="DM_restriction"></a><span class="summary-name">DM_restriction</span> = <code title="2">2</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__derivationMethod"></a><span class="summary-name">__derivationMethod</span> = <code title="None">None</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__abstract"></a><span class="summary-name">__abstract</span> = <code title="False">False</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__attributeUses"></a><span class="summary-name">__attributeUses</span> = <code title="None">None</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__scopedAttributeDeclarations"></a><span class="summary-name">__scopedAttributeDeclarations</span> = <code title="None">None</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__scopedElementDeclarations"></a><span class="summary-name">__scopedElementDeclarations</span> = <code title="None">None</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__localScopedDeclarations"></a><span class="summary-name">__localScopedDeclarations</span> = <code title="None">None</code>
    </td>
  </tr>
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="CT_EMPTY"></a><span class="summary-name">CT_EMPTY</span> = <code title="'EMPTY'"><code class="variable-quote">'</code><code class="variable-string">EMPTY</code><code class="variable-quote">'</code></code>
    </td>
  </tr>
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="CT_SIMPLE"></a><span class="summary-name">CT_SIMPLE</span> = <code title="'SIMPLE'"><code class="variable-quote">'</code><code class="variable-string">SIMPLE</code><code class="variable-quote">'</code></code>
    </td>
  </tr>
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="CT_MIXED"></a><span class="summary-name">CT_MIXED</span> = <code title="'MIXED'"><code class="variable-quote">'</code><code class="variable-string">MIXED</code><code class="variable-quote">'</code></code>
    </td>
  </tr>
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="CT_ELEMENT_ONLY"></a><span class="summary-name">CT_ELEMENT_ONLY</span> = <code title="'ELEMENT_ONLY'"><code class="variable-quote">'</code><code class="variable-string">ELEMENT_ONLY</code><code class="variable-quote">'</code></code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__contentType"></a><span class="summary-name">__contentType</span> = <code title="None">None</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__prohibitedSubstitutions"></a><span class="summary-name">__prohibitedSubstitutions</span> = <code title="0">0</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__UrTypeDefinition"></a><span class="summary-name">__UrTypeDefinition</span> = <code title="None">None</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__ckw"></a><span class="summary-name">__ckw</span> = <code title="None">None</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__anyAttribute"></a><span class="summary-name">__anyAttribute</span> = <code title="None">None</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__attributeGroupAttributes"></a><span class="summary-name">__attributeGroupAttributes</span> = <code title="None">None</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__usesC1"></a><span class="summary-name">__usesC1</span> = <code title="None">None</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__usesC1C2"></a><span class="summary-name">__usesC1C2</span> = <code title="None">None</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__attributeGroups"></a><span class="summary-name">__attributeGroups</span> = <code title="None">None</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__ctscClause2STD"></a><span class="summary-name">__ctscClause2STD</span> = <code title="None">None</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__ctscRestrictioNode"></a><span class="summary-name">__ctscRestrictioNode</span> = <code title="None">None</code>
    </td>
  </tr>
  <tr>
    <td colspan="2" class="summary">
    ...
    <div class="private">    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.xmlschema.structures._AttributeWildcard_mixin-class.html" onclick="show_private();">_AttributeWildcard_mixin</a></code></b> (private):
      <code><a href="pyxb.xmlschema.structures._AttributeWildcard_mixin-class.html#_AttributeWildcard_mixin__attributeWildcard" onclick="show_private();">_AttributeWildcard_mixin__attributeWildcard</a></code>
      </p></div>
    </td>
  </tr>
</table>
...
<a name="lookupScopedAttributeDeclaration"></a>
<div>
<table class="details" border="1" cellpadding="3"
       cellspacing="0" width="100%" bgcolor="white">
<tr><td>
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr valign="top"><td>
  <h3 class="epydoc"><span class="sig"><span class="sig-name">lookupScopedAttributeDeclaration</span>(<span class="sig-arg">self</span>,
        <span class="sig-arg">expanded_name</span>)</span>
  </h3>
  ...
  <p>Find an attribute declaration with the given name that is local to 
  this type.</p>
...
<a name="lookupScopedElementDeclaration"></a>
<div>
<table class="details" border="1" cellpadding="3"
       cellspacing="0" width="100%" bgcolor="white">
<tr><td>
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr valign="top"><td>
  <h3 class="epydoc"><span class="sig"><span class="sig-name">lookupScopedElementDeclaration</span>(<span class="sig-arg">self</span>,
        <span class="sig-arg">expanded_name</span>)</span>
  </h3>
  </td><td align="right" valign="top"
    ><span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition.lookupScopedElementDeclaration">source&nbsp;code</a></span>&nbsp;
  ...
  <p>Find an element declaration with the given name that is local to this 
  type.</p>
...
<a name="localScopedDeclarations"></a>
<div>
<table class="details" border="1" cellpadding="3"
       cellspacing="0" width="100%" bgcolor="white">
<tr><td>
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr valign="top"><td>
  <h3 class="epydoc"><span class="sig"><span class="sig-name">localScopedDeclarations</span>(<span class="sig-arg">self</span>,
  ...
  <p>Return a list of element and attribute declarations that were 
  introduced in this definition (i.e., their scope is this CTD).</p>
  <dl class="fields">
    <dt>Parameters:</dt>
    <dd><ul class="nomargin-top">
        <li><strong class="pname"><code>reset</code></strong> - If <code>False</code> (default), a cached previous value (if it 
          exists) will be returned.</li>
    </ul></dd>
  </dl>
<div class="fields">      <p><strong>Note:</strong>
        This specifically returns a list, with element declarations first, 
        because name binding should privilege the elements over the 
        attributes.  Within elements and attributes, the components are 
        sorted by expanded name, to ensure consistency across a series of 
        binding generations.
      </p>
</div></td></tr></table>
</div>
<a name="_contentTypeTag"></a>
<div class="private">
<table class="details" border="1" cellpadding="3"
       cellspacing="0" width="100%" bgcolor="white">
<tr><td>
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr valign="top"><td>
  <h3 class="epydoc"><span class="sig"><span class="sig-name">_contentTypeTag</span>(<span class="sig-arg">self</span>)</span>
  </h3>
  </td><td align="right" valign="top"
    ><span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition._contentTypeTag">source&nbsp;code</a></span>&nbsp;
    </td>
  ...
  <p>Return the value of the content type identifier, i.e. one of the CT_ 
  constants.  Return value is None if no content type has been defined.</p>
  <dl class="fields">
  </dl>
</td></tr></table>
</div>
...
<tr><td>
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr valign="top"><td>
  <h3 class="epydoc"><span class="sig"><span class="sig-name">contentType</span>(<span class="sig-arg">self</span>)</span>
  </h3>
  </td><td align="right" valign="top"
    ><span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ComplexTypeDefinition.contentType">source&nbsp;code</a></span>&nbsp;
    </td>
  ...
  <p>Identify the sort of content in this type.</p>
  ...
  <ul>
    ...
    <li>
      ( <code>CT_SIMPLE</code>, a <a 
      href="pyxb.xmlschema.structures.SimpleTypeDefinition-class.html" 
      class="link">SimpleTypeDefinition</a> instance )
    </li>
    <li>
      ( <code>CT_MIXED</code>, a <a 
      href="pyxb.xmlschema.structures.Particle-class.html" 
      class="link">Particle</a> instance )
    </li>
    <li>
      ( <code>CT_ELEMENT_ONLY</code>, a <a 
      href="pyxb.xmlschema.structures.Particle-class.html" 
      class="link">Particle</a> instance )
    </li>
  </ul>
...
<tr><td>
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr valign="top"><td>
  <h3 class="epydoc"><span class="sig"><span class="sig-name">UrTypeDefinition</span>(<span class="sig-arg">cls</span>,
  ...
  <p>Create the ComplexTypeDefinition instance that approximates the 
  ur-type.</p>
...
<tr><td>
  ...
  <p>Complex type definitions depend on their base type definition, the 
  type definitions of any local attribute declarations, and if strict the 
  type definitions of any local element declarations.</p>
  <dl class="fields">
...
<tr><td>
  ...
  <p>Indicate whether this complex type is fully defined.</p>
  <p>All built-in type definitions are resolved upon creation. 
  Schema-defined type definitionss are held unresolved until the schema has
  been completely read, so that references to later schema-defined types 
  can be resolved.  Resolution is performed after the entire schema has 
  been scanned and type-definition instances created for all 
  topLevel{Simple,Complex}Types.</p>
  <p>If a built-in type definition is also defined in a schema (which it 
  should be), the built-in definition is kept, with the schema-related 
  information copied over from the matching schema-defined type definition.
  The former then replaces the latter in the list of type definitions to be
  resolved.  See Schema._addNamedComponent.</p>
  <dl class="fields">
    <dt>Overrides:
...
<a name="__PrivateTransient"></a>
<div class="private">
<table class="details" border="1" cellpadding="3"
       cellspacing="0" width="100%" bgcolor="white">
<tr><td>
  <h3 class="epydoc">__PrivateTransient</h3>
...
<code class="variable-group">set([</code><code class="variable-quote">'</code><code class="variable-string">anyAttribute</code><code class="variable-quote">'</code><code class="variable-op">,</code>
     <code class="variable-quote">'</code><code class="variable-string">attributeGroupAttributes</code><code class="variable-quote">'</code><code class="variable-op">,</code>
     <code class="variable-quote">'</code><code class="variable-string">attributeGroups</code><code class="variable-quote">'</code><code class="variable-op">,</code>
     <code class="variable-quote">'</code><code class="variable-string">ckw</code><code class="variable-quote">'</code><code class="variable-op">,</code>
     <code class="variable-quote">'</code><code class="variable-string">usesC1</code><code class="variable-quote">'</code><code class="variable-op">,</code>
     <code class="variable-quote">'</code><code class="variable-string">usesC1C2</code><code class="variable-quote">'</code><code class="variable-group">])</code>
</pre></td></tr></table>
</dd>
  </dl>
</td></tr></table>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%%">
  <tr>
    ...
    Generated by Epydoc 3.0.1 on Thu Jan 28 08:39:52 2010
    </td>
