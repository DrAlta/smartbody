...
<head>
  <title>pyxb.xmlschema.structures.ElementDeclaration</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="pyxb.xmlschema.structures.ElementDeclaration-class.html"
...
<!-- ==================== CLASS DESCRIPTION ==================== -->
<h1 class="epydoc">Class ElementDeclaration</h1><p class="nomargin-top"><span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ElementDeclaration">source&nbsp;code</a></span></p>
<pre class="base-tree">
                       object --+                
                                |                
     ...
     <a href="pyxb.utils.utility.PrivateTransient_mixin-class.html">utils.utility.PrivateTransient_mixin</a> --+   |
       ...
       <a href="pyxb.namespace.resolution._Resolvable_mixin-class.html" onclick="show_private();">namespace.resolution._Resolvable_mixin</a> --+
                     ...
                     <a href="pyxb.xmlschema.structures._ScopedDeclaration_mixin-class.html" onclick="show_private();">_ScopedDeclaration_mixin</a> --+
                                                |
                                               <strong class="uidshort">ElementDeclaration</strong>
</pre>

<hr />
<p>An XMLSchema <a 
  href="http://www.w3.org/TR/xmlschema-1/#cElement_Declarations" 
  target="_top">Element Declaration</a> component.</p>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      The simple or complex type to which the element value conforms.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ElementDeclaration.typeDefinition">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="_typeDefinition"></a><span class="summary-sig-name">_typeDefinition</span>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">type_definition</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ElementDeclaration._typeDefinition">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="nillable"></a><span class="summary-sig-name">nillable</span>(<span class="summary-sig-arg">self</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ElementDeclaration.nillable">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="identityConstraintDefinitions"></a><span class="summary-sig-name">identityConstraintDefinitions</span>(<span class="summary-sig-arg">self</span>)</span><br />
      A list of IdentityConstraintDefinition instances.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ElementDeclaration.identityConstraintDefinitions">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="substitutionGroupAffiliation"></a><span class="summary-sig-name">substitutionGroupAffiliation</span>(<span class="summary-sig-arg">self</span>)</span><br />
      None, or a reference to an ElementDeclaration.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ElementDeclaration.substitutionGroupAffiliation">source&nbsp;code</a></span>
    ...
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          ...
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ElementDeclaration.abstract">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.xmlschema.structures.ElementDeclaration-class.html#pluralityData" class="summary-sig-name">pluralityData</a>(<span class="summary-sig-arg">self</span>)</span><br />
      Return the plurality information for this component.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ElementDeclaration.pluralityData">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      Return False, since element declarations are not wildcards.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ElementDeclaration.hasWildcardElement">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.xmlschema.structures.ElementDeclaration-class.html#_bindingRequires_vx" class="summary-sig-name" onclick="show_private();">_bindingRequires_vx</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">include_lax</span>)</span><br />
      Element declarations depend on the type definition of their content.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ElementDeclaration._bindingRequires_vx">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.xmlschema.structures.ElementDeclaration-class.html#__init__" class="summary-sig-name">__init__</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">*args</span>,
        <span class="summary-sig-arg">**kw</span>)</span><br />
      Initialize portions of a component.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ElementDeclaration.__init__">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.xmlschema.structures.ElementDeclaration-class.html#isAdaptable" class="summary-sig-name">isAdaptable</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">ctd</span>)</span><br />
      Determine whether this element declaration is adaptable.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ElementDeclaration.isAdaptable">source&nbsp;code</a></span>
    ...
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        ...
        <span class="summary-sig-arg">ctd</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ElementDeclaration._adaptForScope">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.xmlschema.structures.ElementDeclaration-class.html#isResolved" class="summary-sig-name">isResolved</a>(<span class="summary-sig-arg">self</span>)</span><br />
      Determine whether this named component is resolved.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ElementDeclaration.isResolved">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.xmlschema.structures.ElementDeclaration-class.html#_resolve" class="summary-sig-name" onclick="show_private();">_resolve</a>(<span class="summary-sig-arg">self</span>)</span><br />
      Perform whatever steps are required to resolve this component.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ElementDeclaration._resolve">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.xmlschema.structures.ElementDeclaration-class.html#__str__" class="summary-sig-name">__str__</a>(<span class="summary-sig-arg">self</span>)</span><br />
      str(x)</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ElementDeclaration.__str__">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.xmlschema.structures.ElementDeclaration-class.html#CreateFromDOM" class="summary-sig-name">CreateFromDOM</a>(<span class="summary-sig-arg">cls</span>,
        <span class="summary-sig-arg">node</span>,
        <span class="summary-sig-arg">**kw</span>)</span><br />
      Create an element declaration from the given DOM node.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#ElementDeclaration.CreateFromDOM">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__identityConstraintDefinitions"></a><span class="summary-name">__identityConstraintDefinitions</span> = <code title="None">None</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__substitutionGroupAffiliation"></a><span class="summary-name">__substitutionGroupAffiliation</span> = <code title="None">None</code>
    </td>
  </tr>
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="SGE_none"></a><span class="summary-name">SGE_none</span> = <code title="0">0</code>
    </td>
  </tr>
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="SGE_extension"></a><span class="summary-name">SGE_extension</span> = <code title="1">1</code>
    </td>
  </tr>
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="SGE_restriction"></a><span class="summary-name">SGE_restriction</span> = <code title="2">2</code>
    </td>
  </tr>
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="SGE_substitution"></a><span class="summary-name">SGE_substitution</span> = <code title="4">4</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__substitutionGroupExclusions"></a><span class="summary-name">__substitutionGroupExclusions</span> = <code title="0">0</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__disallowedSubstitutions"></a><span class="summary-name">__disallowedSubstitutions</span> = <code title="0">0</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__isResolved"></a><span class="summary-name">__isResolved</span> = <code title="False">False</code>
    </td>
  </tr>
  <tr>
    <td colspan="2" class="summary">
...
<tr><td>
  ...
  <p>Return the plurality information for this component.</p>
  <p>An ElementDeclaration produces one instance of a single element.</p>
  <dl class="fields">
  </dl>
</td></tr></table>
</div>
...
<tr><td>
  ...
  <p>Element declarations depend on the type definition of their 
  content.</p>
  <dl class="fields">
...
<tr><td>
  ...
  <p>Create an element declaration from the given DOM node.</p>
  <p>wxs is a Schema instance within which the element is being 
  declared.</p>
  <p>scope is the _ScopeDeclaration_mixin context into which the element 
  declaration is recorded.  It can be SCOPE_global, a complex type 
  definition, or None in the case of elements declared in a named model 
  group.</p>
  <p>node is a DOM element.  The name must be 'element', and the node must 
  be in the XMLSchema namespace.</p>
  <dl class="fields">
  </dl>
</td></tr></table>
</div>
<a name="isAdaptable"></a>
<div>
<table class="details" border="1" cellpadding="3"
       cellspacing="0" width="100%" bgcolor="white">
<tr><td>
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr valign="top"><td>
  <h3 class="epydoc"><span class="sig"><span class="sig-name">isAdaptable</span>(<span class="sig-arg">self</span>,
  ...
  <p>Determine whether this element declaration is adaptable.</p>
  ...
  verify that it is derivation-consistent with any other uses of the same 
  name in the same complex type.  If the element's type is resolved, that's
  good enough.</p>
  <p>If the element's type isn't resolved, we're golden as long as 
  type-equivalent types were used.  But it's also allowed for the derived 
  ctd to use the element name constraining it to a derivation of the 
  element base type.  (Go see namespace http://www.opengis.net/ows/1.1 
  types PositionType, PositionType2D, BoundingBox, and WGS84BoundingBox for
  an example).  So, we really do have to have the element's type 
  resolved.</p>
  <p>Except that if a CTD's content incorporates an element with the same 
  type as the CTD (i.e., nested), this will never happen, because the CTD 
  can't get resolved until after it has been resolved. (Go see 
  {http://www.opengis.net/ows/1.1}ContentsBaseType and 
  {http://www.opengis.net/ows/1.1}DatasetDescriptionSummaryBaseType for an 
  example).</p>
  <p>So, we give the world a break and assume that if the type we're trying
  to resolve is the same as the type of an element in that type, then the 
  element type will be resolved by the point it's needed.  In point of 
  fact, it won't, but we'll only notice that if a CTD contains an element 
  whose type is a restriction of the CTD.  In that case, 
  isDerivationConsistent will blow chunks and somebody'll have to come back
  and finish up this mess.</p>
  <dl class="fields">
  </dl>
</td></tr></table>
</div>
