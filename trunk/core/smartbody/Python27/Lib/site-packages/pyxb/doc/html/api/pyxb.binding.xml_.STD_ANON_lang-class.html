...
<head>
  <title>pyxb.binding.xml_.STD_ANON_lang</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="pyxb.binding.xml_.STD_ANON_lang-class.html"
...
<!-- ==================== CLASS DESCRIPTION ==================== -->
<h1 class="epydoc">Class STD_ANON_lang</h1><p class="nomargin-top"><span class="codelink"><a href="pyxb.binding.xml_-pysrc.html#STD_ANON_lang">source&nbsp;code</a></span></p>
<pre class="base-tree">
                    object --+                    
                             |                    
...
<a href="pyxb.utils.utility._DeconflictSymbols_mixin-class.html" onclick="show_private();">utils.utility._DeconflictSymbols_mixin</a> --+        
            ...
            <a href="pyxb.binding.basis._DynamicCreate_mixin-class.html" onclick="show_private();">basis._DynamicCreate_mixin</a> --+        
                ...
                <a href="pyxb.binding.basis.simpleTypeDefinition-class.html">basis.simpleTypeDefinition</a> --+    
                                             |    
                               <a href="pyxb.binding.basis.STD_union-class.html">basis.STD_union</a> --+
                                                 |
                                                <strong class="uidshort">STD_ANON_lang</strong>
</pre>

<hr />
<p>Simple type that is a union of pyxb.binding.datatypes.language, 
  STD_ANON_emptyString</p>
...
<tr bgcolor="#70b0f0" class="table-header">
  ...
  <tr>
    ...
    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.basis.STD_union-class.html">basis.STD_union</a></code></b>:
      <code><a href="pyxb.binding.basis.STD_union-class.html#__init__">__init__</a></code>
      </p>
...
<tr bgcolor="#70b0f0" class="table-header">
  ...
  <tr>
    <td colspan="2" class="summary">
    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.basis.STD_union-class.html">basis.STD_union</a></code></b>:
      <code><a href="pyxb.binding.basis.STD_union-class.html#Factory">Factory</a></code>,
      <code><a href="pyxb.binding.basis.STD_union-class.html#XsdLiteral">XsdLiteral</a></code>
      </p>
    <div class="private">    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.basis.STD_union-class.html">basis.STD_union</a></code></b> (private):
      <code><a href="pyxb.binding.basis.STD_union-class.html#_ValidatedMember" onclick="show_private();">_ValidatedMember</a></code>,
      <code><a href="pyxb.binding.basis.STD_union-class.html#_description" onclick="show_private();">_description</a></code>
      </p></div>
    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.basis.simpleTypeDefinition-class.html">basis.simpleTypeDefinition</a></code></b>:
      <code><a href="pyxb.binding.basis.simpleTypeDefinition-class.html#PythonLiteral">PythonLiteral</a></code>,
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.xml_.STD_ANON_lang-class.html#_MemberTypes" class="summary-name" onclick="show_private();">_MemberTypes</a> = <code title="(&lt;class 'pyxb.binding.datatypes.language'&gt;,
 &lt;class 'pyxb.binding.xml_.STD_ANON_emptyString'&gt;)"><code class="variable-group">(</code>&lt;class 'pyxb.binding.datatypes.language'&gt;<code class="variable-op">, </code>&lt;cl<code class="variable-ellipsis">...</code></code><br />
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.xml_.STD_ANON_lang-class.html#_CF_enumeration" class="summary-name" onclick="show_private();">_CF_enumeration</a> = <code title="pyxb.binding.facets.CF_enumeration(value_datatype= STD_ANON_lang)">pyxb.binding.facets.CF_enumeration(value_dat<code class="variable-ellipsis">...</code></code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="_CF_pattern"></a><span class="summary-name">_CF_pattern</span> = <code title="pyxb.binding.facets.CF_pattern()">pyxb.binding.facets.CF_pattern()</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.xml_.STD_ANON_lang-class.html#_STD_ANON_lang_FacetMap" class="summary-name" onclick="show_private();">_STD_ANON_lang_FacetMap</a> = <code title="{&lt;class 'pyxb.binding.facets.CF_pattern'&gt;: &lt;pyxb.binding.facets.CF_pat\
tern object at 0x9e04e8c&gt;,
 &lt;class 'pyxb.binding.facets.CF_enumeration'&gt;: &lt;pyxb.binding.facets.CF\
_enumeration object at 0x9d496cc&gt;}"><code class="variable-group">{</code>&lt;class 'pyxb.binding.facets.CF_patt<code class="variable-ellipsis">...</code></code>
    </td>
  </tr>
  <tr>
    <td colspan="2" class="summary">
...
<a name="_MemberTypes"></a>
<div class="private">
<table class="details" border="1" cellpadding="3"
       cellspacing="0" width="100%" bgcolor="white">
<tr><td>
  <h3 class="epydoc">_MemberTypes</h3>
  <p>A list of classes which are permitted as values of the union.</p>
  <dl class="fields">
  </dl>
  <dl class="fields">
    <dt>Value:</dt>
      <dd><table><tr><td><pre class="variable">
<code class="variable-group">(</code>&lt;class 'pyxb.binding.datatypes.language'&gt;<code class="variable-op">,</code>
 &lt;class 'pyxb.binding.xml_.STD_ANON_emptyString'&gt;<code class="variable-group">)</code>
</pre></td></tr></table>
</dd>
  </dl>
</td></tr></table>
...
<a name="_STD_ANON_lang_FacetMap"></a>
<div class="private">
<table class="details" border="1" cellpadding="3"
       cellspacing="0" width="100%" bgcolor="white">
<tr><td>
  <h3 class="epydoc">_STD_ANON_lang_FacetMap</h3>
...
tern object at 0x9e04e8c&gt;<code class="variable-op">,</code>
...
_enumeration object at 0x9d496cc&gt;<code class="variable-group">}</code>
</pre></td></tr></table>
</dd>
  </dl>
</td></tr></table>
