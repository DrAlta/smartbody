...
{
	double emphTime = motion->time_stroke_emphasis();////(motion->time_stroke_end()+motion->time_stroke_emphasis())*0.5f;//motion->time_stroke_emphasis();//(motion->time_stroke_end()+motion->time_stroke_emphasis())*0.5f;	
