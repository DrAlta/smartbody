...
namespace BML {
	...
	BML::BehaviorRequestPtr parse_bml_animation( DOMElement* elem, const std::string& unique_id, BML::SyncPoints& tms, bool required, BML::BmlRequestPtr request, mcuCBHandle *mcu );
};
