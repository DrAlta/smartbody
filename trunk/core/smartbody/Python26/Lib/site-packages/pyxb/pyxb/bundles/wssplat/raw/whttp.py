...
# Generated 2010-01-28 08:40:24.405000 by PyXB version 1.1.1
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:735da5b0-0c23-11df-9f0a-000c29370554')
...
STD_ANON_1.basic = STD_ANON_1._CF_enumeration.addEnumeration(unicode_value=u'basic')
STD_ANON_1.digest = STD_ANON_1._CF_enumeration.addEnumeration(unicode_value=u'digest')
...
STD_ANON_2.any = STD_ANON_2._CF_enumeration.addEnumeration(unicode_value=u'#any')
...
class STD_ANON_3 (pyxb.binding.basis.STD_union):
    ...
    """Simple type that is a union of pyxb.binding.datatypes.int, STD_ANON_2."""

    _ExpandedName = None
    _Documentation = None

    _MemberTypes = ( pyxb.binding.datatypes.int, STD_ANON_2, )
...
STD_ANON_3.any = u'#any'                          # originally STD_ANON_2.any
