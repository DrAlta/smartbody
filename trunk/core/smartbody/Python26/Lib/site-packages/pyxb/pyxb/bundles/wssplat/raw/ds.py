...
# Generated 2010-01-28 08:40:25.208000 by PyXB version 1.1.1
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:73cf5340-0c23-11df-9233-000c29370554')
...
DSAKeyValueType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
    ...
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=DSAKeyValueType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'J'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=DSAKeyValueType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Seed'))),
    ])
