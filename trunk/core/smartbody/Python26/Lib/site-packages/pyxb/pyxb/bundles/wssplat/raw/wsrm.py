...
# Generated 2010-01-28 08:40:38.441000 by PyXB version 1.1.1
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:7bb348a0-0c23-11df-847c-000c29370554')
...
class CTD_ANON_6 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __Lower = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'Lower'), 'Lower', '__httpdocs_oasis_open_orgws_rxwsrm200702_CTD_ANON_6_Lower', pyxb.binding.datatypes.unsignedLong, required=True)
    
    Lower = property(__Lower.value, __Lower.set, None, None)

    
    # Attribute Upper uses Python identifier Upper
    __Upper = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'Upper'), 'Upper', '__httpdocs_oasis_open_orgws_rxwsrm200702_CTD_ANON_6_Upper', pyxb.binding.datatypes.unsignedLong, required=True)
...
class CTD_ANON_9 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __None = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'None'), 'None_', '__httpdocs_oasis_open_orgws_rxwsrm200702_CTD_ANON_9_httpdocs_oasis_open_orgws_rxwsrm200702None', False)
    ...
    __Final = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Final'), 'Final', '__httpdocs_oasis_open_orgws_rxwsrm200702_CTD_ANON_9_httpdocs_oasis_open_orgws_rxwsrm200702Final', False)
    ...
    # Element {http://docs.oasis-open.org/ws-rx/wsrm/200702}Identifier uses Python identifier Identifier
    __Identifier = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Identifier'), 'Identifier', '__httpdocs_oasis_open_orgws_rxwsrm200702_CTD_ANON_9_httpdocs_oasis_open_orgws_rxwsrm200702Identifier', False)
    ...
    __Nack = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Nack'), 'Nack', '__httpdocs_oasis_open_orgws_rxwsrm200702_CTD_ANON_9_httpdocs_oasis_open_orgws_rxwsrm200702Nack', True)
    ...
    __AcknowledgementRange = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'AcknowledgementRange'), 'AcknowledgementRange', '__httpdocs_oasis_open_orgws_rxwsrm200702_CTD_ANON_9_httpdocs_oasis_open_orgws_rxwsrm200702AcknowledgementRange', True)
...
Address = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Address'), CTD_ANON_5)
...
SequenceAcknowledgement = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'SequenceAcknowledgement'), CTD_ANON_9)
...
CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'None'), CTD_ANON_4, scope=CTD_ANON_9))

CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Final'), CTD_ANON_8, scope=CTD_ANON_9))

CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Identifier'), CTD_ANON_2, scope=CTD_ANON_9))

CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Nack'), pyxb.binding.datatypes.unsignedLong, scope=CTD_ANON_9))

CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AcknowledgementRange'), CTD_ANON_6, scope=CTD_ANON_9))
CTD_ANON_9._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Identifier'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://docs.oasis-open.org/ws-rx/wsrm/200702'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Nack'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'None'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AcknowledgementRange'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Nack'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://docs.oasis-open.org/ws-rx/wsrm/200702'))),
    ...
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Final'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://docs.oasis-open.org/ws-rx/wsrm/200702'))),
    ])
