...
# Generated 2010-01-28 08:42:05.433000 by PyXB version 1.1.1
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:ae5bba80-0c23-11df-a308-000c29370554')
...
class AnyOrReferenceType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netsampling1_0_AnyOrReferenceType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    ...
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netsampling1_0_AnyOrReferenceType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
class LocationPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netsampling1_0_LocationPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    
    actuate = property(__actuate.value, __actuate.set, None, u"\n        The 'actuate' attribute is used to communicate the desired timing \n        of traversal from the starting resource to the ending resource; \n        it's value should be treated as follows:\n        onLoad - traverse to the ending resource immediately on loading \n                 the starting resource \n        onRequest - traverse from the starting resource to the ending \n                    resource only on a post-loading event triggered for \n                    this purpose \n        other - behavior is unconstrained; examine other markup in link \n                for hints \n        none - behavior is unconstrained\n      ")

    
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netsampling1_0_LocationPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class SurveyProcedurePropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netsampling1_0_SurveyProcedurePropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    
    show = property(__show.value, __show.set, None, u"\n        The 'show' attribute is used to communicate the desired presentation \n        of the ending resource on traversal from the starting resource; it's \n        value should be treated as follows: \n        new - load ending resource in a new window, frame, pane, or other \n              presentation context\n        replace - load the resource in the same window, frame, pane, or \n                  other presentation context\n        embed - load ending resource in place of the presentation of the \n                starting resource\n        other - behavior is unconstrained; examine other markup in the \n                link for hints \n        none - behavior is unconstrained \n      ")

    
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netsampling1_0_SurveyProcedurePropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
class CTD_ANON_1 (pyxb.bundles.opengis.gml.MeasureType):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netsampling1_0_CTD_ANON_1_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netsampling1_0_CTD_ANON_1_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
class SpatiallyExtensiveSamplingFeaturePropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netsampling1_0_SpatiallyExtensiveSamplingFeaturePropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    
    show = property(__show.value, __show.set, None, u"\n        The 'show' attribute is used to communicate the desired presentation \n        of the ending resource on traversal from the starting resource; it's \n        value should be treated as follows: \n        new - load ending resource in a new window, frame, pane, or other \n              presentation context\n        replace - load the resource in the same window, frame, pane, or \n                  other presentation context\n        embed - load ending resource in place of the presentation of the \n                starting resource\n        other - behavior is unconstrained; examine other markup in the \n                link for hints \n        none - behavior is unconstrained \n      ")

    
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netsampling1_0_SpatiallyExtensiveSamplingFeaturePropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
class SpecimenPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netsampling1_0_SpecimenPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netsampling1_0_SpecimenPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
class SamplingPointPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netsampling1_0_SamplingPointPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    
    show = property(__show.value, __show.set, None, u"\n        The 'show' attribute is used to communicate the desired presentation \n        of the ending resource on traversal from the starting resource; it's \n        value should be treated as follows: \n        new - load ending resource in a new window, frame, pane, or other \n              presentation context\n        replace - load the resource in the same window, frame, pane, or \n                  other presentation context\n        embed - load ending resource in place of the presentation of the \n                starting resource\n        other - behavior is unconstrained; examine other markup in the \n                link for hints \n        none - behavior is unconstrained \n      ")

    
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netsampling1_0_SamplingPointPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
class LocatedSpecimenPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netsampling1_0_LocatedSpecimenPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netsampling1_0_LocatedSpecimenPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
class SamplingSolidPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netsampling1_0_SamplingSolidPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netsampling1_0_SamplingSolidPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class SamplingFeaturePropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netsampling1_0_SamplingFeaturePropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netsampling1_0_SamplingFeaturePropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class SamplingSurfacePropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netsampling1_0_SamplingSurfacePropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    
    show = property(__show.value, __show.set, None, u"\n        The 'show' attribute is used to communicate the desired presentation \n        of the ending resource on traversal from the starting resource; it's \n        value should be treated as follows: \n        new - load ending resource in a new window, frame, pane, or other \n              presentation context\n        replace - load the resource in the same window, frame, pane, or \n                  other presentation context\n        embed - load ending resource in place of the presentation of the \n                starting resource\n        other - behavior is unconstrained; examine other markup in the \n                link for hints \n        none - behavior is unconstrained \n      ")

    
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netsampling1_0_SamplingSurfacePropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
class SamplingCurvePropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netsampling1_0_SamplingCurvePropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netsampling1_0_SamplingCurvePropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class SamplingFeatureCollectionPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netsampling1_0_SamplingFeatureCollectionPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netsampling1_0_SamplingFeatureCollectionPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
SamplingFeatureType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=SamplingFeatureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
    ...
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=SamplingFeatureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'surveyDetails'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=SamplingFeatureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'relatedSamplingFeature'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=SamplingFeatureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'relatedObservation'))),
    ])
...
SpatiallyExtensiveSamplingFeatureType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=SpatiallyExtensiveSamplingFeatureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
    ...
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=SpatiallyExtensiveSamplingFeatureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'surveyDetails'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=SpatiallyExtensiveSamplingFeatureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'relatedSamplingFeature'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=SpatiallyExtensiveSamplingFeatureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'relatedObservation'))),
    ])
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=SpatiallyExtensiveSamplingFeatureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=SpatiallyExtensiveSamplingFeatureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'sampledFeature'))),
...
SamplingSurfaceType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=SamplingSurfaceType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=SamplingSurfaceType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'boundedBy'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=SamplingSurfaceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'sampledFeature'))),
    ...
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=SamplingSurfaceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'relatedObservation'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=SamplingSurfaceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'relatedSamplingFeature'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=SamplingSurfaceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'surveyDetails'))),
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=SamplingSurfaceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'shape'))),
    ])
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=SamplingSurfaceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'sampledFeature'))),
    ])
    ...
    , 9 : pyxb.binding.content.ContentModelState(state=9, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=SamplingSurfaceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'area'))),
    ])
})
...
SamplingPointType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=SamplingPointType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'boundedBy'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=SamplingPointType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'sampledFeature'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SamplingPointType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SamplingPointType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=SamplingPointType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'boundedBy'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=SamplingPointType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
    ...
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=SamplingPointType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'relatedObservation'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=SamplingPointType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'relatedSamplingFeature'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=SamplingPointType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'surveyDetails'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=SamplingPointType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'position'))),
    ])
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=SamplingPointType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'sampledFeature'))),
    ])
...
SurveyProcedureType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=SurveyProcedureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'elevationMethod'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SurveyProcedureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=SurveyProcedureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'elevationAccuracy'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=SurveyProcedureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'boundedBy'))),
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=SurveyProcedureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'positionMethod'))),
        pyxb.binding.content.ContentModelTransition(next_state=11, element_use=SurveyProcedureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'operator'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=SurveyProcedureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=SurveyProcedureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=SurveyProcedureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'geodeticDatum'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=SurveyProcedureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'elevationDatum'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=SurveyProcedureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'elevationAccuracy'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=SurveyProcedureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'elevationMethod'))),
    ...
    , 9 : pyxb.binding.content.ContentModelState(state=9, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=10, element_use=SurveyProcedureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'positionAccuracy'))),
        pyxb.binding.content.ContentModelTransition(next_state=12, element_use=SurveyProcedureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'projection'))),
...
SamplingFeatureCollectionType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=SamplingFeatureCollectionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=SamplingFeatureCollectionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'boundedBy'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=SamplingFeatureCollectionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'sampledFeature'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SamplingFeatureCollectionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SamplingFeatureCollectionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=SamplingFeatureCollectionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'boundedBy'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SamplingFeatureCollectionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
    ...
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=SamplingFeatureCollectionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'surveyDetails'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=SamplingFeatureCollectionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'relatedSamplingFeature'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=SamplingFeatureCollectionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'member'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=SamplingFeatureCollectionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'relatedObservation'))),
    ])
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=SamplingFeatureCollectionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=SamplingFeatureCollectionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'sampledFeature'))),
...
SamplingCurveType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=SamplingCurveType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=SamplingCurveType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'boundedBy'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=SamplingCurveType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'sampledFeature'))),
    ...
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=SamplingCurveType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'relatedObservation'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=SamplingCurveType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'relatedSamplingFeature'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=SamplingCurveType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'surveyDetails'))),
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=SamplingCurveType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'shape'))),
    ])
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=SamplingCurveType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=SamplingCurveType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'sampledFeature'))),
    ...
    , 9 : pyxb.binding.content.ContentModelState(state=9, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=SamplingCurveType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'length'))),
    ])
})
...
SpecimenType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=SpecimenType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=SpecimenType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'boundedBy'))),
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=SpecimenType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'sampledFeature'))),
    ...
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=SpecimenType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'processingDetails'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=SpecimenType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'materialClass'))),
    ])
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=SpecimenType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'sampledFeature'))),
    ])
    , 6 : pyxb.binding.content.ContentModelState(state=6, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=SpecimenType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'size'))),
        pyxb.binding.content.ContentModelTransition(next_state=10, element_use=SpecimenType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'samplingMethod'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=SpecimenType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'samplingTime'))),
    ...
    , 9 : pyxb.binding.content.ContentModelState(state=9, is_final=False, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=SpecimenType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'surveyDetails'))),
...
LocatedSpecimenType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=LocatedSpecimenType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=LocatedSpecimenType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'boundedBy'))),
        pyxb.binding.content.ContentModelTransition(next_state=10, element_use=LocatedSpecimenType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'sampledFeature'))),
    ...
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=LocatedSpecimenType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'processingDetails'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=LocatedSpecimenType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'samplingLocation'))),
    ])
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=LocatedSpecimenType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'materialClass'))),
    ])
    , 6 : pyxb.binding.content.ContentModelState(state=6, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=10, element_use=LocatedSpecimenType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'sampledFeature'))),
    ])
    , 7 : pyxb.binding.content.ContentModelState(state=7, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=LocatedSpecimenType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'size'))),
        pyxb.binding.content.ContentModelTransition(next_state=11, element_use=LocatedSpecimenType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'samplingMethod'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=LocatedSpecimenType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'samplingTime'))),
        pyxb.binding.content.ContentModelTransition(next_state=13, element_use=LocatedSpecimenType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'currentLocation'))),
    ])
    , 8 : pyxb.binding.content.ContentModelState(state=8, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=LocatedSpecimenType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
        pyxb.binding.content.ContentModelTransition(next_state=10, element_use=LocatedSpecimenType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'sampledFeature'))),
    ...
    , 10 : pyxb.binding.content.ContentModelState(state=10, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=12, element_use=LocatedSpecimenType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'relatedObservation'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=LocatedSpecimenType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'surveyDetails'))),
        pyxb.binding.content.ContentModelTransition(next_state=12, element_use=LocatedSpecimenType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'relatedSamplingFeature'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=LocatedSpecimenType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'materialClass'))),
        pyxb.binding.content.ContentModelTransition(next_state=10, element_use=LocatedSpecimenType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'sampledFeature'))),
    ])
    , 11 : pyxb.binding.content.ContentModelState(state=11, is_final=False, transitions=[
...
SamplingSolidType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=SamplingSolidType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=SamplingSolidType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'boundedBy'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=SamplingSolidType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'sampledFeature'))),
    ...
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=SamplingSolidType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'shape'))),
    ])
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=SamplingSolidType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'sampledFeature'))),
    ])
    , 6 : pyxb.binding.content.ContentModelState(state=6, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=SamplingSolidType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'volume'))),
    ])
    , 7 : pyxb.binding.content.ContentModelState(state=7, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=SamplingSolidType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'surveyDetails'))),
