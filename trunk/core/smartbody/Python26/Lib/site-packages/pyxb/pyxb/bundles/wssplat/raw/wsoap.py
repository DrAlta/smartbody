...
# Generated 2010-01-28 08:40:31.576000 by PyXB version 1.1.1
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:77a56180-0c23-11df-aedd-000c29370554')
...
class STD_ANON_2 (pyxb.binding.basis.STD_union):
    ...
    """Simple type that is a union of TokenAny, STD_ANON_1."""

    _ExpandedName = None
    _Documentation = None

    _MemberTypes = ( TokenAny, STD_ANON_1, )
...
class CTD_ANON_1 (pyxb.bundles.wssplat.wsdl20.ExtensibleDocumentedType):
    ...
    __ref = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'ref'), 'ref', '__httpwww_w3_orgnswsdlsoap_CTD_ANON_1_ref', pyxb.binding.datatypes.anyURI, required=True)
...
class CTD_ANON_2 (pyxb.bundles.wssplat.wsdl20.ExtensibleDocumentedType):
    ...
    __mustUnderstand = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'mustUnderstand'), 'mustUnderstand', '__httpwww_w3_orgnswsdlsoap_CTD_ANON_2_mustUnderstand', pyxb.binding.datatypes.boolean)
    ...
    __element = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'element'), 'element', '__httpwww_w3_orgnswsdlsoap_CTD_ANON_2_element', pyxb.binding.datatypes.QName, required=True)
...
module = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'module'), CTD_ANON_1)
Namespace.addCategoryObject('elementBinding', module.name().localName(), module)

header = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'header'), CTD_ANON_2)
