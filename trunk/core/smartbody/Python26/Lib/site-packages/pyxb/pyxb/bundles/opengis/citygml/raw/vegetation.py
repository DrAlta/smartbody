...
# Generated 2010-01-28 08:42:48.253000 by PyXB version 1.1.1
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:c82e9950-0c23-11df-b633-000c29370554')
...
AbstractVegetationObjectType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=AbstractVegetationObjectType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'boundedBy'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=AbstractVegetationObjectType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
    ])
...
PlantCoverType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=10, element_use=PlantCoverType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'function'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=PlantCoverType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/citygml/1.0'), u'externalReference'))),
        pyxb.binding.content.ContentModelTransition(next_state=16, element_use=PlantCoverType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'boundedBy'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=PlantCoverType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/citygml/1.0'), u'_GenericApplicationPropertyOfCityObject'))),
        pyxb.binding.content.ContentModelTransition(next_state=13, element_use=PlantCoverType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lod2MultiSurface'))),
        pyxb.binding.content.ContentModelTransition(next_state=14, element_use=PlantCoverType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lod3MultiSurface'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=PlantCoverType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lod4MultiSurface'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=PlantCoverType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lod1MultiSolid'))),
        pyxb.binding.content.ContentModelTransition(next_state=12, element_use=PlantCoverType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lod2MultiSolid'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=PlantCoverType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lod3MultiSolid'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=PlantCoverType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/citygml/1.0'), u'terminationDate'))),
        pyxb.binding.content.ContentModelTransition(next_state=10, element_use=PlantCoverType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'class'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=PlantCoverType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'averageHeight'))),
        pyxb.binding.content.ContentModelTransition(next_state=11, element_use=PlantCoverType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/citygml/1.0'), u'creationDate'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=PlantCoverType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfPlantCover'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=PlantCoverType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=PlantCoverType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
        pyxb.binding.content.ContentModelTransition(next_state=15, element_use=PlantCoverType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfVegetationObject'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=PlantCoverType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=PlantCoverType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/citygml/1.0'), u'generalizesTo'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=15, element_use=PlantCoverType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfVegetationObject'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=PlantCoverType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lod3MultiSolid'))),
...
SolitaryVegetationObjectType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=12, element_use=SolitaryVegetationObjectType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'function'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=SolitaryVegetationObjectType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'species'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=SolitaryVegetationObjectType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'height'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=SolitaryVegetationObjectType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=13, element_use=SolitaryVegetationObjectType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'trunkDiameter'))),
        pyxb.binding.content.ContentModelTransition(next_state=10, element_use=SolitaryVegetationObjectType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lod3ImplicitRepresentation'))),
        pyxb.binding.content.ContentModelTransition(next_state=20, element_use=SolitaryVegetationObjectType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'crownDiameter'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=SolitaryVegetationObjectType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lod1Geometry'))),
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=SolitaryVegetationObjectType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lod2Geometry'))),
        pyxb.binding.content.ContentModelTransition(next_state=11, element_use=SolitaryVegetationObjectType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lod3Geometry'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SolitaryVegetationObjectType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lod2ImplicitRepresentation'))),
        pyxb.binding.content.ContentModelTransition(next_state=14, element_use=SolitaryVegetationObjectType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/citygml/1.0'), u'externalReference'))),
        pyxb.binding.content.ContentModelTransition(next_state=14, element_use=SolitaryVegetationObjectType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/citygml/1.0'), u'terminationDate'))),
        pyxb.binding.content.ContentModelTransition(next_state=16, element_use=SolitaryVegetationObjectType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfSolitaryVegetationObject'))),
        pyxb.binding.content.ContentModelTransition(next_state=12, element_use=SolitaryVegetationObjectType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'class'))),
        pyxb.binding.content.ContentModelTransition(next_state=14, element_use=SolitaryVegetationObjectType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/citygml/1.0'), u'_GenericApplicationPropertyOfCityObject'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=SolitaryVegetationObjectType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lod1ImplicitRepresentation'))),
        pyxb.binding.content.ContentModelTransition(next_state=16, element_use=SolitaryVegetationObjectType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lod4ImplicitRepresentation'))),
        pyxb.binding.content.ContentModelTransition(next_state=15, element_use=SolitaryVegetationObjectType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lod4Geometry'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=SolitaryVegetationObjectType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
        pyxb.binding.content.ContentModelTransition(next_state=17, element_use=SolitaryVegetationObjectType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'boundedBy'))),
        pyxb.binding.content.ContentModelTransition(next_state=19, element_use=SolitaryVegetationObjectType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfVegetationObject'))),
        pyxb.binding.content.ContentModelTransition(next_state=18, element_use=SolitaryVegetationObjectType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/citygml/1.0'), u'creationDate'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=SolitaryVegetationObjectType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=14, element_use=SolitaryVegetationObjectType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/citygml/1.0'), u'generalizesTo'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=10, element_use=SolitaryVegetationObjectType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lod3ImplicitRepresentation'))),
        pyxb.binding.content.ContentModelTransition(next_state=16, element_use=SolitaryVegetationObjectType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lod4ImplicitRepresentation'))),
