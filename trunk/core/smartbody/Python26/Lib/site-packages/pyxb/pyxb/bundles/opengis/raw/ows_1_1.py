...
# Generated 2010-01-28 08:41:56.617000 by PyXB version 1.1.1
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:aa1e5ef0-0c23-11df-9a07-000c29370554')
...
class MetadataType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netows1_1_MetadataType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netows1_1_MetadataType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class CTD_ANON_1 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __reference = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(Namespace, u'reference'), 'reference', '__httpwww_opengis_netows1_1_CTD_ANON_1_httpwww_opengis_netows1_1reference', pyxb.binding.datatypes.anyURI, required=True)
...
class CTD_ANON_2 (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {http://www.opengis.net/ows/1.1}Metadata uses Python identifier Metadata
    __Metadata = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Metadata'), 'Metadata', '__httpwww_opengis_netows1_1_CTD_ANON_2_httpwww_opengis_netows1_1Metadata', True)
    ...
    __Parameter = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Parameter'), 'Parameter', '__httpwww_opengis_netows1_1_CTD_ANON_2_httpwww_opengis_netows1_1Parameter', True)
    ...
    __DCP = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'DCP'), 'DCP', '__httpwww_opengis_netows1_1_CTD_ANON_2_httpwww_opengis_netows1_1DCP', True)
    ...
    __Constraint = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Constraint'), 'Constraint', '__httpwww_opengis_netows1_1_CTD_ANON_2_httpwww_opengis_netows1_1Constraint', True)
    ...
    # Attribute name uses Python identifier name
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'name'), 'name', '__httpwww_opengis_netows1_1_CTD_ANON_2_name', pyxb.binding.datatypes.string, required=True)
...
class CTD_ANON_4 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __Post = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Post'), 'Post', '__httpwww_opengis_netows1_1_CTD_ANON_4_httpwww_opengis_netows1_1Post', True)
    ...
    __Get = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Get'), 'Get', '__httpwww_opengis_netows1_1_CTD_ANON_4_httpwww_opengis_netows1_1Get', True)
...
class OnlineResourceType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netows1_1_OnlineResourceType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netows1_1_OnlineResourceType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
class CTD_ANON_6 (DescriptionType):
    ...
    __AccessConstraints = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'AccessConstraints'), 'AccessConstraints', '__httpwww_opengis_netows1_1_CTD_ANON_6_httpwww_opengis_netows1_1AccessConstraints', True)
    ...
    __ServiceType = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ServiceType'), 'ServiceType', '__httpwww_opengis_netows1_1_CTD_ANON_6_httpwww_opengis_netows1_1ServiceType', False)
    ...
    __Fees = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Fees'), 'Fees', '__httpwww_opengis_netows1_1_CTD_ANON_6_httpwww_opengis_netows1_1Fees', False)
    ...
    __ServiceTypeVersion = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ServiceTypeVersion'), 'ServiceTypeVersion', '__httpwww_opengis_netows1_1_CTD_ANON_6_httpwww_opengis_netows1_1ServiceTypeVersion', True)
    ...
    __Profile = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Profile'), 'Profile', '__httpwww_opengis_netows1_1_CTD_ANON_6_httpwww_opengis_netows1_1Profile', True)
...
class AbstractReferenceBaseType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netows1_1_AbstractReferenceBaseType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netows1_1_AbstractReferenceBaseType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class CTD_ANON_8 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __ServiceContact = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ServiceContact'), 'ServiceContact', '__httpwww_opengis_netows1_1_CTD_ANON_8_httpwww_opengis_netows1_1ServiceContact', False)
    ...
    __ProviderName = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ProviderName'), 'ProviderName', '__httpwww_opengis_netows1_1_CTD_ANON_8_httpwww_opengis_netows1_1ProviderName', False)
    ...
    __ProviderSite = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ProviderSite'), 'ProviderSite', '__httpwww_opengis_netows1_1_CTD_ANON_8_httpwww_opengis_netows1_1ProviderSite', False)
...
class CTD_ANON_9 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __Operation = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Operation'), 'Operation', '__httpwww_opengis_netows1_1_CTD_ANON_9_httpwww_opengis_netows1_1Operation', True)
    ...
    __ExtendedCapabilities = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ExtendedCapabilities'), 'ExtendedCapabilities', '__httpwww_opengis_netows1_1_CTD_ANON_9_httpwww_opengis_netows1_1ExtendedCapabilities', False)
...
class CTD_ANON_10 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __Exception = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Exception'), 'Exception', '__httpwww_opengis_netows1_1_CTD_ANON_10_httpwww_opengis_netows1_1Exception', True)
    ...
    # Attribute {http://www.w3.org/XML/1998/namespace}lang uses Python identifier lang
    __lang = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.XML, 'lang'), 'lang', '__httpwww_opengis_netows1_1_CTD_ANON_10_httpwww_w3_orgXML1998namespacelang', pyxb.binding.xml_.STD_ANON_lang)
    
    lang = property(__lang.value, __lang.set, None, None)

    
    # Attribute version uses Python identifier version
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'version'), 'version', '__httpwww_opengis_netows1_1_CTD_ANON_10_version', STD_ANON_1, required=True)
...
AnyValue = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AnyValue'), CTD_ANON_3, documentation=u'Specifies that any value is allowed for this parameter.')
...
NoValues = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'NoValues'), CTD_ANON_5, documentation=u'Specifies that no values are allowed for this parameter or quantity.')
...
ServiceProvider = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ServiceProvider'), CTD_ANON_8, documentation=u'Metadata about the organization that provides this specific service instance or server. ')
Namespace.addCategoryObject('elementBinding', ServiceProvider.name().localName(), ServiceProvider)

OperationsMetadata = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'OperationsMetadata'), CTD_ANON_9, documentation=u'Metadata about the operations and related abilities specified by this service and implemented by this server, including the URLs for operation requests. The basic contents of this section shall be the same for all OWS types, but individual services can add elements and/or change the optionality of optional elements. ')
...
ValuesReference = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ValuesReference'), CTD_ANON_1, documentation=u'Reference to externally specified list of all the valid values and/or ranges of values for this quantity. (Informative: This element was simplified from the metaDataProperty element in GML 3.0.) ')
...
ExceptionReport = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ExceptionReport'), CTD_ANON_10, documentation=u'Report message returned to the client that requested any OWS operation when the server detects an error while processing that operation request. ')
...
HTTP = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'HTTP'), CTD_ANON_4, documentation=u'Connect point URLs for the HTTP Distributed Computing Platform (DCP). Normally, only one Get and/or one Post is included in this element. More than one Get and/or Post is allowed to support including alternative URLs for uses such as load balancing or backup. ')
...
IdentificationType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=IdentificationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Metadata'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=IdentificationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Identifier'))),
...
UnNamedDomainType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AnyValue'), CTD_ANON_3, scope=UnNamedDomainType, documentation=u'Specifies that any value is allowed for this parameter.'))
...
UnNamedDomainType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ValuesReference'), CTD_ANON_1, scope=UnNamedDomainType, documentation=u'Reference to externally specified list of all the valid values and/or ranges of values for this quantity. (Informative: This element was simplified from the metaDataProperty element in GML 3.0.) '))
...
UnNamedDomainType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'NoValues'), CTD_ANON_5, scope=UnNamedDomainType, documentation=u'Specifies that no values are allowed for this parameter or quantity.'))
...
UnNamedDomainType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
    ...
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=UnNamedDomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Metadata'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=UnNamedDomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Meaning'))),
    ...
    , 6 : pyxb.binding.content.ContentModelState(state=6, is_final=True, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=UnNamedDomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Meaning'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=UnNamedDomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ReferenceSystem'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=UnNamedDomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'DefaultValue'))),
    ])
})
...
DomainType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
    ...
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=DomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Metadata'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=DomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Meaning'))),
    ...
    , 6 : pyxb.binding.content.ContentModelState(state=6, is_final=True, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=DomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Meaning'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=DomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ReferenceSystem'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=DomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'DefaultValue'))),
    ])
})
...
CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'DCP'), CTD_ANON_11, scope=CTD_ANON_2, documentation=u'Information for one distributed Computing Platform (DCP) supported for this operation. At present, only the HTTP DCP is defined, so this element only includes the HTTP element.\n'))

CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Constraint'), DomainType, scope=CTD_ANON_2, documentation=u'Optional unordered list of valid domain constraints on non-parameter quantities that each apply to this operation. If one of these Constraint elements has the same "name" attribute as a Constraint element in the OperationsMetadata element, this Constraint element shall override the other one for this operation. The list of required and optional constraints for this operation shall be specified in the Implementation Specification for this service. '))
CTD_ANON_2._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'DCP'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'DCP'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Metadata'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Parameter'))),
...
CTD_ANON_4._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Post'), RequestMethodType, scope=CTD_ANON_4, documentation=u'Connect point URL and any constraints for the HTTP "Post" request method for this operation request. '))

CTD_ANON_4._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Get'), RequestMethodType, scope=CTD_ANON_4, documentation=u'Connect point URL prefix and any constraints for the HTTP "Get" request method for this operation request. '))
CTD_ANON_4._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Post'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Get'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Post'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Get'))),
...
ContactType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=ContactType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Phone'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=ContactType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'HoursOfService'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ContactType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ContactInstructions'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
...
CapabilitiesBaseType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'OperationsMetadata'), CTD_ANON_9, scope=CapabilitiesBaseType, documentation=u'Metadata about the operations and related abilities specified by this service and implemented by this server, including the URLs for operation requests. The basic contents of this section shall be the same for all OWS types, but individual services can add elements and/or change the optionality of optional elements. '))
...
CapabilitiesBaseType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ServiceProvider'), CTD_ANON_8, scope=CapabilitiesBaseType, documentation=u'Metadata about the organization that provides this specific service instance or server. '))
...
CTD_ANON_6._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Profile'), pyxb.binding.datatypes.anyURI, scope=CTD_ANON_6, documentation=u'Unordered list of identifiers of Application Profiles that are implemented by this server. This element should be included for each specified application profile implemented by this server. The identifier value should be specified by each Application Profile. If this element is omitted, no meaning is implied. '))
CTD_ANON_6._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Keywords'))),
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Title'))),
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Abstract'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ServiceType'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AccessConstraints'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ServiceTypeVersion'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Profile'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Fees'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ServiceTypeVersion'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AccessConstraints'))),
    ])
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=True, transitions=[
...
ResponsiblePartyType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=ResponsiblePartyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'IndividualName'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=ResponsiblePartyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'OrganisationName'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=ResponsiblePartyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ContactInfo'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=ResponsiblePartyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Role'))),
...
CTD_ANON_8._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ServiceContact'), ResponsiblePartySubsetType, scope=CTD_ANON_8, documentation=u'Information for contacting the service provider. The OnlineResource element within this ServiceContact element should not be used to reference a web site of the service provider. '))

CTD_ANON_8._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ProviderName'), pyxb.binding.datatypes.string, scope=CTD_ANON_8, documentation=u'A unique identifier for the service provider organization. '))

CTD_ANON_8._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ProviderSite'), OnlineResourceType, scope=CTD_ANON_8, documentation=u'Reference to the most relevant web site of the service provider. '))
CTD_ANON_8._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ProviderName'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ProviderSite'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ServiceContact'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ServiceContact'))),
    ])
...
CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Operation'), CTD_ANON_2, scope=CTD_ANON_9, documentation=u'Metadata for one operation that this server implements. '))
...
CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ExtendedCapabilities'), pyxb.binding.datatypes.anyType, scope=CTD_ANON_9, documentation=u'Individual software vendors and servers can use this element to provide metadata about any additional server abilities. '))
CTD_ANON_9._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Operation'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Operation'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Parameter'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Operation'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Constraint'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ExtendedCapabilities'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Parameter'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Constraint'))),
...
CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Exception'), ExceptionType, scope=CTD_ANON_10))
CTD_ANON_10._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Exception'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Exception'))),
    ])
...
CTD_ANON_11._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'HTTP'), CTD_ANON_4, scope=CTD_ANON_11, documentation=u'Connect point URLs for the HTTP Distributed Computing Platform (DCP). Normally, only one Get and/or one Post is included in this element. More than one Get and/or Post is allowed to support including alternative URLs for uses such as load balancing or backup. '))
