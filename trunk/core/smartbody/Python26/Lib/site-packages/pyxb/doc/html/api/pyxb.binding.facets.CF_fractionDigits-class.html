...
<head>
  <title>pyxb.binding.facets.CF_fractionDigits</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="pyxb.binding.facets.CF_fractionDigits-class.html"
...
<!-- ==================== CLASS DESCRIPTION ==================== -->
<h1 class="epydoc">Class CF_fractionDigits</h1><p class="nomargin-top"><span class="codelink"><a href="pyxb.binding.facets-pysrc.html#CF_fractionDigits">source&nbsp;code</a></span></p>
<pre class="base-tree">
object --+            
         |            
 ...
 <a href="pyxb.binding.facets.ConstrainingFacet-class.html">ConstrainingFacet</a> --+
    ...
    object --+       |
      ...
      <a href="pyxb.binding.facets._Fixed_mixin-class.html" onclick="show_private();">_Fixed_mixin</a> --+
                     |
                    <strong class="uidshort">CF_fractionDigits</strong>
</pre>

<hr />
<p>Specify the number of sub-unit digits in the *value* space of the 
  type.</p>
  <p>See <a href="http://www.w3.org/TR/xmlschema-2/#rf-fractionDigits" 
  target="_top">http://www.w3.org/TR/xmlschema-2/#rf-fractionDigits</a></p>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a href="pyxb.binding.datatypes.nonNegativeInteger-class.html" class="summary-name" onclick="show_private();">_ValueDatatype</a>
    </td>
  </tr>
</table>
<!-- ==================== INSTANCE METHODS ==================== -->
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.binding.facets.CF_fractionDigits-class.html#_validateConstraint_vx" class="summary-sig-name" onclick="show_private();">_validateConstraint_vx</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">value</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.facets-pysrc.html#CF_fractionDigits._validateConstraint_vx">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="_Name"></a><span class="summary-name">_Name</span> = <code title="'fractionDigits'"><code class="variable-quote">'</code><code class="variable-string">fractionDigits</code><code class="variable-quote">'</code></code>
    </td>
  </tr>
  <tr>
    <td colspan="2" class="summary">
