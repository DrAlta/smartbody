...
<head>
  <title>pyxb.xmlschema.structures._UrTypeDefinition</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="pyxb.xmlschema.structures._UrTypeDefinition-class.html"
...
<!-- ==================== CLASS DESCRIPTION ==================== -->
<h1 class="epydoc">Class _UrTypeDefinition</h1><p class="nomargin-top"><span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#_UrTypeDefinition">source&nbsp;code</a></span></p>
<pre class="base-tree">
                       object --+                    
                                |                    
     ...
     <a href="pyxb.utils.utility.PrivateTransient_mixin-class.html">utils.utility.PrivateTransient_mixin</a> --+   |    
       ...
       <a href="pyxb.namespace.resolution._Resolvable_mixin-class.html" onclick="show_private();">namespace.resolution._Resolvable_mixin</a> --+    
                     ...
                     <a href="pyxb.xmlschema.structures._AttributeWildcard_mixin-class.html" onclick="show_private();">_AttributeWildcard_mixin</a> --+    
                                                |    
                            <a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html">ComplexTypeDefinition</a> --+
                                                    |
                                   object --+       |
                                            |       |
                                      <a href="pyxb.cscRoot-class.html">cscRoot</a> --+   |
                                                |   |
                                 <a href="pyxb.xmlschema.structures._Singleton_mixin-class.html" onclick="show_private();">_Singleton_mixin</a> --+
                                                    |
                                                   <strong class="uidshort">_UrTypeDefinition</strong>
</pre>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.xmlschema.structures._UrTypeDefinition-class.html#pythonSupport" class="summary-sig-name">pythonSupport</a>(<span class="summary-sig-arg">self</span>)</span><br />
      The ur-type does have a Python class backing it up.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#_UrTypeDefinition.pythonSupport">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.xmlschema.structures._UrTypeDefinition-class.html#_resolve" class="summary-sig-name" onclick="show_private();">_resolve</a>(<span class="summary-sig-arg">self</span>)</span><br />
      Perform whatever steps are required to resolve this component.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#_UrTypeDefinition._resolve">source&nbsp;code</a></span>
  ...
  <tr>
    ...
    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html">ComplexTypeDefinition</a></code></b>:
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#__init__">__init__</a></code>,
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#__str__">__str__</a></code>,
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#abstract">abstract</a></code>,
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#attributeUses">attributeUses</a></code>,
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#baseTypeDefinition">baseTypeDefinition</a></code>,
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#contentType">contentType</a></code>,
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#contentTypeAsString">contentTypeAsString</a></code>,
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#derivationMethod">derivationMethod</a></code>,
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#hasWildcardElement">hasWildcardElement</a></code>,
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#isBuiltin">isBuiltin</a></code>,
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#isResolved">isResolved</a></code>,
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#localScopedDeclarations">localScopedDeclarations</a></code>,
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#lookupScopedAttributeDeclaration">lookupScopedAttributeDeclaration</a></code>,
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#lookupScopedElementDeclaration">lookupScopedElementDeclaration</a></code>
      </p>
    <div class="private">    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html">ComplexTypeDefinition</a></code></b> (private):
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#_bindingRequires_vx" onclick="show_private();">_bindingRequires_vx</a></code>,
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#_contentTypeComponent" onclick="show_private();">_contentTypeComponent</a></code>,
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#_contentTypeTag" onclick="show_private();">_contentTypeTag</a></code>,
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#_isHierarchyRoot" onclick="show_private();">_isHierarchyRoot</a></code>,
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#_recordLocalDeclaration" onclick="show_private();">_recordLocalDeclaration</a></code>,
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#_setDerivationMethod" onclick="show_private();">_setDerivationMethod</a></code>,
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#_updateFromOther_csc" onclick="show_private();">_updateFromOther_csc</a></code>
      </p></div>
...
<tr bgcolor="#70b0f0" class="table-header">
  ...
  <tr>
    <td colspan="2" class="summary">
    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html">ComplexTypeDefinition</a></code></b>:
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#CreateFromDOM">CreateFromDOM</a></code>,
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#UrTypeDefinition">UrTypeDefinition</a></code>
      </p>
    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.xmlschema.structures._AttributeWildcard_mixin-class.html" onclick="show_private();">_AttributeWildcard_mixin</a></code></b>:
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__singleton"></a><span class="summary-name">__singleton</span> = <code title="None">None</code>
    </td>
  </tr>
  <tr>
    <td colspan="2" class="summary">
    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html">ComplexTypeDefinition</a></code></b>:
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#CT_ELEMENT_ONLY">CT_ELEMENT_ONLY</a></code>,
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#CT_EMPTY">CT_EMPTY</a></code>,
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#CT_MIXED">CT_MIXED</a></code>,
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#CT_SIMPLE">CT_SIMPLE</a></code>,
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#DM_empty">DM_empty</a></code>,
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#DM_extension">DM_extension</a></code>,
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#DM_restriction">DM_restriction</a></code>
      </p>
    <div class="private">    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html">ComplexTypeDefinition</a></code></b> (private):
      <code><a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#_DM_Map" onclick="show_private();">_DM_Map</a></code>
      </p></div>
    <div class="private">    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.xmlschema.structures._SchemaComponent_mixin-class.html" onclick="show_private();">_SchemaComponent_mixin</a></code></b> (private):
...
<tr><td>
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr valign="top"><td>
  <h3 class="epydoc"><span class="sig"><span class="sig-name">pythonSupport</span>(<span class="sig-arg">self</span>)</span>
  </h3>
  ...
  <p>The ur-type does have a Python class backing it up.</p>
  <dl class="fields">
    <dt>Overrides:
        <a href="pyxb.xmlschema.structures.ComplexTypeDefinition-class.html#pythonSupport">ComplexTypeDefinition.pythonSupport</a>
    </dt>
  </dl>
</td></tr></table>
</div>
