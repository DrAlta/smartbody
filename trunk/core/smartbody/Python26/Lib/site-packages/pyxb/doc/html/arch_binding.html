...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Binding Model &mdash; PyXB v1.1.1 documentation</title>
...
<span class="n">v</span> <span class="o">=</span> <span class="n">content</span><span class="o">.</span><span class="n">numbers</span><span class="p">(</span><span class="mf">1</span><span class="p">,</span> <span class="n">BIND</span><span class="p">(</span><span class="mf">2</span><span class="p">),</span> <span class="n">attribute</span><span class="o">=</span><span class="mf">3</span><span class="p">)</span>
...
<span class="k">print</span> <span class="mf">3</span> <span class="o">*</span> <span class="n">v</span><span class="o">.</span><span class="n">simple</span>
<span class="k">print</span> <span class="mf">4</span> <span class="o">*</span> <span class="n">v</span><span class="o">.</span><span class="n">complex</span><span class="o">.</span><span class="n">value</span><span class="p">()</span>
<span class="k">print</span> <span class="mf">5</span> <span class="o">*</span> <span class="n">v</span><span class="o">.</span><span class="n">attribute</span>
</pre></div>
</div>
...
attribute names are distinct.  These classes also associate a <a class="reference external" href="api/pyxb.binding.content.ContentModel-class.html">content
...
corresponding type.  See <a class="reference internal" href="#ex-showcontent"><em>the example above</em></a>.</p>
      ...
      <div class="sphinxsidebar">
        <div class="sphinxsidebarwrapper">
            ...
            <ul>
<li><a class="reference external" href="">Binding Model</a><ul>
...
<li><a class="reference external" href="#simple-type-definitions">Simple Type Definitions</a><ul>
<li><a class="reference external" href="#constraining-facets">Constraining Facets</a></li>
...
<li><a class="reference external" href="#complex-type-definitions">Complex Type Definitions</a><ul>
...
<li><a class="reference external" href="#id5">Elements</a></li>
</ul>
</li>
</ul>
