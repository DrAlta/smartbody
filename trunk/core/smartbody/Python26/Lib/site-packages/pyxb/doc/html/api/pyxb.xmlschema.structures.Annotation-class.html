...
<head>
  <title>pyxb.xmlschema.structures.Annotation</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="pyxb.xmlschema.structures.Annotation-class.html"
...
<!-- ==================== CLASS DESCRIPTION ==================== -->
<h1 class="epydoc">Class Annotation</h1><p class="nomargin-top"><span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#Annotation">source&nbsp;code</a></span></p>
<pre class="base-tree">
                       object --+                
                                |                
     ...
     <a href="pyxb.utils.utility.PrivateTransient_mixin-class.html">utils.utility.PrivateTransient_mixin</a> --+    
            ...
            <a href="pyxb.utils.utility.Locatable_mixin-class.html">utils.utility.Locatable_mixin</a> --+    
                       ...
                       <a href="pyxb.xmlschema.structures._SchemaComponent_mixin-class.html" onclick="show_private();">_SchemaComponent_mixin</a> --+
                                                |
                                               <strong class="uidshort">Annotation</strong>
</pre>

<hr />
<p>An XMLSchema <a href="http://www.w3.org/TR/xmlschema-1/#cAnnotation" 
  target="_top">Annotation</a> component.</p>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="applicationInformation"></a><span class="summary-sig-name">applicationInformation</span>(<span class="summary-sig-arg">self</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#Annotation.applicationInformation">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="userInformation"></a><span class="summary-sig-name">userInformation</span>(<span class="summary-sig-arg">self</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#Annotation.userInformation">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.xmlschema.structures.Annotation-class.html#__init__" class="summary-sig-name">__init__</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">**kw</span>)</span><br />
      Initialize portions of a component.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#Annotation.__init__">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.xmlschema.structures.Annotation-class.html#asDocString" class="summary-sig-name">asDocString</a>(<span class="summary-sig-arg">self</span>,
        ...
        <span class="summary-sig-arg">error</span>=<span class="summary-sig-default"><code class="variable-quote">'</code><code class="variable-string">xmlcharrefreplace</code><code class="variable-quote">'</code></span>)</span><br />
      Return the text in a form suitable for embedding in a 
      triple-double-quoted docstring.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#Annotation.asDocString">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="text"></a><span class="summary-sig-name">text</span>(<span class="summary-sig-arg">self</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#Annotation.text">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.xmlschema.structures.Annotation-class.html#__str__" class="summary-sig-name">__str__</a>(<span class="summary-sig-arg">self</span>)</span><br />
      Return the catenation of all user information elements in the 
      annotation as a single unicode string.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#Annotation.__str__">source&nbsp;code</a></span>
    ...
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        ...
        <span class="summary-sig-arg">**kw</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#Annotation.CreateFromDOM">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__applicationInformation"></a><span class="summary-name">__applicationInformation</span> = <code title="None">None</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__userInformation"></a><span class="summary-name">__userInformation</span> = <code title="None">None</code>
    </td>
  </tr>
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="__RemoveMultiQuote_re"></a><span class="summary-name">__RemoveMultiQuote_re</span> = <code title="re.compile(r'&quot;&quot;+')">re.compile(r'&quot;&quot;<code class="re-op">+</code>')</code>
    </td>
  </tr>
  <tr>
    <td colspan="2" class="summary">
...
<tr><td>
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr valign="top"><td>
  <h3 class="epydoc"><span class="sig"><span class="sig-name">asDocString</span>(<span class="sig-arg">self</span>,
        ...
        <span class="sig-arg">error</span>=<span class="sig-default"><code class="variable-quote">'</code><code class="variable-string">xmlcharrefreplace</code><code class="variable-quote">'</code></span>)</span>
  </h3>
  </td><td align="right" valign="top"
    ><span class="codelink"><a href="pyxb.xmlschema.structures-pysrc.html#Annotation.asDocString">source&nbsp;code</a></span>&nbsp;
    </td>
  ...
  <p>Return the text in a form suitable for embedding in a 
  triple-double-quoted docstring.</p>
  <p>Any sequence of two or more double quotes is replaced by a sequence of
  single quotes that is the same length.  Following this, spaces are added 
  at the start and the end as necessary to ensure a double quote does not 
  appear in those positions.</p>
  <dl class="fields">
  </dl>
</td></tr></table>
</div>
...
<tr><td>
  ...
  <p>Return the catenation of all user information elements in the 
  annotation as a single unicode string.  Returns the empty string if there
  are no user information elements.</p>
  <dl class="fields">
    <dt>Overrides:
        object.__str__
    </dt>
