...
<head>
  <title>pyxb.binding.basis.STD_union</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="pyxb.binding.basis.STD_union-class.html"
...
<!-- ==================== CLASS DESCRIPTION ==================== -->
<h1 class="epydoc">Class STD_union</h1><p class="nomargin-top"><span class="codelink"><a href="pyxb.binding.basis-pysrc.html#STD_union">source&nbsp;code</a></span></p>
<pre class="base-tree">
                    object --+                
                             |                
...
<a href="pyxb.utils.utility._DeconflictSymbols_mixin-class.html" onclick="show_private();">utils.utility._DeconflictSymbols_mixin</a> --+    
                  ...
                  <a href="pyxb.binding.basis._DynamicCreate_mixin-class.html" onclick="show_private();">_DynamicCreate_mixin</a> --+    
                      ...
                      <a href="pyxb.binding.basis.simpleTypeDefinition-class.html">simpleTypeDefinition</a> --+
                                             |
                                            <strong class="uidshort">STD_union</strong>
</pre>

<dl><dt>Known Subclasses:</dt>
<dd>
      <ul class="subclass-list">
<li><a href="pyxb.binding.xml_.STD_ANON_lang-class.html">xml_.STD_ANON_lang</a></li>  </ul>
</dd></dl>

<hr />
<p>Base class for union datatypes.</p>
  <p>This class descends only from simpleTypeDefinition.  A pyxb.LogicError
  is raised if an attempt is made to construct an instance of a subclass of
  STD_union.  Values consistent with the member types are constructed using
  the Factory class method.  Values are validated using the 
  _ValidatedMember class method.</p>
  <p>Subclasses must provide a class variable _MemberTypes which is a tuple
  of legal members of the union.</p>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.binding.basis.STD_union-class.html#__init__" class="summary-sig-name">__init__</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">*args</span>,
        <span class="summary-sig-arg">**kw</span>)</span><br />
      Initialize a newly created STD instance.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.basis-pysrc.html#STD_union.__init__">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.binding.basis.STD_union-class.html#Factory" class="summary-sig-name">Factory</a>(<span class="summary-sig-arg">cls</span>,
        <span class="summary-sig-arg">*args</span>,
        <span class="summary-sig-arg">**kw</span>)</span><br />
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.binding.basis.STD_union-class.html#_ValidatedMember" class="summary-sig-name" onclick="show_private();">_ValidatedMember</a>(<span class="summary-sig-arg">cls</span>,
        <span class="summary-sig-arg">value</span>)</span><br />
      Validate the given value as a potential union member.</td>
          <td align="right" valign="top">
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.binding.basis.STD_union-class.html#_description" class="summary-sig-name" onclick="show_private();">_description</a>(<span class="summary-sig-arg">cls</span>,
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.binding.basis.STD_union-class.html#XsdLiteral" class="summary-sig-name">XsdLiteral</a>(<span class="summary-sig-arg">cls</span>,
        <span class="summary-sig-arg">value</span>)</span><br />
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="_MemberTypes"></a><span class="summary-name">_MemberTypes</span> = <code title="None">None</code><br />
...
<tr><td>
  ...
  <p>Given a value, attempt to create an instance of some member of this 
  union.  The first instance which can be legally created is returned.</p>
  <dl class="fields">
    <dt>Parameters:</dt>
    <dd><ul class="nomargin-top">
        <li><strong class="pname"><code>_validate_constraints</code></strong> - If True (default), any constructed value is checked against 
          constraints applied to the union as well as the member type.</li>
    </ul></dd>
    <dt>Raises:</dt>
    <dd><ul class="nomargin-top">
        <li><code><strong class='fraise'><a href="pyxb.exceptions_.BadTypeValueError-class.html">pyxb.BadTypeValueError</a></strong></code> - no member type will permit creation of an instance from the 
        parameters in <code>args</code> and <code>kw</code>.</li>
    </ul></dd>
    <dt>Overrides:
        <a href="pyxb.binding.basis._TypeBinding_mixin-class.html#Factory">_TypeBinding_mixin.Factory</a>
    </dt>
  </dl>
</td></tr></table>
</div>
<a name="_ValidatedMember"></a>
<div class="private">
<table class="details" border="1" cellpadding="3"
       cellspacing="0" width="100%" bgcolor="white">
<tr><td>
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr valign="top"><td>
  <h3 class="epydoc"><span class="sig"><span class="sig-name">_ValidatedMember</span>(<span class="sig-arg">cls</span>,
  ...
  <p>Validate the given value as a potential union member.</p>
  <dl class="fields">
    <dt>Raises:</dt>
    <dd><ul class="nomargin-top">
        <li><code><strong class='fraise'><a href="pyxb.exceptions_.BadTypeValueError-class.html">pyxb.BadTypeValueError</a></strong></code> - the value is not an instance of a member type.</li>
    </ul></dd>
  </dl>
</td></tr></table>
</div>
...
<tr><td>
  ...
  <dl class="fields">
    <dt>Parameters:</dt>
    <dd><ul class="nomargin-top">
        <li><strong class="pname"><code>_validate_constraints</code></strong> - If True (default), the newly constructed value is checked against
