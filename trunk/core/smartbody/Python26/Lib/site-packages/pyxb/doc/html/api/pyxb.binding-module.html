  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="pyxb.binding-module.html"
...
<!-- ==================== PACKAGE DESCRIPTION ==================== -->
<h1 class="epydoc">Package binding</h1><p class="nomargin-top"><span class="codelink"><a href="pyxb.binding-pysrc.html">source&nbsp;code</a></span></p>
<p>Material used to generate and execute bindings generated by the PyXB 
  package.</p>
...
<tr bgcolor="#70b0f0" class="table-header">
  ...
  <ul class="nomargin">
    ...
    <li> <strong class="uidlink"><a href="pyxb.binding.nfa-module.html">pyxb.binding.nfa</a></strong>: <em class="summary">Finite automata classes that support content model management.</em>    </li>
