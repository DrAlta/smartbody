...
<head>
  <title>pyxb.binding.basis.STD_list</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="pyxb.binding.basis.STD_list-class.html"
...
<!-- ==================== CLASS DESCRIPTION ==================== -->
<h1 class="epydoc">Class STD_list</h1><p class="nomargin-top"><span class="codelink"><a href="pyxb.binding.basis-pysrc.html#STD_list">source&nbsp;code</a></span></p>
<pre class="base-tree">
                    object --+                
                             |                
...
<a href="pyxb.utils.utility._DeconflictSymbols_mixin-class.html" onclick="show_private();">utils.utility._DeconflictSymbols_mixin</a> --+    
                  ...
                  <a href="pyxb.binding.basis._DynamicCreate_mixin-class.html" onclick="show_private();">_DynamicCreate_mixin</a> --+    
                                         |    
                      <a href="pyxb.binding.basis.simpleTypeDefinition-class.html">simpleTypeDefinition</a> --+
                                             |
                                object --+   |
                                         |   |
                                      list --+
                                             |
                                            <strong class="uidshort">STD_list</strong>
</pre>

<dl><dt>Known Subclasses:</dt>
<dd>
      <ul class="subclass-list">
<li><a href="pyxb.binding.datatypes.ENTITIES-class.html">datatypes.ENTITIES</a></li><li>, <a href="pyxb.binding.datatypes.IDREFS-class.html">datatypes.IDREFS</a></li><li>, <a href="pyxb.binding.datatypes.NMTOKENS-class.html">datatypes.NMTOKENS</a></li>  </ul>
</dd></dl>

<hr />
<p>Base class for collection datatypes.</p>
  <p>This class descends from the Python list type, and incorporates 
  simpleTypeDefinition.  Subclasses must define a class variable _ItemType 
  which is a reference to the class of which members must be instances.</p>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="__convertMany"></a><span class="summary-sig-name">__convertMany</span>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">values</span>)</span></td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.basis-pysrc.html#STD_list.__convertMany">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.binding.basis.STD_list-class.html#__setitem__" class="summary-sig-name">__setitem__</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">key</span>,
        <span class="summary-sig-arg">value</span>)</span><br />
      x[i]=y</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.basis-pysrc.html#STD_list.__setitem__">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.binding.basis.STD_list-class.html#__setslice__" class="summary-sig-name">__setslice__</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">start</span>,
        <span class="summary-sig-arg">end</span>,
        <span class="summary-sig-arg">values</span>)</span><br />
      x[i:j]=y</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.basis-pysrc.html#STD_list.__setslice__">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.binding.basis.STD_list-class.html#__contains__" class="summary-sig-name">__contains__</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">item</span>)</span><br />
      y in x</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.basis-pysrc.html#STD_list.__contains__">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.binding.basis.STD_list-class.html#append" class="summary-sig-name">append</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">x</span>)</span><br />
      append object to end</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.basis-pysrc.html#STD_list.append">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.binding.basis.STD_list-class.html#extend" class="summary-sig-name">extend</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">x</span>)</span><br />
      extend list by appending elements from the iterable</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.basis-pysrc.html#STD_list.extend">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.binding.basis.STD_list-class.html#count" class="summary-sig-name">count</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">x</span>)</span><br />
      return number of occurrences of value</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.basis-pysrc.html#STD_list.count">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.binding.basis.STD_list-class.html#index" class="summary-sig-name">index</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">x</span>,
        <span class="summary-sig-arg">*args</span>)</span><br />
      L.index(value, [start, [stop]]) -&gt; integer -- return first index 
      of value</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.basis-pysrc.html#STD_list.index">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.binding.basis.STD_list-class.html#insert" class="summary-sig-name">insert</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">i</span>,
        <span class="summary-sig-arg">x</span>)</span><br />
      insert object before index</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.basis-pysrc.html#STD_list.insert">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.binding.basis.STD_list-class.html#remove" class="summary-sig-name">remove</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">x</span>)</span><br />
      remove first occurrence of value</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyxb.binding.basis-pysrc.html#STD_list.remove">source&nbsp;code</a></span>
  ...
  <tr>
    ...
    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.basis.simpleTypeDefinition-class.html">simpleTypeDefinition</a></code></b>:
    ...
    <div class="private">    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.basis.simpleTypeDefinition-class.html">simpleTypeDefinition</a></code></b> (private):
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.binding.basis.STD_list-class.html#_ValidatedItem" class="summary-sig-name" onclick="show_private();">_ValidatedItem</a>(<span class="summary-sig-arg">cls</span>,
        <span class="summary-sig-arg">value</span>)</span><br />
      Verify that the given value is permitted as an item of this list.</td>
          <td align="right" valign="top">
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.binding.basis.STD_list-class.html#_ConvertArguments_vx" class="summary-sig-name" onclick="show_private();">_ConvertArguments_vx</a>(<span class="summary-sig-arg">cls</span>,
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="_XsdValueLength_vx"></a><span class="summary-sig-name">_XsdValueLength_vx</span>(<span class="summary-sig-arg">cls</span>,
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.binding.basis.STD_list-class.html#XsdLiteral" class="summary-sig-name">XsdLiteral</a>(<span class="summary-sig-arg">cls</span>,
        <span class="summary-sig-arg">value</span>)</span><br />
      Convert from a binding value to a string usable in an XML document.</td>
          <td align="right" valign="top">
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyxb.binding.basis.STD_list-class.html#_description" class="summary-sig-name" onclick="show_private();">_description</a>(<span class="summary-sig-arg">cls</span>,
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a name="__ConvertOne"></a><span class="summary-sig-name">__ConvertOne</span>(<span class="summary-sig-arg">cls</span>,
...
<tr bgcolor="#70b0f0" class="table-header">
  ...
  <tr>
    <td colspan="2" class="summary">
    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="pyxb.binding.basis.simpleTypeDefinition-class.html">simpleTypeDefinition</a></code></b>:
      <code><a href="pyxb.binding.basis.simpleTypeDefinition-class.html#__new__">__new__</a></code>
      </p>
    </td>
  </tr>
</table>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      <span class="summary-type">&nbsp;</span>
        ...
        <a name="_ItemType"></a><span class="summary-name">_ItemType</span> = <code title="None">None</code><br />
...
<tr><td>
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr valign="top"><td>
  <h3 class="epydoc"><span class="sig"><span class="sig-name">_ValidatedItem</span>(<span class="sig-arg">cls</span>,
  ...
  <p>Verify that the given value is permitted as an item of this list.</p>
  <p>This may convert the value to the proper type, if it is compatible but
  not an instance of the item type.  Returns the value that should be used 
  as the item, or raises an exception if the value cannot be converted.</p>
  <dl class="fields">
  </dl>
</td></tr></table>
</div>
<a name="_ConvertArguments_vx"></a>
<div class="private">
<table class="details" border="1" cellpadding="3"
       cellspacing="0" width="100%" bgcolor="white">
<tr><td>
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr valign="top"><td>
  <h3 class="epydoc"><span class="sig"><span class="sig-name">_ConvertArguments_vx</span>(<span class="sig-arg">cls</span>,
  ...
  <dl class="fields">
    <dt>Overrides:
        <a href="pyxb.binding.basis.simpleTypeDefinition-class.html#_ConvertArguments_vx" onclick="show_private();">simpleTypeDefinition._ConvertArguments_vx</a>
    </dt>
  </dl>
</td></tr></table>
</div>
...
<tr><td>
  ...
  <p>Convert from a binding value to a string usable in an XML 
  document.</p>
  <dl class="fields">
    <dt>Overrides:
        <a href="pyxb.binding.basis.simpleTypeDefinition-class.html#XsdLiteral">simpleTypeDefinition.XsdLiteral</a>
    </dt>
  </dl>
</td></tr></table>
</div>
...
<tr><td>
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr valign="top"><td>
  <h3 class="epydoc"><span class="sig"><span class="sig-name">_description</span>(<span class="sig-arg">cls</span>,
        <span class="sig-arg">name_only</span>=<span class="sig-default">False</span>,
        <span class="sig-arg">user_documentation</span>=<span class="sig-default">True</span>)</span>
    <br /><em class="fname">Class Method</em>
  </h3>
  </td><td align="right" valign="top"
    >&nbsp;
  ...
  <dl class="fields">
    <dt>Overrides:
        <a href="pyxb.binding.basis.simpleTypeDefinition-class.html#_description" onclick="show_private();">simpleTypeDefinition._description</a>
    </dt>
  </dl>
</td></tr></table>
</div>
...
<tr><td>
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr valign="top"><td>
  <h3 class="epydoc"><span class="sig"><span class="sig-name">__setslice__</span>(<span class="sig-arg">self</span>,
...
<tr><td>
  ...
  <p>L.index(value, [start, [stop]]) -&gt; integer -- return first index of
  value</p>
  <dl class="fields">
    <dt>Overrides:
        list.index
