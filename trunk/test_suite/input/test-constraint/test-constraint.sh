#!/bin/sh
#SBMINPUT="-seqpath ../../../../test_suite/input/test-constraint -seq test-constraint.seq -facebone"
SBMINPUT="-scriptpath ../../../../test_suite/input/test-constraint -script test-constraint.py"
OPTION_1=IMG
THRESHOLD_1=500
OPTION_2=IMG
THRESHOLD_2=500
