...
bml.execBMLAt(1, 'ChrBrad', '<sbm:reach sbm:handle="cbrad" effector="r_middle1" sbm:action="touch"/>')
bml.execBMLAt(2, 'ChrBrad', '<sbm:reach sbm:handle="cbrad" target="pawn1" sbm:fade-in="1.0"/>')
scene.commandAt(3, 'snapshot')
bml.execBMLAt(4, 'ChrBrad', '<sbm:reach sbm:handle="cbrad" target="pawn2" sbm:reach-finish="true"/>')
scene.commandAt(4.4, 'snapshot')
