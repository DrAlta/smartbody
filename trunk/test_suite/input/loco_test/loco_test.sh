#!/bin/sh
#SBMINPUT="-noninteractive -seqpath ../../../../test_suite/input/loco_test -seq loco_test.seq -facebone"
SBMINPUT="-noninteractive -scriptpath ../../../../test_suite/input/loco_test -script loco_test.py"
OPTION_1=IMG
THRESHOLD_1=500
OPTION_2=IMG
THRESHOLD_2=500
