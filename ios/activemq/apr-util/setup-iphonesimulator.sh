...
# This script is used for compiling apr-util-1.3.* for iphone simulator, other version not tested
# Modify variables if needed

export SBROOT=""
export PREFIX="$SBROOT/ios/activemq/apr-util/iphonesimulator"
