...
//! Project version number for Smartbody.
FOUNDATION_EXPORT double SmartbodyVersionNumber;

//! Project version string for Smartbody.
FOUNDATION_EXPORT const unsigned char SmartbodyVersionString[];
