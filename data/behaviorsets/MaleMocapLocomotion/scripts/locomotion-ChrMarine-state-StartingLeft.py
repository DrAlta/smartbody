...
def mocapStartLeftSetup(skeletonName, baseJoint, preFix, statePreFix):
	...
	motions.append(statePreFix+"ChrMarine@Idle01_ToWalk01_Turn90Lf01")
	motions.append(statePreFix+"ChrMarine@Idle01_ToWalk01_Turn180Lf01")
