    ...
    implements SensorEventListener
{
     ...
     */
    public boolean init(String arg, int width, int height) { return true; }
     ...
     */
    public boolean inputEvent(int action, float x, float y, MotionEvent event) { return true; }
     ...
     * @return True if the event was handled.
     */
    public boolean keyEvent(int action, int unicodeChar, int keyCode, KeyEvent event) { return true; }
